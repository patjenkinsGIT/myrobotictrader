var et=Object.defineProperty;var tt=(a,n,s)=>n in a?et(a,n,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[n]=s;var he=(a,n,s)=>(tt(a,typeof n!="symbol"?n+"":n,s),s);import{r as w,a as nt,R as Fe}from"./vendor-b1791c80.js";import{L as ne,u as Oe,a as at,b as st,B as ot,R as rt,c as re}from"./router-97b07f8f.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const h of i)if(h.type==="childList")for(const b of h.addedNodes)b.tagName==="LINK"&&b.rel==="modulepreload"&&t(b)}).observe(document,{childList:!0,subtree:!0});function s(i){const h={};return i.integrity&&(h.integrity=i.integrity),i.referrerPolicy&&(h.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?h.credentials="include":i.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function t(i){if(i.ep)return;i.ep=!0;const h=s(i);fetch(i.href,h)}})();var Ye={exports:{}},Te={};/**
 * @license React
 ...
 */var it=w,lt=Symbol.for("react.element"),dt=Symbol.for("react.fragment"),ct=Object.prototype.hasOwnProperty,ht=it.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,mt={key:!0,ref:!0,__self:!0,__source:!0};function Ge(a,n,s){var t,i={},h=null,b=null;s!==void 0&&(h=""+s),n.key!==void 0&&(h=""+n.key),n.ref!==void 0&&(b=n.ref);for(t in n)ct.call(n,t)&&!mt.hasOwnProperty(t)&&(i[t]=n[t]);if(a&&a.defaultProps)for(t in n=a.defaultProps,n)i[t]===void 0&&(i[t]=n[t]);return{$$typeof:lt,type:a,key:h,ref:b,props:i,_owner:ht.current}}Te.Fragment=dt;Te.jsx=Ge;Te.jsxs=Ge;Ye.exports=Te;var e=Ye.exports,ze,We=nt;ze=We.createRoot,We.hydrateRoot;const Ee="G-RX3B8PVTHE",ut=()=>{const a=document.createElement("script");a.async=!0,a.src=`https://www.googletagmanager.com/gtag/js?id=${Ee}`,document.head.appendChild(a),window.dataLayer=window.dataLayer||[],window.gtag=function(...s){window.dataLayer.push(s)},window.gtag("js",new Date),window.gtag("config",Ee,{page_title:document.title,page_location:window.location.href})},ke=(a,n,s,t)=>{typeof window.gtag<"u"&&window.gtag("event",a,{event_category:n,event_label:s,value:t})},Ne=(a,n="hero")=>{ke("click","cta_button",`${a}_${n}`,1)},je=(a,n)=>{ke("click","outbound_link",`${n}_${a}`,1)};class pt{constructor(n="smart_cache",s=!0){he(this,"data",new Map);he(this,"stats",{hits:0,misses:0,sets:0,deletes:0,evictions:0,memoryUsage:0,entryCount:0,totalEntries:0,rateLimitedKeys:[],expiredEntries:0,staleEntries:0});he(this,"defaultTTL",30*60*1e3);he(this,"localStoragePrefix");he(this,"persistToLocalStorage");this.localStoragePrefix=n,this.persistToLocalStorage=s,this.persistToLocalStorage&&this.loadFromLocalStorage()}loadFromLocalStorage(){try{const n=Object.keys(localStorage),s=`${this.localStoragePrefix}_`;let t=0;for(const i of n)if(i.startsWith(s)){const h=i.substring(s.length),b=localStorage.getItem(i);if(b){const I=JSON.parse(b);Date.now()-I.time<=this.defaultTTL?(this.data.set(h,I),t++):(localStorage.removeItem(i),this.stats.expiredEntries++)}}this.stats.entryCount=this.data.size,this.stats.totalEntries=this.data.size}catch(n){console.warn("Error loading cache from localStorage:",n)}}saveToLocalStorage(n,s){if(this.persistToLocalStorage)try{const t=`${this.localStoragePrefix}_${String(n)}`;localStorage.setItem(t,JSON.stringify(s))}catch(t){console.warn("Error saving to localStorage:",t)}}removeFromLocalStorage(n){if(this.persistToLocalStorage)try{const s=`${this.localStoragePrefix}_${String(n)}`;localStorage.removeItem(s)}catch(s){console.warn("Error removing from localStorage:",s)}}set(n,s){const t={value:s,time:Date.now()};this.data.set(n,t),this.saveToLocalStorage(n,t),this.stats.sets++,this.stats.entryCount=this.data.size,this.stats.totalEntries=this.data.size}get(n,s){const t=this.data.get(n);if(t){const i=s||this.defaultTTL;if(Date.now()-t.time>i){this.data.delete(n),this.removeFromLocalStorage(n),this.stats.expiredEntries++,this.stats.misses++;return}else return this.stats.hits++,t.value}else{this.stats.misses++;return}}delete(n){const s=this.data.delete(n);return s&&(this.removeFromLocalStorage(n),this.stats.deletes++,this.stats.entryCount=this.data.size,this.stats.totalEntries=this.data.size),s}clear(){const n=Array.from(this.data.keys());if(this.data.clear(),this.persistToLocalStorage)for(const s of n)this.removeFromLocalStorage(s);this.stats.entryCount=0,this.stats.totalEntries=0}size(){return this.data.size}keys(){return Array.from(this.data.keys())}values(){return Array.from(this.data.values()).map(n=>n.value)}has(n){return this.data.has(n)}hasValid(n,s){const t=this.data.get(n);if(!t)return!1;const i=s||this.defaultTTL;return Date.now()-t.time>i?(this.data.delete(n),this.removeFromLocalStorage(n),this.stats.expiredEntries++,!1):!0}getAge(n){const s=this.data.get(n);if(s)return Date.now()-s.time}getTimeUntilExpiration(n,s){const t=this.data.get(n);if(!t)return 0;const i=s||this.defaultTTL,h=Date.now()-t.time,b=i-h;return Math.max(0,b)}getStats(){return{...this.stats,entryCount:this.data.size,totalEntries:this.data.size,memoryUsage:this.calculateMemoryUsage()}}getCacheInfo(){return{totalEntries:this.data.size,rateLimitedKeys:[],expiredEntries:this.stats.expiredEntries,staleEntries:this.stats.staleEntries,memoryUsage:this.calculateMemoryUsage(),hits:this.stats.hits,misses:this.stats.misses}}cleanup(){const n=Date.now();let s=0;for(const[t,i]of this.data.entries())n-i.time>this.defaultTTL&&(this.data.delete(t),this.removeFromLocalStorage(t),s++);this.stats.expiredEntries+=s,this.stats.entryCount=this.data.size,this.stats.totalEntries=this.data.size}getTimeUntilNextRequest(n){return this.getTimeUntilExpiration(n)}setDefaultTTL(n){this.defaultTTL=n}getDefaultTTL(){return this.defaultTTL}calculateMemoryUsage(){let n=0;for(const[s,t]of this.data.entries())n+=JSON.stringify(s).length+JSON.stringify(t).length;return n}}function gt(a,n="smart_cache",s=!0){const t=new pt(n,s);return a&&t.setDefaultTTL(a),t}const le=gt(30*60*1e3,"trading_data_cache",!0),be=()=>{var P;const[a,n]=w.useState(null),[s,t]=w.useState(!0),[i,h]=w.useState(null),[b,I]=w.useState({isFresh:!1,timeUntilNextRefresh:0,isRateLimited:!1}),m="Calculations",d="A:G",M="Coinbase Balance",x="A:D",g="Transactions Raw Data",F="T:T",$=w.useCallback(l=>{var S,k,j,A,E,W,G,p,R,L,D;if(!l||l.length<23)return null;try{const T=q=>{if(!q)return 0;const X=q.toString().replace(/[$,%]/g,"").trim();return parseFloat(X)||0};return{availableUSDC:T((S=l[3])==null?void 0:S[1]),openTradingPositions:T((k=l[4])==null?void 0:k[1]),totalAccountValue:T((j=l[5])==null?void 0:j[1]),totalCapitalDeposited:T((A=l[10])==null?void 0:A[1]),profitsWithdrawn:T((E=l[11])==null?void 0:E[1]),netCapitalAtRisk:T((W=l[12])==null?void 0:W[1]),realizedProfits:T((G=l[17])==null?void 0:G[1]),totalTrades:T((p=l[18])==null?void 0:p[1]),avgProfitPerTrade:T((R=l[19])==null?void 0:R[1]),totalTradingVolume:T((L=l[21])==null?void 0:L[1]),profitsSaved:T((D=l[22])==null?void 0:D[1])}}catch(T){return console.error("Error parsing Coinbase Balance:",T),null}},[]),Y=w.useCallback(l=>{if(!l||l.length<2)return 0;const S=[];for(let A=1;A<l.length;A++){const E=l[A],W=E==null?void 0:E[0];if(W&&W.toString().trim()!==""){let G=W.toString().replace(/[%]/g,"").trim();const p=parseFloat(G);if(!isNaN(p)&&p!==0){const R=p<1?p*100:p;S.push(R)}}}if(S.length===0)return 0;const j=S.reduce((A,E)=>A+E,0)/S.length;return console.log(`[parsePercentGainColumn] Parsed ${S.length} % gains, average: ${j.toFixed(2)}%`),j},[]),H=w.useCallback((l,S)=>{var T,q,X,_,ee,pe,we,ce,r,y;if(console.log("[parseCalculationsData] Rows received:",l==null?void 0:l.length,"rows"),console.log("[parseCalculationsData] First row (headers):",l==null?void 0:l[0]),console.log("[parseCalculationsData] Last 3 rows:",l==null?void 0:l.slice(-3)),!l||l.length<3)return console.warn("[parseCalculationsData] FALLBACK: Not enough rows (need 3, got",l==null?void 0:l.length,")"),O();let k=null,j=-1;for(let c=l.length-1;c>=0;c--){const u=l[c],f=((T=u==null?void 0:u[0])==null?void 0:T.toString().toLowerCase())||"";if(console.log(`[parseCalculationsData] Row ${c}: length=${u==null?void 0:u.length}, firstCell="${u==null?void 0:u[0]}"`),u&&u.length>=2&&f.includes("grand total")){k=u,j=c,console.log("[parseCalculationsData] FOUND Grand Total at row",c,":",u);break}}if(!k||k.length<2)return console.warn("[parseCalculationsData] FALLBACK: Grand Total row not found or too short"),console.warn("[parseCalculationsData] grandTotalRow:",k),O();const A=parseFloat((q=k[1])==null?void 0:q.toString().replace(/[$,]/g,""))||0,E=parseInt((X=k[2])==null?void 0:X.toString().replace(/[,]/g,""))||0;console.log("[parseCalculationsData] Grand Total: $"+A+", "+E+" trades");let W=0,G=0,p=0,R=0;for(let c=j-1;c>=1;c--){const u=l[c];if(u&&u.length>=7){const f=parseFloat((_=u[3])==null?void 0:_.toString().replace(/[$,]/g,""))||0,C=parseFloat((ee=u[4])==null?void 0:ee.toString().replace(/[$,]/g,""))||0,z=parseFloat((pe=u[5])==null?void 0:pe.toString().replace(/[$,]/g,""))||0,B=parseFloat((we=u[6])==null?void 0:we.toString().replace(/[$,]/g,""))||0;if(f>0||C>0||z>0||B>0){W=f,G=C,p=z,R=B,console.log("[parseCalculationsData] Found calculated fields in row",c,":",u[0]),console.log("[parseCalculationsData] Calculated fields:",{avgProfitPerTrade:W,monthlyAverage:G,dailyAvg:p,bestMonthProfit:R});break}}}W===0&&G===0&&console.warn("[parseCalculationsData] WARNING: Calculated fields not found in any month row");const L=[],D=new Date().getFullYear();console.log("[parseCalculationsData] Parsing monthly data, rows 1 to",j-1);for(let c=1;c<j;c++){const u=l[c];if(u&&u.length>=2){const f=(ce=u[0])==null?void 0:ce.toString().trim(),C=parseFloat((r=u[1])==null?void 0:r.toString().replace(/[$,]/g,""))||0,z=parseInt((y=u[2])==null?void 0:y.toString().replace(/[,]/g,""))||0;if(f&&f!=="Grand Total"&&f!==""&&!f.toLowerCase().includes("month")){let B=f,U=D;if(f.includes("-")){const te=f.split("-");if(te.length>=2){U=parseInt(te[0])||D;const xe=parseInt(te[1]);B=["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][xe]||f}}else f.length>3&&(B=f.substring(0,3));L.push({month:B,year:U,profit:C,trades:z}),console.log(`[parseCalculationsData] Added month: ${B} ${U}, profit: $${C}, trades: ${z}`)}}}return console.log("[parseCalculationsData] SUCCESS: Parsed",L.length,"months of data"),console.log("[parseCalculationsData] Final totals: $"+A.toFixed(2)+", "+E+" trades"),{totalProfit:A,totalTrades:E,avgProfitPerTrade:W,monthlyAverage:G,dailyAvg:p,bestMonthProfit:R,avgPercentGain:0,monthlyData:L,isLiveData:!0,lastUpdated:S}},[]),O=()=>{console.error("⚠️ [getMockTradingStatsBase] USING MOCK DATA - API parsing failed!"),console.error("⚠️ This means the site is showing FAKE data of $3,905.39 instead of real data."),console.error("⚠️ Check the parsing logs above to see why.");const l=[{month:"Sep",year:2024,profit:312.45,trades:68},{month:"Oct",year:2024,profit:445.89,trades:92},{month:"Nov",year:2024,profit:523.12,trades:105},{month:"Dec",year:2024,profit:398.67,trades:84},{month:"Jan",year:2025,profit:477.23,trades:89},{month:"Feb",year:2025,profit:686.71,trades:124},{month:"Mar",year:2025,profit:261.97,trades:67},{month:"Apr",year:2025,profit:552.58,trades:98},{month:"May",year:2025,profit:376.3,trades:82},{month:"Jun",year:2025,profit:382.97,trades:91},{month:"Jul",year:2025,profit:817.31,trades:156},{month:"Aug",year:2025,profit:350.32,trades:78}],S=l.reduce((j,A)=>j+A.profit,0),k=l.reduce((j,A)=>j+A.trades,0);return{totalProfit:S,totalTrades:k,avgProfitPerTrade:k>0?S/k:0,monthlyAverage:l.length>0?S/l.length:0,dailyAvg:15.5,bestMonthProfit:Math.max(...l.map(j=>j.profit)),avgPercentGain:2.35,monthlyData:l,isLiveData:!1,lastUpdated:new Date().toISOString()}},K=w.useCallback(async(l=!1)=>{var S;try{t(!0),h(null);const k="1Q8I0kU3TinicEOZCgBjisRbktIOryaKnJ2GaBncxako",j="AIzaSyDNQznjzn8BijyHJWWOesvggVc31FFK-LA",A=new Date().toISOString(),[E,W,G]=await Promise.allSettled([fetch(`https://sheets.googleapis.com/v4/spreadsheets/${k}/values/${m}!${d}?key=${j}`),fetch(`https://sheets.googleapis.com/v4/spreadsheets/${k}/values/${M}!${x}?key=${j}`),fetch(`https://sheets.googleapis.com/v4/spreadsheets/${k}/values/${g}!${F}?key=${j}`)]);console.log("[fetchEnhancedTradingStats] Calculations API response status:",E.status);const p=E.status==="fulfilled"?await E.value.json():null;p?console.log("[fetchEnhancedTradingStats] Calculations data received:",(S=p.values)==null?void 0:S.length,"rows"):console.error("[fetchEnhancedTradingStats] Calculations API call failed completely");const R=p!=null&&p.values?H(p.values,A):O();console.log("[fetchEnhancedTradingStats] Using",R.isLiveData?"✅ LIVE DATA":"❌ MOCK DATA");const L=W.status==="fulfilled"?await W.value.json():null,D=L?$(L.values||[]):null,T=G.status==="fulfilled"?await G.value.json():null,q=T!=null&&T.values?Y(T.values):0,X={...R,avgPercentGain:q,portfolioSummary:D||void 0};n(X),I({isFresh:!l,timeUntilNextRefresh:0,isRateLimited:!1})}catch(k){console.error("Error fetching enhanced trading stats:",k),h(k instanceof Error?k.message:"Failed to load trading data");const j=v();n(j)}finally{t(!1)}},[H,$,Y]),v=()=>{console.log("🧪 [getEnhancedMockTradingStats] Using mock data with 2024+2025 for multi-year test");const l=[{month:"Sep",year:2024,profit:312.45,trades:68},{month:"Oct",year:2024,profit:445.89,trades:92},{month:"Nov",year:2024,profit:523.12,trades:105},{month:"Dec",year:2024,profit:398.67,trades:84},{month:"Jan",year:2025,profit:477.23,trades:89},{month:"Feb",year:2025,profit:686.71,trades:124},{month:"Mar",year:2025,profit:261.97,trades:67},{month:"Apr",year:2025,profit:552.58,trades:98},{month:"May",year:2025,profit:376.3,trades:82},{month:"Jun",year:2025,profit:382.97,trades:91},{month:"Jul",year:2025,profit:817.31,trades:156},{month:"Aug",year:2025,profit:350.32,trades:78},{month:"Sep",year:2025,profit:425.6,trades:88},{month:"Oct",year:2025,profit:512.45,trades:102},{month:"Nov",year:2025,profit:389.2,trades:76},{month:"Dec",year:2025,profit:298.5,trades:62}],S=l.reduce((j,A)=>j+A.profit,0),k=l.reduce((j,A)=>j+A.trades,0);return{totalProfit:S,totalTrades:k,avgProfitPerTrade:k>0?S/k:0,monthlyAverage:l.length>0?S/l.length:0,dailyAvg:15.5,bestMonthProfit:686.71,avgPercentGain:2.35,monthlyData:l,isLiveData:!1,lastUpdated:new Date().toISOString(),portfolioSummary:void 0}};return w.useEffect(()=>{K()},[K]),{tradingStats:a,isLoading:s,error:i,refreshStats:()=>K(!0),cacheInfo:b,cacheStats:((P=le==null?void 0:le.getStats)==null?void 0:P.call(le))||{hits:0,misses:0,size:0}}},yt=({title:a="MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams",description:n="Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system. Start your automated trading journey today.",keywords:s="robotic trading, crypto trading, automated trading, passive income, cryptocurrency, trading bot, AI trading, revenue streams",ogTitle:t="MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams",ogDescription:i="Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system.",ogImage:h="https://5defe27d.myrobotictrader.pages.dev/og-image.png",twitterTitle:b="MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams",twitterDescription:I="Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system.",twitterImage:m="https://myrobotictrader.com/robot-twitter.png",canonicalUrl:d="https://myrobotictrader.com/",pageType:M="home"})=>(w.useEffect(()=>{document.title=a;const x=(v,P,l)=>{const S=l?`meta[property="${v}"]`:`meta[name="${v}"]`;let k=document.querySelector(S);k||(k=document.createElement("meta"),l?k.setAttribute("property",v):k.setAttribute("name",v),document.head.appendChild(k)),k.setAttribute("content",P)},g=(v,P)=>{let l=document.querySelector(`link[rel="${v}"]`);l||(l=document.createElement("link"),l.setAttribute("rel",v),document.head.appendChild(l)),l.setAttribute("href",P)};x("title",a),x("description",n),x("keywords",s),x("og:type","website",!0),x("og:url",d,!0),x("og:title",t,!0),x("og:description",i,!0),x("og:image",h,!0),x("og:site_name","MyRoboticTrader",!0),x("twitter:card","summary_large_image",!0),x("twitter:url",d,!0),x("twitter:title",b,!0),x("twitter:description",I,!0),x("twitter:image",m,!0),g("canonical",d),document.querySelectorAll('script[type="application/ld+json"]').forEach(v=>{var P;(P=v.id)!=null&&P.startsWith("structured-data-")&&v.remove()});const $=(v,P)=>{const l=document.createElement("script");l.type="application/ld+json",l.id=`structured-data-${P}`,l.textContent=JSON.stringify(v,null,2),document.head.appendChild(l)},Y={"@context":"https://schema.org","@type":"WebSite",name:"MyRoboticTrader",alternateName:"My Robotic Trader",url:d,description:n,author:{"@type":"Person",name:"Patrick Jenkins",jobTitle:"Automated Trading Specialist",knowsAbout:["Cryptocurrency Trading","Automated Trading Systems","AI Trading","Passive Income"]},potentialAction:{"@type":"SearchAction",target:{"@type":"EntryPoint",urlTemplate:`${d}search?q={search_term_string}`},"query-input":"required name=search_term_string"}},H={"@context":"https://schema.org","@type":"Organization",name:"MyRoboticTrader",url:d,logo:{"@type":"ImageObject",url:"https://myrobotictrader.com/favicon-32x32.png",width:32,height:32},description:"Leading platform for AI-enhanced autonomous cryptocurrency trading",foundingDate:"2025",founder:{"@type":"Person",name:"Patrick Jenkins"},contactPoint:{"@type":"ContactPoint",contactType:"customer service",email:"support@myrobotictrader.com"},areaServed:"Worldwide",serviceType:"Automated Trading Platform"},O={"@context":"https://schema.org","@type":"Person",name:"Patrick Jenkins",jobTitle:"Automated Trading Specialist & Founder",worksFor:{"@type":"Organization",name:"MyRoboticTrader"},knowsAbout:["Cryptocurrency Trading","Automated Trading Systems","AI Trading Algorithms","Passive Income Generation","Risk Management","Financial Technology"],description:"Expert in AI-enhanced autonomous cryptocurrency trading with proven track record of building sustainable revenue streams",url:d},K={"@context":"https://schema.org","@type":"FAQPage",mainEntity:[{"@type":"Question",name:"How does automated crypto trading work?",acceptedAnswer:{"@type":"Answer",text:"Our AI-enhanced robotic trading system analyzes market conditions 24/7 and executes trades based on proven algorithms. The system runs autonomously, requiring no manual intervention while building sustainable revenue streams."}},{"@type":"Question",name:"Is automated trading safe?",acceptedAnswer:{"@type":"Answer",text:"Yes, when done properly with robust risk management. Our system includes built-in safety features like stop losses, position sizing, and maximum drawdown limits to protect your capital."}},{"@type":"Question",name:"How much money do I need to start?",acceptedAnswer:{"@type":"Answer",text:"You can start with as little as $1,000, though we recommend at least $5,000 for better diversification and risk management. The system scales with your account size."}}]};if(M==="home"){const v={"@context":"https://schema.org","@type":"Article",headline:"AI-Enhanced Autonomous Robotic Crypto Trading Results",description:n,author:{"@type":"Person",name:"Patrick Jenkins"},publisher:{"@type":"Organization",name:"MyRoboticTrader",logo:{"@type":"ImageObject",url:h}},datePublished:"2025-01-08",dateModified:new Date().toISOString().split("T")[0],mainEntityOfPage:{"@type":"WebPage","@id":d},image:{"@type":"ImageObject",url:h,width:1200,height:630},articleSection:"Trading Results",keywords:s};$(v,"article")}M==="resources"&&$({"@context":"https://schema.org","@type":"Course",name:"AI-Enhanced Autonomous Crypto Trading with GoBabyTrade",description:"Comprehensive resources and tools for automated cryptocurrency trading with GoBabyTrade",provider:{"@type":"Organization",name:"MyRoboticTrader"},instructor:{"@type":"Person",name:"Patrick Jenkins"},courseMode:"online",educationalLevel:"Beginner to Advanced",about:"Automated Trading, Cryptocurrency, AI Trading Systems, GoBabyTrade"},"course"),$(Y,"website"),$(H,"organization"),$(O,"person"),$(K,"faq")},[a,n,s,t,i,h,b,I,m,d,M]),null),bt=()=>(w.useEffect(()=>{const a=()=>{const s=document.head;s.querySelectorAll('meta[data-dynamic="true"]').forEach(b=>b.remove()),[{name:"title",content:"MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams"},{name:"description",content:"Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system. Start your automated trading journey today."},{name:"keywords",content:"robotic trading, crypto trading, automated trading, passive income, cryptocurrency, trading bot, AI trading, revenue streams"},{name:"robots",content:"index, follow"},{name:"author",content:"Patrick Jenkins"},{name:"theme-color",content:"#8B5CF6"},{property:"og:type",content:"website"},{property:"og:url",content:"https://myrobotictrader.com/"},{property:"og:title",content:"MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams"},{property:"og:description",content:"Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system."},{property:"og:image",content:"https://myrobotictrader.com/og-image.png"},{property:"og:image:width",content:"1200"},{property:"og:image:height",content:"630"},{property:"og:image:type",content:"image/png"},{property:"og:site_name",content:"MyRoboticTrader"},{property:"og:locale",content:"en_US"},{property:"twitter:card",content:"summary_large_image"},{property:"twitter:site",content:"@myrobotictrader"},{property:"twitter:creator",content:"@myrobotictrader"},{property:"twitter:url",content:"https://myrobotictrader.com/"},{property:"twitter:title",content:"MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams"},{property:"twitter:description",content:"Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system."},{property:"twitter:image",content:"https://myrobotictrader.com/twitter-image.png"},{property:"twitter:image:alt",content:"MyRoboticTrader - Automated Crypto Trading Results"},{property:"linkedin:owner",content:"Patrick Jenkins"},{property:"og:image:secure_url",content:"https://myrobotictrader.com/og-image.png"}].forEach(({name:b,property:I,content:m})=>{const d=document.createElement("meta");d.setAttribute("data-dynamic","true"),b?d.setAttribute("name",b):I&&d.setAttribute("property",I),d.setAttribute("content",m),s.appendChild(d)}),document.title="MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams";let h=s.querySelector('link[rel="canonical"]');h||(h=document.createElement("link"),h.setAttribute("rel","canonical"),h.setAttribute("data-dynamic","true"),s.appendChild(h)),h.setAttribute("href","https://myrobotictrader.com/")};a(),setTimeout(a,100),(()=>{document.querySelectorAll('script[type="application/ld+json"][data-static="true"]').forEach(i=>i.remove()),[{id:"website-static",data:{"@context":"https://schema.org","@type":"WebSite",name:"MyRoboticTrader",alternateName:"My Robotic Trader",url:"https://myrobotictrader.com/",description:"Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system.",author:{"@type":"Person",name:"Patrick Jenkins",jobTitle:"Automated Trading Specialist"}}},{id:"organization-static",data:{"@context":"https://schema.org","@type":"Organization",name:"MyRoboticTrader",url:"https://myrobotictrader.com/",logo:{"@type":"ImageObject",url:"https://myrobotictrader.com/og-image.png",width:1200,height:630},description:"Leading platform for AI-enhanced autonomous cryptocurrency trading",founder:{"@type":"Person",name:"Patrick Jenkins"}}}].forEach(({id:i,data:h})=>{const b=document.createElement("script");b.type="application/ld+json",b.setAttribute("data-static","true"),b.id=i,b.textContent=JSON.stringify(h,null,2),document.head.appendChild(b)})})()},[]),null),ft=()=>{const a=w.useRef(null);return w.useEffect(()=>{setTimeout(()=>{const s=a.current;if(!s)return;const t=s.getContext("2d");if(!t)return;s.width=1200,s.height=630;const i=t.createLinearGradient(0,0,1200,630);i.addColorStop(0,"#0f172a"),i.addColorStop(.5,"#7c3aed"),i.addColorStop(1,"#0f172a"),t.fillStyle=i,t.fillRect(0,0,1200,630),t.fillStyle="rgba(139, 92, 246, 0.1)",t.beginPath(),t.arc(200,150,100,0,Math.PI*2),t.fill(),t.fillStyle="rgba(236, 72, 153, 0.1)",t.beginPath(),t.arc(1e3,480,120,0,Math.PI*2),t.fill(),t.fillStyle="#ffffff",t.font="bold 64px Arial, sans-serif",t.textAlign="center",t.fillText("MyRoboticTrader",600,200),t.font="36px Arial, sans-serif",t.fillStyle="#e2e8f0",t.fillText("Set It and Forget It Crypto Trading",600,260),t.font="bold 48px Arial, sans-serif",t.fillStyle="#10b981",t.fillText("$12,450 Total Profits",600,350),t.font="28px Arial, sans-serif",t.fillStyle="#a78bfa",t.fillText("Real Results • 8+ Months Trading • Always Growing",600,400),t.font="bold 32px Arial, sans-serif",t.fillStyle="#fbbf24",t.fillText("Get Free Training Now",600,500),t.fillStyle="#8b5cf6",t.fillRect(550,520,100,60),t.fillStyle="#ffffff",t.font="bold 36px Arial, sans-serif",t.textAlign="center",t.fillText("R",600,560),s.toBlob(h=>{if(h){const b=URL.createObjectURL(h),I=document.querySelector('meta[property="og:image"]'),m=document.querySelector('meta[property="twitter:image"]');I&&I.setAttribute("content",b),m&&m.setAttribute("content",b)}},"image/png",.9)},100)},[]),e.jsx("canvas",{ref:a,style:{display:"none"},width:1200,height:630})};var wt={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};const xt=a=>a.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),vt=(a,n)=>{const s=w.forwardRef(({color:t="currentColor",size:i=24,strokeWidth:h=2,absoluteStrokeWidth:b,children:I,...m},d)=>w.createElement("svg",{ref:d,...wt,width:i,height:i,stroke:t,strokeWidth:b?Number(h)*24/Number(i):h,className:`lucide lucide-${xt(a)}`,...m},[...n.map(([M,x])=>w.createElement(M,x)),...(Array.isArray(I)?I:[I])||[]]));return s.displayName=`${a}`,s};var N=vt;const kt=N("Activity",[["path",{d:"M22 12h-4l-3 9L9 3l-3 9H2",key:"d5dnw9"}]]),Tt=N("AlertCircle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]),Nt=N("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]),Z=N("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]),jt=N("ArrowUp",[["path",{d:"m5 12 7-7 7 7",key:"hav0vg"}],["path",{d:"M12 19V5",key:"x0mq9r"}]]),qe=N("BarChart3",[["path",{d:"M3 3v18h18",key:"1s2lah"}],["path",{d:"M18 17V9",key:"2bz60n"}],["path",{d:"M13 17V5",key:"1frdt8"}],["path",{d:"M8 17v-3",key:"17ska0"}]]),It=N("BookOpen",[["path",{d:"M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z",key:"vv98re"}],["path",{d:"M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z",key:"1cyq3y"}]]),Ie=N("Bot",[["rect",{width:"18",height:"10",x:"3",y:"11",rx:"2",key:"1ofdy3"}],["circle",{cx:"12",cy:"5",r:"2",key:"f1ur92"}],["path",{d:"M12 7v4",key:"xawao1"}],["line",{x1:"8",x2:"8",y1:"16",y2:"16",key:"h6x27f"}],["line",{x1:"16",x2:"16",y1:"16",y2:"16",key:"5lty7f"}]]),De=N("Calculator",[["rect",{width:"16",height:"20",x:"4",y:"2",rx:"2",key:"1nb95v"}],["line",{x1:"8",x2:"16",y1:"6",y2:"6",key:"x4nwl0"}],["line",{x1:"16",x2:"16",y1:"14",y2:"18",key:"wjye3r"}],["path",{d:"M16 10h.01",key:"1m94wz"}],["path",{d:"M12 10h.01",key:"1nrarc"}],["path",{d:"M8 10h.01",key:"19clt8"}],["path",{d:"M12 14h.01",key:"1etili"}],["path",{d:"M8 14h.01",key:"6423bh"}],["path",{d:"M12 18h.01",key:"mhygvu"}],["path",{d:"M8 18h.01",key:"lrp35t"}]]),Ue=N("Calendar",[["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",ry:"2",key:"eu3xkr"}],["line",{x1:"16",x2:"16",y1:"2",y2:"6",key:"m3sa8f"}],["line",{x1:"8",x2:"8",y1:"2",y2:"6",key:"18kwsl"}],["line",{x1:"3",x2:"21",y1:"10",y2:"10",key:"xt86sb"}]]),J=N("CheckCircle",[["path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14",key:"g774vq"}],["polyline",{points:"22 4 12 14.01 9 11.01",key:"6xbx8j"}]]),Ke=N("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]),Re=N("ChevronLeft",[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]]),He=N("ChevronRight",[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]]),_e=N("ChevronUp",[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]]),fe=N("Clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]]),St=N("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]),de=N("DollarSign",[["line",{x1:"12",x2:"12",y1:"2",y2:"22",key:"7eqyqh"}],["path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6",key:"1b0p4s"}]]),At=N("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]),me=N("ExternalLink",[["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}],["polyline",{points:"15 3 21 3 21 9",key:"mznyad"}],["line",{x1:"10",x2:"21",y1:"14",y2:"3",key:"18c3s4"}]]),$t=N("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]),Je=N("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]),Bt=N("Gift",[["polyline",{points:"20 12 20 22 4 22 4 12",key:"nda8fc"}],["rect",{width:"20",height:"5",x:"2",y:"7",key:"wkgdzj"}],["line",{x1:"12",x2:"12",y1:"22",y2:"7",key:"1n8zgp"}],["path",{d:"M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z",key:"zighg4"}],["path",{d:"M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z",key:"1pa5tk"}]]),Ct=N("Heart",[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]]),Ve=N("HelpCircle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]),Mt=N("Lightbulb",[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5",key:"1gvzjb"}],["path",{d:"M9 18h6",key:"x1upvd"}],["path",{d:"M10 22h4",key:"ceow96"}]]),Pt=N("Link",[["path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71",key:"1cjeqo"}],["path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71",key:"19qd67"}]]),Wt=N("Mail",[["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2",key:"18n3k1"}],["path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7",key:"1ocrg3"}]]),Et=N("Menu",[["line",{x1:"4",x2:"20",y1:"12",y2:"12",key:"1e0a9i"}],["line",{x1:"4",x2:"20",y1:"6",y2:"6",key:"1owob3"}],["line",{x1:"4",x2:"20",y1:"18",y2:"18",key:"yk5zj1"}]]),Dt=N("Percent",[["line",{x1:"19",x2:"5",y1:"5",y2:"19",key:"1x9vlm"}],["circle",{cx:"6.5",cy:"6.5",r:"2.5",key:"4mh3h7"}],["circle",{cx:"17.5",cy:"17.5",r:"2.5",key:"1mdrzq"}]]),Rt=N("RefreshCw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]),Ht=N("Rocket",[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z",key:"m3kijz"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z",key:"1fmvmk"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0",key:"1f8sc4"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5",key:"qeys4"}]]),oe=N("Shield",[["path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z",key:"3xmgem"}]]),Lt=N("Smartphone",[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2",key:"1yt0o3"}],["path",{d:"M12 18h.01",key:"mhygvu"}]]),ge=N("Target",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"12",r:"6",key:"1vlfrh"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]]),V=N("TrendingUp",[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17",key:"126l90"}],["polyline",{points:"16 7 22 7 22 13",key:"kwv8wd"}]]),Ft=N("Twitter",[["path",{d:"M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z",key:"pff0z6"}]]),Ze=N("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]),Qe=N("Users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75",key:"1da9ce"}]]),Le=N("Wallet",[["path",{d:"M21 12V7H5a2 2 0 0 1 0-4h14v4",key:"195gfw"}],["path",{d:"M3 5v14a2 2 0 0 0 2 2h16v-5",key:"195n9w"}],["path",{d:"M18 12a2 2 0 0 0 0 4h4v-4Z",key:"vllfpd"}]]),Ot=N("Wifi",[["path",{d:"M5 13a10 10 0 0 1 14 0",key:"6v8j51"}],["path",{d:"M8.5 16.5a5 5 0 0 1 7 0",key:"sej527"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0",key:"dnpr2z"}],["line",{x1:"12",x2:"12.01",y1:"20",y2:"20",key:"of4bc4"}]]),Yt=N("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),ye=N("Zap",[["polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2",key:"45s27k"}]]),Gt=()=>{const a=[{Icon:Ie,delay:"0s",position:"top-20 left-20"},{Icon:V,delay:"2s",position:"top-32 right-32"},{Icon:oe,delay:"4s",position:"bottom-40 left-16"},{Icon:fe,delay:"1s",position:"bottom-32 right-20"},{Icon:ye,delay:"3s",position:"top-1/2 left-8"},{Icon:de,delay:"5s",position:"top-1/3 right-8"}];return e.jsx(e.Fragment,{children:a.map(({Icon:n,delay:s,position:t},i)=>e.jsx("div",{className:`absolute ${t} opacity-20 pointer-events-none hidden lg:block animate-float-subtle`,style:{animationDelay:s},children:e.jsx("div",{className:"w-8 h-8 text-purple-300",children:e.jsx(n,{className:"w-full h-full"})})},i))})},zt=()=>{const a=new Date(2025,0,8),n=new Date;let s=(n.getFullYear()-a.getFullYear())*12;return s+=n.getMonth()-a.getMonth(),n.getDate()<a.getDate()&&s--,Math.max(0,s)},qt=()=>{const{tradingStats:a,isLoading:n}=be(),s=zt(),t=()=>{Ne("start_trading_save_1000","hero"),je("https://gobabytrade.com/432706BE","Start Trading Save $1000")};return e.jsxs("section",{className:"relative min-h-screen flex items-center justify-center px-4 overflow-hidden pb-10 pt-10",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"}),e.jsx("div",{className:"absolute top-0 left-0 w-full h-full bg-gradient-to-br from-transparent via-purple-500/15 to-transparent"}),e.jsx(Gt,{}),e.jsxs("div",{className:"relative max-w-6xl mx-auto text-center z-10 mt-32",children:[e.jsxs("div",{className:"mb-8",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-400/40 mb-2 mt-4 shadow-lg shadow-purple-500/20",children:[e.jsx(Ie,{className:"w-4 h-4 text-purple-300"}),e.jsx("span",{className:"text-purple-200 font-medium",children:"AI-Enhanced Autonomous Trading"})]}),e.jsxs("p",{className:"text-sm text-gray-400 mb-4",children:["Powered by"," ",e.jsx("a",{href:"https://gobabytrade.com/432706BE",target:"_blank",rel:"noopener noreferrer",className:"text-purple-300 hover:text-purple-200 transition-colors",children:"GoBabyTrade"})]}),e.jsxs("h1",{className:"text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-6 leading-tight px-4",children:[e.jsxs("span",{className:"block md:hidden",children:["Building Revenue Streams",e.jsx("span",{className:"block text-transparent bg-gradient-to-r from-green-300 via-blue-400 to-purple-400 bg-clip-text",children:"Without Watching Charts"})]}),e.jsxs("span",{className:"hidden md:block",children:["How I'm Building Multiple",e.jsx("span",{className:"block text-transparent bg-gradient-to-r from-green-300 via-blue-400 to-purple-400 bg-clip-text",children:"Revenue Streams"}),e.jsx("span",{className:"block text-white",children:"Without Watching Charts"})]})]}),e.jsx("p",{className:"text-lg sm:text-xl md:text-2xl text-gray-200 mb-4 max-w-4xl mx-auto px-4",children:n?e.jsx("span",{className:"text-gray-300",children:"Loading live results..."}):e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"text-green-300 font-bold",children:["$",a==null?void 0:a.totalProfit.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}),"+ profit"]})," ","in"," ",e.jsxs("span",{className:"text-blue-300 font-bold",children:[s,"+ months"]})," ","using AI-enhanced autonomous trading most people don't know exists."]})}),e.jsx("p",{className:"text-base sm:text-lg md:text-xl text-gray-300 mb-8 max-w-4xl mx-auto px-4",children:"See my live results below."})]}),e.jsx("div",{className:"flex flex-col sm:flex-row gap-4 justify-center mb-16",children:e.jsxs("a",{href:"https://gobabytrade.com/432706BE",onClick:t,target:"_blank",rel:"noopener noreferrer",className:"group bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-purple-500/30 flex items-center justify-center gap-2",children:["Start Trading – Save $1,000",e.jsx(Z,{className:"w-5 h-5 group-hover:translate-x-1 transition-transform"})]})}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10",children:[e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-green-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-green-500 to-emerald-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-green-500/40",children:e.jsx(oe,{className:"w-full h-full text-white"})}),e.jsx("div",{className:"relative text-center",children:n?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"text-2xl font-bold text-green-300 mb-2 animate-pulse",children:"Loading..."}),e.jsx("div",{className:"text-gray-200 font-medium",children:"Total Profit"})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-4xl font-bold text-green-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-green-300 group-hover:to-emerald-300 group-hover:bg-clip-text transition-all duration-300",children:["$",a==null?void 0:a.totalProfit.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}),"+"]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Total Profit"}),(a==null?void 0:a.isLiveData)&&e.jsxs("div",{className:"mt-2 flex items-center justify-center gap-1",children:[e.jsx("div",{className:"w-2 h-2 bg-green-400 rounded-full animate-pulse"}),e.jsx("span",{className:"text-xs text-green-300",children:"LIVE"})]})]})}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-blue-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-blue-500 to-cyan-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-blue-500/40",children:e.jsx(fe,{className:"w-full h-full text-white"})}),e.jsx("div",{className:"relative text-center",children:n?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"text-2xl font-bold text-blue-300 mb-2 animate-pulse",children:"Loading..."}),e.jsx("div",{className:"text-gray-200 font-medium",children:"Profitable"})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-4xl font-bold text-blue-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-300 group-hover:to-cyan-300 group-hover:bg-clip-text transition-all duration-300",children:[s,"+ Months"]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Profitable"})]})}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-purple-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-purple-500 to-pink-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-purple-500/40",children:e.jsx(Qe,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsx("div",{className:"text-4xl font-bold text-purple-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-300 group-hover:to-pink-300 group-hover:bg-clip-text transition-all duration-300",children:"Zero"}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Losing Months"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]})]}),e.jsx("div",{className:"max-w-2xl mx-auto",children:e.jsx("img",{src:"/graphics/homepage-hero-01.webp",alt:"Set It and Forget It - Manual Trading vs Autonomous Trading comparison",className:"w-full rounded-2xl shadow-2xl shadow-purple-500/20 border border-white/10"})})]})]})},ve=new Date(2025,0,8),Se=()=>{const a=new Date;let n=(a.getFullYear()-ve.getFullYear())*12;n+=a.getMonth()-ve.getMonth();let s=a.getDate()-ve.getDate();if(s<0){n--;const t=new Date(a.getFullYear(),a.getMonth(),0);s+=t.getDate()}if(n>=1)return s>0?`${n} month${n>1?"s":""}, ${s} day${s>1?"s":""}`:`${n} month${n>1?"s":""}`;{const t=Math.abs(a.getTime()-ve.getTime()),i=Math.ceil(t/(1e3*60*60*24));return`${i} day${i>1?"s":""}`}},Ut=({tradingStats:a})=>{var b;const n=Se(),t=a||{totalProfit:12450,totalTrades:1247,isLiveData:!1,dailyAvg:89},i=((b=a==null?void 0:a.dailyAvg)==null?void 0:b.toFixed(0))||"89",h=a!==null;return e.jsxs("section",{className:"py-16 px-4 relative overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-blue-900/20 to-purple-900/20"}),e.jsxs("div",{className:"relative max-w-6xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/30 to-purple-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-blue-400/40 mb-6 shadow-lg shadow-blue-500/20",children:[e.jsx(Ze,{className:"w-4 h-4 text-blue-300"}),e.jsx("span",{className:"text-blue-200 font-medium",children:"My Story"})]}),e.jsxs("h2",{className:"text-3xl md:text-5xl font-bold text-white mb-6",children:["Hi, I'm Patrick",e.jsx("span",{className:"block text-transparent bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text",children:"Here's How I Discovered This System"})]})]}),e.jsxs("div",{className:"bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl border border-blue-400/20 p-8 shadow-lg shadow-blue-500/10 mb-8",children:[e.jsx("img",{src:"/patrick-and-moses.jpeg",alt:"Patrick Jenkins with Moses",className:"hidden lg:block float-right ml-8 mb-6 w-80 h-80 rounded-2xl object-cover border-4 border-white/20 shadow-2xl shadow-purple-500/20"}),e.jsx("div",{className:"lg:hidden flex justify-center mb-8",children:e.jsx("img",{src:"/patrick-and-moses.jpeg",alt:"Patrick Jenkins with Moses",className:"w-64 h-64 rounded-2xl object-cover border-4 border-white/20 shadow-2xl shadow-purple-500/20"})}),e.jsxs("div",{className:"text-lg text-gray-200 leading-relaxed",children:[e.jsxs("h3",{className:"text-2xl font-bold text-blue-300 mb-4 flex items-center gap-2",children:[e.jsx(ge,{className:"w-6 h-6"}),"My Journey Started Like Yours"]}),e.jsx("p",{className:"mb-6",children:"I've been following the markets since 2014, and I genuinely love investing. I did okay with my stock investments, but tracking individual stocks became incredibly tedious. I got frustrated with mutual funds because of their fees and average returns - even index funds weren't delivering what I hoped for. Target date funds? Don't get me started on those."}),e.jsxs("h3",{className:"text-2xl font-bold text-blue-300 mb-4 flex items-center gap-2",children:[e.jsx(de,{className:"w-6 h-6"}),"Chasing the Dream of Extra Income"]}),e.jsxs("p",{className:"mb-4",children:[e.jsx("span",{className:"text-blue-200 font-semibold",children:"Like many of you, I've always wanted to make extra income in addition to my 9-to-5 job."})," ","Over the years, I invested tens of thousands in various courses and systems - email marketing, affiliate marketing, Amazon wholesale, you name it. Some methods seemed unreliable, and honestly, part of the problem was probably me not putting in full effort or knowing how to position myself properly."]}),e.jsx("p",{className:"mb-6",children:`I was tired of chasing the next "breakthrough" system. Tired of complex strategies that required constant attention. Tired of watching opportunities slip by because I was stuck at work or didn't have time to analyze the market.`}),e.jsxs("h3",{className:"text-2xl font-bold text-yellow-300 mb-4 flex items-center gap-2",children:[e.jsx(Mt,{className:"w-6 h-6"}),"Then Everything Changed"]}),e.jsxs("p",{className:"mb-4",children:["So when I discovered this autonomous trading system while researching new opportunities, my first thought was:"," ",e.jsx("span",{className:"italic text-yellow-200 font-semibold",children:`"Here's just another system promising easy money."`})," ","I was naturally skeptical - and you should be too."]}),e.jsxs("p",{className:"mb-6",children:[e.jsx("span",{className:"text-green-300 font-bold",children:"But this one is truly automated!"})," ","I set it up, connected my exchange accounts with trading-only API permissions, and started with a small amount to test it. The autonomous trader trades while I'm working, sleeping, or spending time with family."]}),e.jsxs("h3",{className:"text-2xl font-bold text-green-300 mb-4 flex items-center gap-2",children:[e.jsx(V,{className:"w-6 h-6"}),"The Results Speak for Themselves"]}),e.jsxs("p",{className:"mb-4",children:[e.jsxs("span",{className:"text-green-400 font-bold text-xl",children:["In just ",n,", my system has generated $",t.totalProfit.toLocaleString()," in realized profits."]})," ","That's an average of"," ",e.jsxs("span",{className:"text-green-300 font-semibold",children:["$",i," per day"]})," ","- money that's been withdrawn and spent on real life."]}),e.jsx("p",{className:"mb-6",children:`This isn't paper gains or "what if" projections. This is actual cash that I use for every day living. As of now, it's giving me the extra money to spend for every day expenses and save for emergencies. I'm also reinvesting a portion of my profits to scale my investment capital.`}),e.jsxs("h3",{className:"text-2xl font-bold text-pink-300 mb-4 flex items-center gap-2",children:[e.jsx(Ct,{className:"w-6 h-6"}),"The Best Part: Time with Moses"]}),e.jsx("div",{className:"lg:hidden flex justify-center mb-6",children:e.jsx("img",{src:"/moses-sprinkler.jpeg",alt:"Moses enjoying the sprinkler",className:"w-64 h-64 rounded-2xl object-cover border-4 border-white/20 shadow-2xl shadow-purple-500/20"})}),e.jsx("div",{className:"hidden lg:block",style:{float:"left",marginRight:"2rem",marginBottom:"1.5rem",width:"320px",height:"320px"},children:e.jsx("img",{src:"/moses-sprinkler.jpeg",alt:"Moses enjoying the sprinkler",className:"w-full h-full rounded-2xl object-cover border-4 border-white/20 shadow-2xl shadow-purple-500/20"})}),e.jsxs("p",{className:"mb-4",children:[e.jsx("span",{className:"text-pink-200 font-semibold",children:"I recently got a new dog named Moses, and this automated system gives me something priceless: time."})," ","While my trader works 24/7—executing trades, taking profits, managing positions—I'm at the park with Moses. I'm not glued to charts or stressed about missing opportunities."]}),e.jsx("p",{className:"mb-4",children:`That's what "Set It and Forget It" really means. The system handles everything while I actually live my life. No more choosing between making money and spending time with those I love. I get both.`}),e.jsx("p",{className:"mb-4",children:"Moses and I go to the park almost every day now. Whether it's morning walks, afternoon sprinkler sessions, or just lounging in the yard, I'm actually present for these moments. The autonomous trader is working in the background, but my focus is where it should be—on the simple joys that make life worth living."}),e.jsx("p",{className:"mb-6",children:"This is the freedom I always wanted: the ability to generate income without being chained to a screen, constantly watching markets and second-guessing decisions. The system does the work. I enjoy the life."}),e.jsxs("h3",{className:"text-2xl font-bold text-blue-300 mb-4 flex items-center gap-2",children:[e.jsx(J,{className:"w-6 h-6"}),"Why I'm Sharing This With You"]}),e.jsx("p",{className:"mb-4",children:"I see people struggling with finances every day - having too much month left at the end of the money. Working overtime just to stay afloat. Missing out on time with family because they need that extra shift."}),e.jsxs("p",{className:"mb-6",children:[e.jsx("span",{className:"text-blue-200 font-semibold",children:"This platform could genuinely help, but not many people know about it."})," ",`That's why I built this site and share what's working for me. As you can see, my total profits are not breaking any records, but it's consistent and reliable - It's truly "Set It and Forget It." My trader only takes what the market GIVES. I'm not a financial guru or marketing expert - I'm just someone who found something that works and wants to help others discover it too.`]})]}),e.jsx("div",{className:"clear-both"})]}),e.jsxs("div",{className:"text-center bg-gradient-to-r from-purple-500/10 to-blue-500/10 backdrop-blur-sm rounded-2xl border border-purple-400/20 p-8",children:[e.jsxs("p",{className:"text-gray-200 max-w-3xl mx-auto text-lg leading-relaxed",children:[e.jsx("span",{className:"text-white font-semibold",children:"Here's the truth:"})," ","I'm not a financial advisor, and I can't promise you'll get the same results I have. But I can show you exactly what's working for me, with real numbers that are updated"," ",h?"live":"regularly"," from my actual trading accounts below."]}),e.jsx("p",{className:"text-blue-300 mt-4 font-medium",children:"If you're ready to explore a different path to financial growth, keep reading."})]})]})]})},Kt=()=>{const[a,n]=w.useState([]),[s,t]=w.useState(!0),[i,h]=w.useState(null),[b,I]=w.useState(new Date),[m,d]=w.useState(!1),[M,x]=w.useState(!1),[g,F]=w.useState(1),[$,Y]=w.useState(null),H="Transactions Raw Data",O="A:T",K="Calculations",v="H14",P=w.useCallback(r=>{if(!r)return"$0.00";if(r.includes("$"))return r;const y=r.replace(/[,$]/g,""),c=parseFloat(y);return isNaN(c)?r:c<1e-5?`${c.toFixed(8)}`:c<.001?`${c.toFixed(5)}`:c<1?`${c.toFixed(4)}`:c<100?`${c.toFixed(2)}`:`${c.toLocaleString()}`},[]),l=w.useCallback(r=>{if(!r)return"0";const y=r.replace(/[,$]/g,""),c=parseFloat(y);return isNaN(c)?r:c>=1e6?`${(c/1e6).toFixed(1)}M`:c>=1e3?`${(c/1e3).toFixed(1)}K`:c<1?c.toFixed(3):c.toLocaleString()},[]),S=w.useCallback(r=>{if(!r)return"Unknown";if(r.toLowerCase().includes("today"))return r;try{const y=new Date(r);if(!isNaN(y.getTime())){const c=new Date;return y.toDateString()===c.toDateString()?`Today ${y.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`:y.toLocaleDateString()+" "+y.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}}catch{}return r},[]),k=w.useCallback(r=>r&&r.toLowerCase().includes("profit goal reached")?"profit_goal_reached":"completed",[]),j=w.useCallback(r=>!r||r.length===0?[]:r.map((y,c)=>{var Me;if(c===0&&((Me=y[0])==null?void 0:Me.toLowerCase())==="coin")return null;const[u,f,C,z,B,U,te]=y,xe=y[19];if(!u||!U)return null;const Be=parseFloat(U.toString().replace(/[$,]/g,""))||0;let Ce=null;if(xe){const Xe=xe.toString().replace(/[%]/g,"").trim(),Pe=parseFloat(Xe);isNaN(Pe)||(Ce=Pe)}return{id:`tx_${Date.now()}_${c}`,coin:(u==null?void 0:u.toString().trim())||"",action:(f==null?void 0:f.toString().trim())||"CLOSE",price:P((C==null?void 0:C.toString())||""),quantity:l((z==null?void 0:z.toString())||""),profit:Be,percentGain:Ce,timestamp:S((te==null?void 0:te.toString())||""),status:k((B==null?void 0:B.toString())||"")}}).filter(y=>y!==null&&y.coin.length>0&&y.profit!==void 0),[P,l,S,k]),A=w.useMemo(()=>{const r={};return a.forEach(y=>{const c=y.timestamp;let u="";if(c.toLowerCase().includes("today")){const f=new Date;u=`${f.toLocaleString("default",{month:"long"})} ${f.getFullYear()}`}else try{const f=new Date(c);if(!isNaN(f.getTime()))u=`${f.toLocaleString("default",{month:"long"})} ${f.getFullYear()}`;else{const C=c.match(/(\d+)\/(\d+)/);if(C){const z=parseInt(C[1]),B=new Date().getFullYear();u=`${new Date(B,z-1).toLocaleString("default",{month:"long"})} ${B}`}else u="Unknown"}}catch{u="Unknown"}r[u]||(r[u]=[]),r[u].push(y)}),r},[a]),E=w.useMemo(()=>Object.keys(A).filter(y=>y!=="Unknown").sort((y,c)=>{const u=new Date(y);return new Date(c).getTime()-u.getTime()}),[A]),W=w.useMemo(()=>{const r=E[g-1];return r?A[r]:[]},[A,E,g]),G=w.useMemo(()=>{const r=W.filter(C=>C.action==="CLOSE"),y=W.filter(C=>C.action==="OPEN"),c=r.reduce((C,z)=>C+z.profit,0),u=r.filter(C=>C.status==="profit_goal_reached").length,f=r.length>0?(r.length/r.length*100).toFixed(1):"100.0";return{totalProfit:`${c.toFixed(2)}`,closedTrades:r.length,openTrades:y.length,totalTrades:W.length,successRate:`${f}%`,profitGoals:u}},[W]),p=E.length,R=E[g-1]||"Unknown",L=r=>{r>=1&&r<=p&&F(r)},D=()=>{const y=[["Coin","Action","Price","Quantity","Profit","% Gain","Status","Timestamp"].join(",")];W.forEach(B=>{const U=[B.coin,B.action,B.price.replace(/,/g,""),B.quantity.replace(/,/g,""),B.action==="CLOSE"?B.profit.toFixed(2):"0.00",B.action==="CLOSE"&&B.percentGain!==null?B.percentGain.toFixed(2)+"%":"",B.status==="profit_goal_reached"?"Profit Goal Reached":"Completed",`"${B.timestamp}"`];y.push(U.join(","))});const c=y.join(`
`),u=new Blob([c],{type:"text/csv;charset=utf-8;"}),f=document.createElement("a"),C=URL.createObjectURL(u),z=`${R.replace(" ","_")}_Transactions.csv`;f.setAttribute("href",C),f.setAttribute("download",z),f.style.visibility="hidden",document.body.appendChild(f),f.click(),document.body.removeChild(f)},T=w.useCallback(()=>{const r=["","","","","","","","","","","",""],y=[["Coin","Action","Price","Quantity","Status","Profit","Timestamp",...r,"% Gain"],["SUI","CLOSE","$3.60","50.9","Profit Goal Reached","$7.34","Today 2:48 AM",...r,"4.01%"],["BONK","CLOSE","$0.00002","10.2M","Profit Goal Reached","$9.03","9/8 12:26 PM",...r,"4.43%"],["DOGE","CLOSE","$0.24","710","Completed","$5.16","9/8 9:19 AM",...r,"3.03%"],["BTC","CLOSE","$43,250.00","0.025","Profit Goal Reached","$12.45","9/7 11:45 PM",...r,"1.15%"],["ETH","CLOSE","$2,650.75","1.8","Completed","$8.92","9/7 6:33 PM",...r,"0.19%"],["ADA","OPEN","$0.45","2,450","Active Position","$0.00","9/7 2:15 PM",...r,""],["SOL","OPEN","$145.32","12.5","Active Position","$0.00","9/7 8:22 AM",...r,""],["MATIC","OPEN","$0.89","1,200","Active Position","$0.00","9/6 11:58 PM",...r,""],["LINK","CLOSE","$11.45","85.3","Completed","$9.87","9/6 7:41 PM",...r,"1.01%"],["DOT","CLOSE","$5.67","180.5","Completed","$7.12","9/6 3:29 PM",...r,"0.70%"]];return j(y)},[j]),q=w.useCallback(async()=>{const r="1Q8I0kU3TinicEOZCgBjisRbktIOryaKnJ2GaBncxako",y="AIzaSyDNQznjzn8BijyHJWWOesvggVc31FFK-LA";try{const c=`https://sheets.googleapis.com/v4/spreadsheets/${r}/values/${K}!${v}?key=${y}`,u=await fetch(c);if(!u.ok){console.error("Failed to fetch Profits Protected"),Y(null);return}const f=await u.json();if(f.values&&f.values[0]&&f.values[0][0]){const C=parseFloat(String(f.values[0][0]).replace(/[$,]/g,""));isNaN(C)||Y(C)}}catch(c){console.error("Error fetching Profits Protected:",c),Y(null)}},[K,v]),X=w.useCallback(async(r=!0)=>{try{r&&t(!0),h(null),x(!1);const y="1Q8I0kU3TinicEOZCgBjisRbktIOryaKnJ2GaBncxako",c="AIzaSyDNQznjzn8BijyHJWWOesvggVc31FFK-LA";if(y&&c){const f=`${y}_${H}_${O}`;let C=le.get(f);if(C){n(C),I(new Date),x(!0),t(!1);return}const z=`https://sheets.googleapis.com/v4/spreadsheets/${y}/values/${H}!${O}?key=${c}`;try{const B=await fetch(z);if(!B.ok)throw new Error(`Google Sheets API error: ${B.status}`);const U=await B.json();if(U.values&&U.values.length>0){const te=j(U.values);le.set(f,te),n(te),I(new Date),x(!1);return}else h("No data found. Using sample data.")}catch(B){console.error("API error:",B),h("Failed to load data.")}}await new Promise(f=>setTimeout(f,1e3));const u=T();n(u),I(new Date),x(!1)}catch(y){console.error("Error:",y),h("Error loading data."),n(T()),x(!1)}finally{t(!1)}},[H,O,j,T]);w.useEffect(()=>{X(),q()},[X,q]);const _=r=>({BTC:"text-orange-400",ETH:"text-blue-400",SUI:"text-purple-400",BONK:"text-yellow-400",DOGE:"text-yellow-300",SOL:"text-purple-500",MATIC:"text-indigo-400",ADA:"text-blue-500",LINK:"text-blue-600",DOT:"text-pink-400",AVAX:"text-red-400",UNI:"text-pink-500",ATOM:"text-purple-500",FTM:"text-blue-600",ALGO:"text-gray-400",XRP:"text-gray-300",LTC:"text-gray-500",BCH:"text-green-500",VET:"text-blue-700",THETA:"text-purple-600",HBAR:"text-gray-600",ICP:"text-orange-300",NEAR:"text-green-300",FLOW:"text-blue-800",MANA:"text-red-300"})[r]||"text-gray-400",ee=r=>r>=10?"text-green-300":r>=7?"text-green-400":"text-green-500",pe=r=>r==="CLOSE"?"bg-green-500/20 text-green-300":"bg-blue-500/20 text-blue-300",we=()=>i?{text:"SAMPLE",color:"text-gray-300"}:M?{text:"CACHED",color:"text-blue-300"}:{text:"LIVE",color:"text-green-300"};if(s&&a.length===0)return e.jsx("div",{className:"bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl border border-white/10 p-6 mb-8",children:e.jsxs("div",{className:"flex items-center justify-center py-12",children:[e.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-green-400"}),e.jsx("span",{className:"ml-3 text-gray-300",children:"Loading..."})]})});const ce=we();return e.jsxs("div",{className:"bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-6 mb-8 overflow-hidden",children:[e.jsxs("div",{className:"flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4",children:[e.jsxs("div",{className:"flex items-center gap-3 min-w-0",children:[e.jsx("div",{className:"w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 p-2 md:p-3 shadow-lg shadow-green-500/40 flex-shrink-0",children:e.jsx(kt,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("h3",{className:"text-lg md:text-xl lg:text-2xl font-bold text-white truncate",children:"TRADING SCOREBOARD"}),e.jsx("p",{className:"text-xs md:text-sm text-gray-400 truncate",children:R||new Date().toLocaleString("default",{month:"long",year:"numeric"})})]})]}),e.jsxs("div",{className:"flex items-center gap-3 flex-shrink-0",children:[e.jsx("button",{onClick:()=>d(!m),className:"md:hidden flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-full px-3 py-2 border border-white/20 transition-all",children:m?e.jsxs(e.Fragment,{children:[e.jsx($t,{className:"w-4 h-4 text-gray-300"}),e.jsx("span",{className:"text-sm text-gray-300",children:"Hide"})]}):e.jsxs(e.Fragment,{children:[e.jsx(Je,{className:"w-4 h-4 text-gray-300"}),e.jsx("span",{className:"text-sm text-gray-300",children:"Show"})]})}),e.jsxs("div",{className:"flex items-center gap-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm rounded-full px-4 py-2 border border-green-400/30",children:[e.jsx("div",{className:`w-2.5 h-2.5 rounded-full ${M?"bg-blue-400":"bg-green-400"} animate-pulse`}),e.jsx("span",{className:`text-sm font-semibold ${ce.color} whitespace-nowrap`,children:ce.text})]}),e.jsxs("button",{onClick:D,className:"flex items-center gap-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 hover:from-blue-500/30 hover:to-purple-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-blue-400/30 hover:border-blue-400/50 transition-all shadow-lg",title:`Download ${R} CSV`,children:[e.jsx(At,{className:"w-4 h-4 text-blue-300"}),e.jsx("span",{className:"hidden sm:inline text-sm text-blue-300 font-semibold whitespace-nowrap",children:"Download CSV"}),e.jsx("span",{className:"sm:hidden text-sm text-blue-300 font-semibold",children:"CSV"})]})]})]}),i&&e.jsx("div",{className:"bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3 mb-4",children:e.jsx("p",{className:"text-yellow-400 text-sm break-words",children:i})}),p>1&&e.jsxs("div",{className:"flex items-center justify-center gap-2 mb-6 px-2",children:[e.jsx("button",{onClick:()=>L(g-1),disabled:g===1,className:"p-2 rounded-lg bg-white/8 hover:bg-white/12 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-shrink-0",children:e.jsx(Re,{className:"w-5 h-5"})}),e.jsx("div",{className:"flex gap-1 items-center overflow-x-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent max-w-full px-1",children:Array.from({length:Math.min(8,p)},(r,y)=>{let c;p<=8||g<=4?c=y+1:g>=p-3?c=p-7+y:c=g-3+y;const u=E[c-1];if(!u)return null;const[f,C]=u.split(" "),z=f.substring(0,3),B=C?C.substring(2):"",U=`${z} ${B}`;return e.jsx("button",{onClick:()=>L(c),className:`px-3 py-1 rounded-lg text-xs font-medium transition-all whitespace-nowrap flex-shrink-0 ${g===c?"bg-blue-500 text-white shadow-lg":"bg-white/8 hover:bg-white/12 text-gray-300"}`,title:u,children:U},c)})}),e.jsx("button",{onClick:()=>L(g+1),disabled:g===p,className:"p-2 rounded-lg bg-white/8 hover:bg-white/12 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-shrink-0",children:e.jsx(He,{className:"w-5 h-5"})})]}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mb-6",children:[e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all text-center",children:[e.jsx("div",{className:"text-sm lg:text-base font-bold text-green-300 truncate",children:G.totalProfit}),e.jsx("div",{className:"text-[10px] lg:text-xs text-gray-400",children:"Total Profit"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all text-center",children:[e.jsx("div",{className:"text-sm lg:text-base font-bold text-green-400",children:G.closedTrades}),e.jsx("div",{className:"text-[10px] lg:text-xs text-gray-400",children:"Closed"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all text-center",children:[e.jsx("div",{className:"text-sm lg:text-base font-bold text-blue-300",children:G.openTrades}),e.jsx("div",{className:"text-[10px] lg:text-xs text-gray-400",children:"Open"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all text-center",children:[e.jsx("div",{className:"text-sm lg:text-base font-bold text-purple-300",children:G.totalTrades}),e.jsx("div",{className:"text-[10px] lg:text-xs text-gray-400",children:"Total"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all text-center",children:[e.jsx("div",{className:"text-sm lg:text-base font-bold text-orange-300",children:G.successRate}),e.jsx("div",{className:"text-[10px] lg:text-xs text-gray-400",children:"Success"})]}),e.jsxs("a",{href:"/blog/the-50-50-strategy",className:"group relative bg-white/8 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-emerald-400/50 transition-all text-center cursor-pointer",children:[e.jsxs("div",{className:"text-sm lg:text-base font-bold text-emerald-300 truncate flex items-center justify-center gap-1",children:[e.jsx(oe,{className:"w-3 h-3 text-emerald-400 flex-shrink-0"}),e.jsxs("span",{children:["50% → ",$!==null?`$${$.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:0})}`:"..."]})]}),e.jsx("div",{className:"text-[10px] lg:text-xs text-emerald-400/80",children:"Profits Saved"}),e.jsxs("div",{className:"absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 border border-white/20 rounded-lg text-xs text-gray-200 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-10",children:["Half of all profits are automatically saved. Learn more →",e.jsx("div",{className:"absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-900"})]})]})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-center gap-1 sm:gap-2 mb-4 px-2",children:[e.jsx(fe,{className:"w-3 h-3 md:w-4 md:h-4 text-gray-400 flex-shrink-0"}),e.jsxs("span",{className:"text-xs text-gray-400 text-center break-words",children:["Last updated: ",b.toLocaleTimeString(),M&&e.jsx("span",{className:"text-blue-400 ml-1 sm:ml-2",children:"• Cached"}),!M&&ce.text==="LIVE"&&e.jsx("span",{className:"text-green-400 ml-1 sm:ml-2",children:"• Fresh"})]})]}),e.jsxs("div",{className:`bg-black/20 rounded-xl border border-white/5 overflow-hidden ${m?"":"hidden md:block"}`,children:[e.jsx("div",{className:"block md:hidden",children:e.jsx("div",{className:"space-y-2 p-2 max-h-96 overflow-y-auto overflow-x-hidden",children:W.length===0?e.jsxs("div",{className:"p-8 text-center text-gray-400",children:["No transactions for ",R]}):W.map(r=>e.jsxs("div",{className:"bg-white/5 rounded-lg p-3 border-t border-r border-b border-white/10 border-l-4 max-w-full",style:r.action==="OPEN"?{borderLeftColor:"#60a5fa"}:{borderLeftColor:"#4ade80"},children:[e.jsxs("div",{className:"flex items-center justify-between mb-2 gap-2 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2 min-w-0 flex-1",children:[e.jsx("span",{className:`font-bold text-sm ${_(r.coin)} flex-shrink-0`,children:r.coin}),e.jsx("span",{className:`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${pe(r.action)} flex-shrink-0`,children:r.action})]}),e.jsx("div",{className:"text-xs text-gray-400 flex-shrink-0 truncate max-w-[120px]",children:r.timestamp})]}),e.jsxs("div",{className:"flex items-center justify-between mb-2 gap-2",children:[e.jsxs("div",{className:"text-xs text-gray-300 truncate flex-1 min-w-0",children:[e.jsx("span",{className:"text-gray-500",children:"Price:"})," ",e.jsx("span",{className:"font-mono",children:r.price})]}),e.jsxs("div",{className:"text-xs text-gray-300 truncate flex-1 min-w-0 text-right",children:[e.jsx("span",{className:"text-gray-500",children:"Qty:"})," ",e.jsx("span",{className:"font-mono",children:r.quantity})]})]}),e.jsxs("div",{className:"flex items-center justify-between gap-2",children:[e.jsx("div",{className:"flex items-center gap-3 flex-shrink-0",children:r.action==="CLOSE"?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:`font-bold text-sm font-mono ${ee(r.profit)}`,children:["+$",r.profit.toFixed(2)]}),r.percentGain!==null&&e.jsxs("div",{className:"font-bold text-sm font-mono text-green-400",children:["(",r.percentGain.toFixed(2),"%)"]})]}):e.jsx("div",{className:"text-gray-500 text-sm",children:"Active"})}),e.jsxs("div",{className:"flex items-center gap-1 flex-shrink-0",children:[r.status==="profit_goal_reached"&&e.jsxs(e.Fragment,{children:[e.jsx(ge,{className:"w-3 h-3 text-yellow-400"}),e.jsx("span",{className:"text-xs text-yellow-400",children:"Goal"})]}),r.action==="OPEN"&&e.jsxs(e.Fragment,{children:[e.jsx(V,{className:"w-3 h-3 text-blue-400"}),e.jsx("span",{className:"text-xs text-blue-400",children:"Active"})]})]})]})]},r.id))})}),e.jsxs("div",{className:"hidden md:block",children:[e.jsx("div",{className:"bg-white/5 px-4 py-3 border-b border-white/5",children:e.jsxs("div",{className:"grid grid-cols-12 gap-2 text-xs font-semibold text-gray-300 uppercase tracking-wider",children:[e.jsx("div",{className:"col-span-1",children:"Coin"}),e.jsx("div",{className:"col-span-2",children:"Action"}),e.jsx("div",{className:"col-span-2",children:"Price"}),e.jsx("div",{className:"col-span-2",children:"Quantity"}),e.jsx("div",{className:"col-span-2",children:"Profit"}),e.jsx("div",{className:"col-span-1",children:"% Gain"}),e.jsx("div",{className:"col-span-2",children:"Time"})]})}),e.jsx("div",{className:"max-h-96 overflow-y-auto",children:W.length===0?e.jsxs("div",{className:"p-8 text-center text-gray-400",children:["No transactions for ",R]}):W.map((r,y)=>e.jsx("div",{className:`px-4 py-3 border-b border-white/5 hover:bg-white/5 ${y%2===0?"bg-white/2":""} border-l-4`,style:r.action==="OPEN"?{borderLeftColor:"#60a5fa"}:{borderLeftColor:"#4ade80"},children:e.jsxs("div",{className:"grid grid-cols-12 gap-2 items-center text-sm",children:[e.jsx("div",{className:"col-span-1",children:e.jsx("div",{className:`font-bold ${_(r.coin)}`,children:r.coin})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${pe(r.action)}`,children:r.action})}),e.jsx("div",{className:"col-span-2",children:e.jsx("div",{className:"text-gray-200 font-mono text-xs",children:r.price})}),e.jsx("div",{className:"col-span-2",children:e.jsx("div",{className:"text-gray-300 font-mono text-xs",children:r.quantity})}),e.jsxs("div",{className:"col-span-2",children:[r.action==="CLOSE"?e.jsxs("div",{className:`font-bold font-mono ${ee(r.profit)}`,children:["+$",r.profit.toFixed(2)]}):e.jsx("div",{className:"text-gray-500 font-mono text-xs",children:"-"}),r.status==="profit_goal_reached"&&e.jsxs("div",{className:"text-xs text-yellow-400 flex items-center gap-1 mt-1",children:[e.jsx(ge,{className:"w-3 h-3"}),e.jsx("span",{children:"Goal"})]}),r.action==="OPEN"&&e.jsxs("div",{className:"text-xs text-blue-400 flex items-center gap-1 mt-1",children:[e.jsx(V,{className:"w-3 h-3"}),e.jsx("span",{children:"Active"})]})]}),e.jsx("div",{className:"col-span-1",children:r.action==="CLOSE"&&r.percentGain!==null?e.jsxs("div",{className:"font-bold font-mono text-green-400 text-xs",children:[r.percentGain.toFixed(2),"%"]}):e.jsx("div",{className:"text-gray-500 font-mono text-xs",children:"-"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("div",{className:"text-gray-400 text-xs",children:r.timestamp})})]})},r.id))})]})]}),p>1&&e.jsxs("div",{className:"flex items-center justify-center gap-2 mt-6 px-2",children:[e.jsx("button",{onClick:()=>L(g-1),disabled:g===1,className:"p-2 rounded-lg bg-white/8 hover:bg-white/12 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-shrink-0",children:e.jsx(Re,{className:"w-5 h-5"})}),e.jsx("div",{className:"flex gap-1 items-center overflow-x-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent max-w-full px-1",children:Array.from({length:Math.min(8,p)},(r,y)=>{let c;p<=8||g<=4?c=y+1:g>=p-3?c=p-7+y:c=g-3+y;const u=E[c-1];if(!u)return null;const[f,C]=u.split(" "),z=f.substring(0,3),B=C?C.substring(2):"",U=`${z} ${B}`;return e.jsx("button",{onClick:()=>L(c),className:`px-3 py-1 rounded-lg text-xs font-medium transition-all whitespace-nowrap flex-shrink-0 ${g===c?"bg-blue-500 text-white shadow-lg":"bg-white/8 hover:bg-white/12 text-gray-300"}`,title:u,children:U},c)})}),e.jsx("button",{onClick:()=>L(g+1),disabled:g===p,className:"p-2 rounded-lg bg-white/8 hover:bg-white/12 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-shrink-0",children:e.jsx(He,{className:"w-5 h-5"})})]}),e.jsxs("div",{className:"mt-4 text-center px-2",children:[e.jsxs("p",{className:"text-xs text-gray-500 break-words",children:["✅ Smart Cache enabled • Live data with intelligent caching •"," ",e.jsx("span",{className:"text-green-400 font-medium",children:"Shows both Open & Closed positions"})]}),!m&&e.jsx("p",{className:"text-xs text-gray-500 mt-1 md:hidden",children:'Tap "Show" to view history'})]})]})},_t=({tradingStats:a,isLoading:n=!1,error:s=null,refreshStats:t=()=>console.log("Refresh not implemented"),cacheInfo:i={isFresh:!1,isRateLimited:!1,timeUntilNextRefresh:0}})=>{var P,l,S,k,j,A,E,W,G;const h=Se(),b=p=>{if(p<=0)return"Available now";const R=Math.floor(p/(1e3*60*60)),L=Math.floor(p%(1e3*60*60)/(1e3*60));return R>0?`${R}h ${L}m`:`${L}m`};if(n)return e.jsx("section",{className:"py-16 px-4 relative overflow-hidden",children:e.jsx("div",{className:"relative max-w-6xl mx-auto text-center",children:e.jsxs("div",{className:"flex items-center justify-center py-12",children:[e.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-b-2 border-green-400 mr-3"}),e.jsx("span",{className:"text-gray-300 text-lg",children:"Loading live trading data..."})]})})});const I=s&&s.trim()!=="",m=a&&typeof a=="object"&&a.totalProfit!==void 0;if(I||!m)return e.jsxs("section",{className:"py-16 px-4 relative overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-red-900/20 to-orange-900/20"}),e.jsxs("div",{className:"relative max-w-6xl mx-auto text-center",children:[e.jsxs("div",{className:"bg-red-500/10 border border-red-500/20 rounded-2xl p-8 mb-8",children:[e.jsx(Tt,{className:"w-12 h-12 text-red-400 mx-auto mb-4"}),e.jsx("h3",{className:"text-xl font-bold text-white mb-4",children:"Unable to Load Live Trading Data"}),e.jsx("p",{className:"text-red-300 mb-6",children:I?s:"Trading data is not available. This could be due to API configuration issues or data loading problems."}),e.jsxs("button",{onClick:t,className:"inline-flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300",children:[e.jsx(Rt,{className:"w-4 h-4"}),"Retry Connection"]})]}),e.jsxs("div",{className:"bg-gray-900/50 rounded-lg p-4 text-left max-w-2xl mx-auto",children:[e.jsx("h4",{className:"text-white font-semibold mb-2",children:"Debug Information:"}),e.jsxs("div",{className:"text-gray-300 text-sm space-y-1",children:[e.jsxs("p",{children:["• Sheet ID:"," ","✅ Configured"]}),e.jsxs("p",{children:["• API Key:"," ","✅ Configured"]}),e.jsx("p",{children:'• Expected Tab: "Calculations"'}),e.jsx("p",{children:"• Expected Range: A:G"}),e.jsxs("p",{children:["• Error: ",s||"No specific error message"]}),e.jsxs("p",{children:["• Cache Status: ",i!=null&&i.isFresh?"Fresh":"Stale"]}),e.jsxs("p",{children:["• Rate Limited: ",i!=null&&i.isRateLimited?"Yes":"No"]}),e.jsxs("p",{children:["• Has Trading Stats: ",m?"Yes":"No"]}),e.jsxs("p",{children:["• Trading Stats Type: ",typeof a]}),e.jsxs("p",{children:["• Trading Stats Value:"," ",a===void 0?"undefined":a===null?"null":"has value"]})]})]})]})]});const d=a,M=((P=d.dailyAvg)==null?void 0:P.toFixed(2))||"0.00",x=d.monthlyData||[],g=x.length,F=g>6?x.slice(-6):x,$=g>6?x.slice(0,-6).reverse():[],Y=x.find(p=>p.profit===d.bestMonthProfit)||x[0],H=p=>({Jan:"January",Feb:"February",Mar:"March",Apr:"April",May:"May",Jun:"June",Jul:"July",Aug:"August",Sep:"September",Oct:"October",Nov:"November",Dec:"December"})[p]||p,O=p=>p.substring(0,3),K=()=>{Ne("start_trading_save_1000","trading_results_section"),je("https://gobabytrade.com/432706BE","Start Trading Save $1000 Trading Results")},v=p=>{const R=Number(p);return isNaN(R)?"0.00":R.toFixed(2)};return e.jsx("section",{id:"trading-results",className:"py-16 px-4 relative overflow-hidden",children:e.jsxs("div",{className:"relative max-w-6xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-green-600/20 to-blue-600/20 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 mb-6",children:[e.jsx(qe,{className:"w-4 h-4 text-green-400"}),e.jsx("span",{className:"text-green-300 font-medium",children:d.isLiveData?"LIVE DATA":"REAL RESULTS"}),d.isLiveData&&e.jsx("div",{className:"w-2 h-2 bg-green-400 rounded-full animate-pulse"})]}),e.jsx("h2",{className:"text-3xl md:text-5xl font-bold text-white mb-4",children:"My Trading Results"}),e.jsxs("div",{className:"mb-6",children:[e.jsx("p",{className:"text-xl text-purple-200 font-medium mb-4",children:"Don't just take my word for it - here are my actual trading results:"}),e.jsx("div",{children:e.jsx(V,{className:"w-8 h-8 text-green-300 mx-auto animate-bounce"})})]}),e.jsxs("p",{className:"text-xl text-gray-300 max-w-3xl mx-auto",children:["These are my actual profits from using my robotic trader.",e.jsxs("span",{className:"text-green-400 font-semibold",children:[" ","Started January 8, 2025"]})," ","-"," ",d.isLiveData?"Live Updates!":"Stats Updated Monthly!"]}),d.isLiveData&&e.jsx("div",{className:"mt-6 flex justify-center",children:e.jsxs("div",{className:"bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm rounded-lg p-4 border border-green-400/30 shadow-lg shadow-green-500/10",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("div",{className:"w-3 h-3 bg-green-400 rounded-full animate-pulse"}),e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"text-green-300 font-semibold text-sm",children:"Live Data Connected"}),e.jsxs("p",{className:"text-gray-300 text-xs",children:["Last updated:"," ",new Date(d.lastUpdated).toLocaleString()]})]})]}),e.jsxs("div",{className:"flex items-center justify-center gap-4 text-xs text-gray-400 border-t border-green-400/20 pt-2",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(St,{className:"w-3 h-3"}),e.jsxs("span",{children:["Cache: ",i.isFresh?"Fresh":"Stale"]})]}),i.isRateLimited&&e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(fe,{className:"w-3 h-3"}),e.jsxs("span",{children:["Next update:"," ",b(i.timeUntilNextRefresh)]})]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(Ot,{className:"w-3 h-3"}),e.jsx("span",{children:"Auto-updating"})]})]})]})})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6 mb-8",children:[e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-green-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-green-500 to-emerald-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-green-500/40",children:e.jsx(de,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-3xl font-bold text-green-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-green-300 group-hover:to-emerald-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:["$",((l=d.totalProfit)==null?void 0:l.toFixed(2))||"0.00"]})," ",e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Total Profits"}),e.jsx("div",{className:"text-green-300 text-sm mt-1",children:h})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-orange-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-orange-500 to-amber-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-orange-500/40",children:e.jsx(ge,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsx("div",{className:"text-3xl font-bold text-orange-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-orange-300 group-hover:to-amber-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:((S=d.totalTrades)==null?void 0:S.toLocaleString())||"0"}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Closed Trades"}),e.jsx("div",{className:"text-orange-300 text-sm mt-1",children:"Consistent & Automated"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-purple-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-purple-500 to-pink-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-purple-500/40",children:e.jsx(ye,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-3xl font-bold text-purple-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-300 group-hover:to-pink-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:["$",((k=d.avgProfitPerTrade)==null?void 0:k.toFixed(2))||"0.00"]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Avg Per Trade"}),e.jsx("div",{className:"text-purple-300 text-sm mt-1",children:"Steady Gains"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]})]}),e.jsx(Kt,{}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12",children:[e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-emerald-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-emerald-500 to-teal-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-emerald-500/40",children:e.jsx(Ue,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-2xl font-bold text-emerald-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-emerald-300 group-hover:to-teal-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:["$",((j=d.monthlyAverage)==null?void 0:j.toFixed(2))||"0.00"]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Monthly Average"}),e.jsx("div",{className:"text-emerald-300 text-sm mt-1",children:"Consistent Performance"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-indigo-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-indigo-500/40",children:e.jsx(V,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-2xl font-bold text-indigo-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-indigo-300 group-hover:to-purple-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:["$",v(M)]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Daily Average"}),e.jsx("div",{className:"text-indigo-300 text-sm mt-1",children:"Steady Growth"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-amber-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-amber-500 to-orange-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-amber-500/40",children:e.jsx(ye,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-2xl font-bold text-amber-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-amber-300 group-hover:to-orange-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:["$",((A=d.bestMonthProfit)==null?void 0:A.toFixed(2))||"0.00"]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Best Month"}),e.jsx("div",{className:"text-amber-300 text-sm mt-1",children:Y?`${H(Y.month)} ${Y.year}`:"N/A"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-blue-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-blue-500 to-cyan-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-blue-500/40",children:e.jsx(Dt,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-2xl font-bold text-cyan-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-300 group-hover:to-cyan-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:[((E=d.avgPercentGain)==null?void 0:E.toFixed(2))||"0.00","%"]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Avg % Gain"}),e.jsx("div",{className:"text-cyan-300 text-sm mt-1",children:"Per Trade"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]})]}),e.jsx("div",{className:"text-center mb-8",children:e.jsx("p",{className:"text-sm text-green-300 bg-green-900/20 backdrop-blur-sm rounded-lg px-4 py-2 inline-block border border-green-500/20",children:"✓ All profits shown are net amounts after trading fees and rebates"})}),F.length>0&&e.jsxs("div",{className:"bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-8 mb-8 relative",children:[e.jsx("div",{className:"absolute top-4 right-4 opacity-20 pointer-events-none hidden md:block",children:e.jsx("div",{className:"w-16 h-16 rounded-full overflow-hidden bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-purple-400/30 flex items-center justify-center animate-pulse shadow-lg shadow-purple-500/20",children:e.jsx("img",{src:"/robot-trading.png",alt:"Robot Trading",className:"w-12 h-12 object-contain filter brightness-110"})})}),e.jsxs("h3",{className:"text-xl md:text-2xl font-bold text-white mb-4 md:mb-6 text-center",children:["Recent Performance (Last ",F.length," Months)"]}),e.jsx("div",{className:"w-full overflow-x-auto overflow-y-visible",children:e.jsx("div",{className:"flex items-end justify-center gap-2 md:gap-6 mb-4 md:mb-6 min-w-max mx-auto px-2 pt-6",style:{minHeight:"220px"},children:F.map(p=>{const L=Math.max(...F.map(q=>q.profit)),D=Math.max(p.profit/L*140,12),T=p.profit===L;return e.jsxs("div",{className:"flex flex-col items-center min-w-0",children:[e.jsxs("div",{className:`text-xs md:text-sm mb-1 md:mb-2 font-semibold ${T?"text-yellow-300":"text-gray-200"}`,children:["$",Math.round(p.profit)]}),e.jsx("div",{className:`w-8 md:w-16 rounded-t-lg transition-all duration-1000 ease-out ${T?"bg-gradient-to-t from-yellow-500 to-yellow-300 shadow-lg shadow-yellow-400/40":"bg-gradient-to-t from-emerald-500 to-green-400 shadow-lg shadow-emerald-400/30"}`,style:{height:`${D}px`,minHeight:"12px"}}),e.jsxs("div",{className:"text-xs md:text-sm text-gray-200 mt-2 md:mt-3 font-medium text-center",children:[e.jsx("span",{className:"md:hidden",children:O(p.month)}),e.jsxs("span",{className:"hidden md:inline",children:[H(p.month)," '",String(p.year).slice(-2)]})]}),e.jsxs("div",{className:`text-xs mt-1 ${T?"text-yellow-400":"text-gray-400"}`,children:[p.trades," trades"]})]},`${p.month}-${p.year}`)})})}),e.jsx("div",{className:"text-center",children:e.jsxs("p",{className:"text-emerald-300 font-semibold text-sm md:text-lg",children:["📈 ",d.totalTrades||0," trades • $",((W=d.avgProfitPerTrade)==null?void 0:W.toFixed(2))||"0.00"," avg profit/trade • Best month:"," ",Y?`${H(Y.month)} '${String(Y.year).slice(-2)}`:"N/A"," ","with $",((G=d.bestMonthProfit)==null?void 0:G.toFixed(2))||"0.00"]})})]}),$.length>0&&(()=>{const p=$.reduce((D,T)=>{const q=T.year;return D[q]||(D[q]=[]),D[q].push(T),D},{}),R=Object.keys(p).map(Number).sort((D,T)=>T-D),L=Math.max(...$.map(D=>D.profit));return e.jsxs("div",{className:"bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl border border-white/10 p-4 md:p-8 mb-8",children:[e.jsx("h3",{className:"text-xl md:text-2xl font-bold text-white mb-4 md:mb-6 text-center",children:"Previous Months Performance"}),R.map(D=>{const T=p[D],q=T.reduce((_,ee)=>_+ee.profit,0),X=T.reduce((_,ee)=>_+ee.trades,0);return e.jsxs("div",{className:"mb-6 last:mb-0",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3 pb-2 border-b border-white/10",children:[e.jsxs("h4",{className:"text-lg font-bold flex items-center gap-2 text-white",children:[e.jsx("span",{children:D}),e.jsxs("span",{className:"text-sm text-gray-400 font-normal",children:["(",T.length," ",T.length===1?"month":"months",")"]})]}),e.jsxs("span",{className:"text-sm font-semibold text-emerald-300",children:["$",q.toFixed(2)," • ",X," trades"]})]}),e.jsx("div",{className:"space-y-3",children:T.map(_=>{const ee=Math.max(_.profit/L*100,10);return e.jsxs("div",{className:"bg-white/5 rounded-xl p-3 md:p-4 border border-white/10 hover:border-white/20 transition-all",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"font-semibold text-sm md:text-base text-gray-200",children:H(_.month)}),e.jsxs("div",{className:"flex items-center gap-3 md:gap-4",children:[e.jsxs("span",{className:"text-xs md:text-sm text-gray-400",children:[_.trades," trades"]}),e.jsxs("span",{className:"font-bold font-mono text-sm md:text-base text-emerald-300",children:["$",_.profit.toFixed(2)]})]})]}),e.jsx("div",{className:"h-3 md:h-4 bg-gray-700/50 rounded-full overflow-hidden",children:e.jsx("div",{className:"h-full rounded-full bg-emerald-500",style:{width:`${ee}%`}})})]},`${_.month}-${_.year}`)})})]},D)}),e.jsx("div",{className:"text-center mt-4 pt-4 border-t border-white/10",children:e.jsxs("p",{className:"text-gray-400 text-sm",children:["Showing ",$.length," previous months • Total: $",$.reduce((D,T)=>D+T.profit,0).toFixed(2)," ","• ",$.reduce((D,T)=>D+T.trades,0)," trades"]})}),e.jsx("div",{className:"text-center mt-8",children:e.jsxs("div",{className:"bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-2xl p-6 border border-purple-400/30 shadow-lg shadow-purple-500/20",children:[e.jsx("h4",{className:"text-xl font-bold text-white mb-3",children:"Ready to Experience Autonomous Trading?"}),e.jsx("p",{className:"text-gray-200 mb-4 max-w-xl mx-auto",children:"GoBabyTrade is the same AI-enhanced system I use. Use my link to save $1,000!"}),e.jsxs("a",{href:"https://gobabytrade.com/432706BE",target:"_blank",rel:"noopener noreferrer",onClick:K,className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-purple-500/30",children:["Start Trading – Save $1,000",e.jsx(V,{className:"w-4 h-4"})]})]})})]})})(),e.jsx("div",{className:"text-center mt-8",children:e.jsxs("p",{className:"text-sm text-gray-400 max-w-2xl mx-auto",children:["* These are my actual trading results from my personal robotic trader account. Started January 8, 2025.",d.isLiveData?" Live data from Google Sheets.":" Results updated regularly.","Past performance does not guarantee future results."]})})]})})},Ae=[{icon:fe,title:"Set It & Forget It",description:"Monitors global markets 24/7, executing trades even while you sleep. Never miss profitable opportunities or stare at charts again.",color:"from-orange-500 to-amber-500",stats:"Always Active"},{icon:oe,title:"Never Trades at a Loss",description:"Only sells when your position is profitable—never at a loss unless you choose otherwise. Protects investments while capitalizing on market swings.",color:"from-blue-500 to-cyan-500",stats:"0% Loss Trades"},{icon:Ie,title:"AI-Enhanced Autonomous Trading",description:"Analyzes market patterns and executes trades with AI precision, adapting to changing conditions in real-time. Never worry about charts or timing again.",color:"from-purple-500 to-pink-500",stats:"Unattended Trading"},{icon:de,title:"Your Funds Stay Safe",description:"Funds remain secure in your Kraken/Coinbase accounts. Trading-only API access means we can never withdraw or transfer your money.",color:"from-emerald-500 to-teal-500",stats:"Your Keys, Your Crypto"},{icon:V,title:"Takes What the Market Gives",description:"Capitalizes on market opportunities as they arise, taking profits when favorable and waiting patiently when not. Smart, patient trading.",color:"from-emerald-500 to-green-500",stats:"Market-Driven Results"},{icon:ye,title:"Lightning Fast Execution",description:"Executes trades in milliseconds, capitalizing on market movements before human traders can react. Speed gives you the competitive edge.",color:"from-yellow-500 to-orange-500",stats:"100ms Execution"},{icon:qe,title:"Real-Time Analytics",description:"Simple position and profit reporting gives you clear visibility into performance and total profits across Coinbase and Kraken.",color:"from-indigo-500 to-purple-500",stats:"Live Tracking"},{icon:Qe,title:"Start with Paper Trading",description:"Test the system risk-free with paper trading before going live. Build confidence and see performance without risking real money.",color:"from-pink-500 to-rose-500",stats:"Risk-Free Testing"}],Jt=function(){const[a,n]=w.useState(new Array(Ae.length).fill(!1));w.useEffect(()=>{const t=new IntersectionObserver(h=>{h.forEach(b=>{if(b.isIntersecting){const I=parseInt(b.target.getAttribute("data-card-index")||"0");n(m=>{const d=[...m];return d[I]=!0,d}),ke("view","feature_card",Ae[I].title,1)}})},{threshold:.1});return document.querySelectorAll("[data-card-index]").forEach(h=>t.observe(h)),()=>t.disconnect()},[]);const s=(t,i)=>{ke("click","feature_card",`${t}_card_${i+1}`,1)};return e.jsx("section",{className:"py-10 px-4 relative",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-400/40 mb-6 mt-4 shadow-lg shadow-purple-500/20",children:[e.jsx(ye,{className:"w-4 h-4 text-purple-300"}),e.jsx("span",{className:"text-purple-200 font-medium",children:"Powerful Features"})]}),e.jsxs("h2",{className:"text-4xl md:text-5xl font-bold text-white mb-6",children:["Why Choose This",e.jsx("span",{className:"block text-transparent bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text",children:"Autonomous Trading Platform"})]}),e.jsx("p",{className:"text-xl text-gray-200 max-w-3xl mx-auto",children:"Advanced autonomous technology with comprehensive risk management on trusted exchanges like Coinbase and Kraken."})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12",children:[e.jsx("img",{src:"/graphics/homepage-features-01.webp",alt:"The Never-Sell-At-A-Loss Rule - How the system protects your capital",className:"w-full rounded-2xl shadow-xl shadow-blue-500/10 border border-white/10 hover:scale-[1.02] transition-transform duration-300"}),e.jsx("img",{src:"/graphics/homepage-features-02.webp",alt:"24/7 Trading - Markets never sleep, neither does your robot",className:"w-full rounded-2xl shadow-xl shadow-purple-500/10 border border-white/10 hover:scale-[1.02] transition-transform duration-300"})]}),e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6",children:Ae.map((t,i)=>{const h=t.icon;return e.jsxs("div",{"data-card-index":i,onClick:()=>s(t.title,i),className:`group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl shadow-lg cursor-pointer ${a[i]?"opacity-100 translate-y-0":"opacity-0 translate-y-10"}`,style:{transitionDelay:`${i*100}ms`,boxShadow:`0 8px 32px rgba(${i%2===0?"168, 85, 247":"236, 72, 153"}, 0.15)`},children:[e.jsx("div",{className:`absolute inset-0 bg-gradient-to-br ${t.color} opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300`}),e.jsx("div",{className:`relative w-12 h-12 rounded-xl bg-gradient-to-br ${t.color} p-3 mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`,children:e.jsx(h,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative",children:[e.jsx("h3",{className:"text-xl font-bold text-white mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-300 group-hover:to-pink-300 group-hover:bg-clip-text transition-all duration-300",children:t.title}),e.jsx("p",{className:"text-gray-300 text-sm leading-relaxed mb-4 group-hover:text-gray-200 transition-colors duration-300",children:t.description}),e.jsx("div",{className:`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${t.color} text-white shadow-md`,children:t.stats})]}),e.jsx("div",{className:`absolute inset-0 rounded-2xl bg-gradient-to-r ${t.color} opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl`})]},i)})})]})})},Vt=function(){const a=()=>{Ne("start_trading_save_1000","cta_section"),je("https://gobabytrade.com/432706BE","Start Trading Save $1000 CTA")};return e.jsxs("section",{className:"py-10 px-4 relative overflow-hidden",children:[e.jsx("div",{className:"absolute top-10 right-10 opacity-8 pointer-events-none hidden xl:block",children:e.jsx("img",{src:"/robot-trading.png",alt:"",className:"w-20 h-20 animate-pulse"})}),e.jsxs("div",{className:"relative max-w-4xl mx-auto text-center",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-400/40 mb-6 mt-4 shadow-lg shadow-purple-500/20",children:[e.jsx(Ht,{className:"w-4 h-4 text-purple-300"}),e.jsx("span",{className:"text-purple-200 font-medium",children:"Ready to Start?"})]}),e.jsxs("h2",{className:"text-4xl md:text-6xl font-bold text-white mb-6 leading-tight",children:["Ready for True",e.jsx("span",{className:"block text-transparent bg-gradient-to-r from-green-300 via-blue-400 to-purple-400 bg-clip-text",children:"Set-It-and-Forget-It Trading?"})]}),e.jsx("p",{className:"text-xl text-gray-200 mb-8 max-w-3xl mx-auto",children:"GoBabyTrade is an AI-enhanced autonomous trading system that protects your capital while maximizing profits. Start with paper trading risk-free."}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6 mb-8",children:[e.jsxs("div",{className:"flex items-center justify-center gap-3",children:[e.jsx(J,{className:"w-6 h-6 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Never trades at a loss"})]}),e.jsxs("div",{className:"flex items-center justify-center gap-3",children:[e.jsx(J,{className:"w-6 h-6 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Your funds stay secure"})]}),e.jsxs("div",{className:"flex items-center justify-center gap-3",children:[e.jsx(J,{className:"w-6 h-6 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Set it and forget it"})]})]}),e.jsxs("div",{className:"bg-gray-900/50 rounded-2xl border border-white/10 p-8 mb-8 max-w-3xl mx-auto shadow-lg shadow-purple-500/10 relative",children:[e.jsx("div",{className:"absolute bottom-4 right-4 opacity-10 pointer-events-none hidden md:block",children:e.jsx("img",{src:"/robot-trading.png",alt:"",className:"w-12 h-12"})}),e.jsxs("div",{className:"flex items-center justify-center gap-3 mb-6",children:[e.jsx(Bt,{className:"w-8 h-8 text-green-300"}),e.jsx("h3",{className:"text-2xl md:text-3xl font-bold text-white",children:"Save $1,000 With My Link"})]}),e.jsxs("ul",{className:"text-left space-y-4 mb-6",children:[e.jsxs("li",{className:"flex items-start text-gray-200 group hover:text-white transition-all duration-300 hover:translate-x-2",children:[e.jsx(Z,{className:"w-5 h-5 text-purple-300 mr-3 mt-1 flex-shrink-0 group-hover:text-pink-300 transition-colors"}),e.jsx("span",{className:"text-lg",children:"AI-enhanced autonomous trading that works 24/7"})]}),e.jsxs("li",{className:"flex items-start text-gray-200 group hover:text-white transition-all duration-300 hover:translate-x-2",children:[e.jsx(Z,{className:"w-5 h-5 text-purple-300 mr-3 mt-1 flex-shrink-0 group-hover:text-pink-300 transition-colors"}),e.jsx("span",{className:"text-lg",children:"Never sells at a loss – waits for profitable opportunities"})]}),e.jsxs("li",{className:"flex items-start text-gray-200 group hover:text-white transition-all duration-300 hover:translate-x-2",children:[e.jsx(Z,{className:"w-5 h-5 text-purple-300 mr-3 mt-1 flex-shrink-0 group-hover:text-pink-300 transition-colors"}),e.jsx("span",{className:"text-lg",children:"Your funds stay in your own Coinbase or Kraken account"})]}),e.jsxs("li",{className:"flex items-start text-gray-200 group hover:text-white transition-all duration-300 hover:translate-x-2",children:[e.jsx(Z,{className:"w-5 h-5 text-purple-300 mr-3 mt-1 flex-shrink-0 group-hover:text-pink-300 transition-colors"}),e.jsx("span",{className:"text-lg",children:"Start with paper trading – zero risk to test the system"})]}),e.jsxs("li",{className:"flex items-start text-gray-200 group hover:text-white transition-all duration-300 hover:translate-x-2",children:[e.jsx(Z,{className:"w-5 h-5 text-purple-300 mr-3 mt-1 flex-shrink-0 group-hover:text-pink-300 transition-colors"}),e.jsx("span",{className:"text-lg",children:"Same system I use – see my live results above"})]})]}),e.jsx("p",{className:"text-lg text-green-300 font-medium",children:"Use my referral link to get $1,000 off GoBabyTrade!"})]}),e.jsx("div",{className:"flex justify-center mb-8",children:e.jsxs("a",{href:"https://gobabytrade.com/432706BE",onClick:a,target:"_blank",rel:"noopener noreferrer",className:"group bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-purple-500/30 flex items-center justify-center gap-2",children:["Start Trading – Save $1,000",e.jsx(Z,{className:"w-5 h-5 group-hover:translate-x-1 transition-transform"})]})}),e.jsxs("div",{className:"flex items-center justify-center gap-3 text-green-300",children:[e.jsx(V,{className:"w-6 h-6"}),e.jsx("span",{className:"text-lg font-semibold",children:"Try Paper Trading First – Zero Risk, Real Results"})]})]})]})},Zt=[{question:"Is my money safe?",answer:"Yes! Your funds stay in your own Kraken/Coinbase accounts. The system only connects via API with trading permissions - it can never withdraw or transfer your funds."},{question:"Do I need trading experience?",answer:"No experience required! The AI handles all analysis and decisions. You set your preferences and investment amount - the platform does the rest."},{question:"How much money do I need to start?",answer:"Start with as little as $100. It's recommended to start small to get familiar with the platform before scaling up your investment."},{question:"What if the system makes losing trades?",answer:"The GoBabyTrade protection system never executes losing trades. It waits for profitable opportunities or doesn't trade at all, safeguarding your capital."},{question:"Can I pause or stop the automated trading anytime?",answer:"Yes! You have complete control. Pause or stop anytime directly in the interface. When paused, the system stops making new trades but your existing positions remain untouched."}],Qt=({question:a,answer:n})=>{const[s,t]=w.useState(!1);return e.jsxs("div",{className:"bg-gray-900/50 rounded-xl border border-white/10 overflow-hidden hover:border-purple-400/40 transition-all duration-300 shadow-lg shadow-purple-500/10",children:[e.jsxs("button",{onClick:()=>t(!s),className:"w-full px-6 py-4 text-left flex items-center justify-between hover:bg-white/10 transition-colors duration-200",children:[e.jsx("span",{className:"text-lg font-semibold text-white pr-4",children:a}),e.jsx("div",{className:"flex-shrink-0",children:s?e.jsx(_e,{className:"w-5 h-5 text-purple-300"}):e.jsx(Ke,{className:"w-5 h-5 text-purple-300"})})]}),e.jsx("div",{className:`overflow-hidden transition-all duration-300 ease-in-out ${s?"max-h-96 opacity-100":"max-h-0 opacity-0"}`,children:e.jsx("div",{className:"px-6 pb-4 border-t border-white/20",children:e.jsx("div",{className:"text-gray-200 leading-relaxed pt-4",children:n})})})]})},Xt=()=>e.jsxs("section",{className:"py-20 px-4 relative overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-slate-900 via-purple-900/30 to-slate-900 -z-10"}),e.jsx("div",{className:"absolute top-0 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl -z-10"}),e.jsx("div",{className:"absolute bottom-0 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl -z-10"}),e.jsxs("div",{className:"max-w-4xl mx-auto relative z-10",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsx("h2",{className:"text-4xl md:text-5xl font-bold text-white mb-4",children:"Common Questions"}),e.jsx("p",{className:"text-xl text-gray-300",children:"Quick answers to help you get started"})]}),e.jsx("div",{className:"max-w-2xl mx-auto mb-12",children:e.jsx("img",{src:"/graphics/homepage-faq-01.webp",alt:"3 Steps to Passive Income - Connect, Configure, Collect",className:"w-full rounded-2xl shadow-xl shadow-purple-500/10 border border-white/10"})}),e.jsx("div",{className:"space-y-3 mb-8",children:Zt.map((a,n)=>e.jsx(Qt,{question:a.question,answer:a.answer},n))}),e.jsx("div",{className:"text-center mb-12",children:e.jsxs(ne,{to:"/faq",className:"inline-flex items-center gap-2 text-purple-300 hover:text-purple-200 transition-colors duration-200",children:[e.jsx(Ve,{className:"w-5 h-5"}),e.jsx("span",{className:"text-lg",children:"View all 30+ questions →"})]})}),e.jsxs("div",{className:"mt-8 text-center bg-gradient-to-r from-gray-900/30 to-purple-900/20 rounded-2xl p-8 border border-white/10 shadow-lg shadow-purple-500/10",children:[e.jsx("h3",{className:"text-2xl font-bold text-white mb-4",children:"Ready to Start Trading?"}),e.jsx("p",{className:"text-gray-200 mb-6",children:"Get started with GoBabyTrade – the same AI-enhanced autonomous trading system I use. Try paper trading first, risk-free."}),e.jsx("a",{href:"https://gobabytrade.com/432706BE",target:"_blank",rel:"noopener noreferrer",className:"inline-block bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-4 px-8 rounded-xl hover:from-purple-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-200 shadow-lg shadow-purple-500/50",children:"Start Trading – Save $1,000 →"})]})]})]}),en=a=>{const[n,s]=w.useState(()=>typeof window<"u"?window.matchMedia(a).matches:!1);return w.useEffect(()=>{const t=window.matchMedia(a);s(t.matches);const i=h=>s(h.matches);return t.addEventListener("change",i),()=>t.removeEventListener("change",i)},[a]),n},ue=()=>{var x;const a=Oe(),[n,s]=w.useState(!1),{tradingStats:t,isLoading:i}=be(),h=en("(min-width: 768px)"),b=()=>{Ne("start_trading_save_1000","full_nav"),je("https://gobabytrade.com/432706BE","Start Trading Save $1000 Nav")},I=[{label:"Home",path:"/"},{label:"Blog",path:"/blog"},{label:"FAQ",path:"/faq"},{label:"Resources",path:"/resources"}],m=g=>g==="/"?a.pathname==="/":a.pathname.startsWith(g),M=(()=>{if(!(t!=null&&t.totalProfit))return 0;const g=new Date("2025-01-08"),$=Math.floor((new Date().getTime()-g.getTime())/(1e3*60*60*24));return $>0?t.totalProfit/$:0})();return e.jsx("nav",{className:"sticky top-0 z-50 bg-white/8 backdrop-blur-md border-b border-white/10",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[e.jsxs("div",{className:"flex items-center gap-4 h-16",children:[e.jsxs(ne,{to:"/",className:"flex items-center gap-3 group flex-shrink-0",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg overflow-hidden shadow-md shadow-purple-500/30 bg-gradient-to-br from-purple-500 to-pink-500 p-0.5 group-hover:shadow-lg group-hover:shadow-purple-500/40 transition-all duration-300",children:e.jsx("div",{className:"w-full h-full rounded-md overflow-hidden bg-white/10 backdrop-blur-sm",children:e.jsx("img",{src:"/robot-logo.png",alt:"MyRoboticTrader Robot",className:"w-full h-full object-cover"})})}),e.jsxs("div",{className:"text-lg font-bold",children:[e.jsx("span",{className:"text-white",children:"My"}),e.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text",children:"Robotic"}),e.jsx("span",{className:"text-white",children:"Trader"})]})]}),h&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex items-center gap-4 flex-1 justify-center max-w-4xl",children:[e.jsxs("div",{className:"flex items-center gap-3 bg-white/10 rounded-lg px-4 py-2 border border-white/20 shadow-sm hover:shadow-md hover:bg-white/[0.12] transition-all duration-200 cursor-default",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-green-400 to-emerald-500 p-1.5 flex-shrink-0 shadow-md",children:e.jsx(de,{className:"w-full h-full text-white",strokeWidth:2.5})}),e.jsx("div",{className:"min-w-0",children:i?e.jsx("div",{className:"text-sm font-bold text-green-300 animate-pulse",children:"Loading..."}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-sm font-bold text-green-300 truncate",children:["$",t==null?void 0:t.totalProfit.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}),"+"]}),e.jsx("div",{className:"text-xs text-gray-400 font-medium",children:"Total"})]})})]}),e.jsxs("div",{className:"flex items-center gap-3 bg-white/10 rounded-lg px-4 py-2 border border-white/20 shadow-sm hover:shadow-md hover:bg-white/[0.12] transition-all duration-200 cursor-default",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-blue-400 to-cyan-500 p-1.5 flex-shrink-0 shadow-md",children:e.jsx(Ue,{className:"w-full h-full text-white",strokeWidth:2.5})}),e.jsx("div",{className:"min-w-0",children:i?e.jsx("div",{className:"text-sm font-bold text-blue-300 animate-pulse",children:"Loading..."}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-sm font-bold text-blue-300 truncate",children:["$",((x=t==null?void 0:t.monthlyAverage)==null?void 0:x.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}))||"0"]}),e.jsx("div",{className:"text-xs text-gray-400 font-medium",children:"Monthly"})]})})]}),e.jsxs("div",{className:"flex items-center gap-3 bg-white/10 rounded-lg px-4 py-2 border border-white/20 shadow-sm hover:shadow-md hover:bg-white/[0.12] transition-all duration-200 cursor-default",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-purple-400 to-pink-500 p-1.5 flex-shrink-0 shadow-md",children:e.jsx(V,{className:"w-full h-full text-white",strokeWidth:2.5})}),e.jsx("div",{className:"min-w-0",children:i?e.jsx("div",{className:"text-sm font-bold text-purple-300 animate-pulse",children:"Loading..."}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"text-sm font-bold text-purple-300 truncate",children:["$",M.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0})]}),e.jsx("div",{className:"text-xs text-gray-400 font-medium",children:"Daily"})]})})]})]}),e.jsxs("div",{className:"flex items-center gap-6",children:[I.map(g=>e.jsxs(ne,{to:g.path,className:`text-sm font-semibold transition-all duration-200 relative group ${m(g.path)?"text-white":"text-gray-300 hover:text-white"}`,children:[g.label,m(g.path)&&e.jsx("div",{className:"absolute -bottom-1 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full"}),!m(g.path)&&e.jsx("div",{className:"absolute -bottom-1 left-0 right-0 h-0.5 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-0 group-hover:opacity-50 transition-opacity duration-200"})]},g.path)),e.jsxs("a",{href:"https://gobabytrade.com/432706BE",onClick:b,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 via-purple-600 to-pink-500 hover:from-purple-600 hover:via-pink-500 hover:to-pink-600 text-white px-5 py-2.5 rounded-full font-bold text-sm transition-all duration-200 hover:scale-[1.02] hover:shadow-xl shadow-lg shadow-purple-500/40 hover:shadow-purple-500/60 flex-shrink-0",children:["Start Trading – Save $1,000",e.jsx(Z,{className:"w-4 h-4"})]})]})]}),!h&&e.jsx("button",{onClick:()=>s(!n),className:"ml-auto text-white hover:text-purple-300 transition-colors p-2","aria-label":"Toggle menu",children:n?e.jsx(Yt,{className:"w-6 h-6"}):e.jsx(Et,{className:"w-6 h-6"})})]}),!h&&n&&e.jsx("div",{className:"py-4 border-t border-white/10",children:e.jsxs("div",{className:"flex flex-col gap-4",children:[I.map(g=>e.jsx(ne,{to:g.path,onClick:()=>s(!1),className:`text-sm font-medium transition-colors duration-300 ${m(g.path)?"text-purple-300":"text-gray-200 hover:text-white"}`,children:g.label},g.path)),e.jsxs("a",{href:"https://gobabytrade.com/432706BE",onClick:()=>{b(),s(!1)},target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-4 py-2 rounded-full font-semibold text-sm transition-all duration-300 shadow-lg shadow-purple-500/30",children:["Start Trading – Save $1,000",e.jsx(Z,{className:"w-4 h-4"})]})]})})]})})},Q=({to:a,children:n})=>e.jsx(ne,{to:a,className:"text-purple-300 hover:text-purple-200 underline transition-colors duration-200",children:n}),tn=[{category:"My Personal Experience",icon:Ze,color:"from-purple-500 to-pink-500",questions:[{question:"Why did you start automated trading in January 2025?",answer:e.jsxs(e.Fragment,{children:["I was tired of watching charts and trying to time the market perfectly. I wanted a systematic approach that could work while I lived my life. The idea of a system that only trades when conditions are favorable—and sits patiently when they're not—made sense to me. I started tracking every single trade publicly on this site to prove it works. ",e.jsx(Q,{to:"/blog/trading-disorders-ai-solution",children:"Learn why I let an AI make every trade →"})]})},{question:"What surprised you most in your first months of trading?",answer:e.jsxs(e.Fragment,{children:["Two things: First, how truly hands-off it is. I genuinely don't watch it constantly. Second, how patience is everything. Some weeks are quiet with few trades, and that used to make me nervous. Now I understand that's the system being smart—waiting for the right opportunities instead of forcing trades. ",e.jsx(Q,{to:"/blog/trading-disorders-ai-solution",children:"Read more about overcoming trading emotions →"})]})},{question:"What happens during flat or low volatility weeks?",answer:"The system thrives on volatility, so when the market is flat, there are fewer trading opportunities. Some weeks I see very few trades. The key lesson I've learned: Don't panic and don't start tweaking settings. Patience is paramount. The system knows what it's doing—it's waiting for better conditions."},{question:"Do you still check it constantly or worry about trades?",answer:"Honestly? In the beginning, yes—I checked it all the time. Now, a few months in, I glance at it maybe once a day, sometimes less. The transparency on this site is actually for YOU to see how it works, not because I'm obsessing over every trade. The system handles it."},{question:"Your profits seem modest. Shouldn't you be making way more money?",answer:e.jsxs(e.Fragment,{children:["I get this question a lot, and I appreciate the honesty. Here's my perspective: I'm not trying to get rich quick—I'm building sustainable, consistent income. Those '$50K in a month!' claims you see everywhere? Usually from huge capital, massive risk, or cherry-picked best months. My results are real, transparent, and conservative. I'm focused on steady growth without gambling. ",e.jsx(Q,{to:"/blog/percent-gain-vs-roi",children:"Why I show % gain instead of ROI →"})]})},{question:"Why not scale up and make bigger profits faster?",answer:"Fair question. I could throw more money at it, but I'm being strategic. I'm adding capital gradually as I get more comfortable and as the system proves itself month after month. I'd rather grow methodically and sleep well at night than rush to scale and take on more risk than I'm comfortable with."},{question:"Would you recommend this to a complete beginner?",answer:e.jsxs(e.Fragment,{children:["Yes, but with realistic expectations. This isn't a 'get rich quick' scheme. It's systematic investing that requires patience and trust in the process. If you're willing to let the system do its job without constantly interfering, this works. ",e.jsx(Q,{to:"/blog/how-to-make-passive-income-crypto",children:"Read the complete beginner's guide →"})]})},{question:"How do I get started with this system?",answer:e.jsxs(e.Fragment,{children:["The system I use is called GoBabyTrade. You can start with paper trading to test it risk-free before going live. Use my referral link to save $1,000:"," ",e.jsx("a",{href:"https://gobabytrade.com/432706BE",target:"_blank",rel:"noopener noreferrer",className:"text-purple-300 hover:text-purple-200 underline transition-colors duration-200",children:"Get GoBabyTrade – Save $1,000"})]})}]},{category:"About My Trade Log",icon:V,color:"from-cyan-500 to-blue-500",questions:[{question:"Why do you publicly show every single trade?",answer:"Because I'm tired of fake affiliate sites with cherry-picked results and photoshopped screenshots. If I'm going to recommend this system, I need to prove it works with real, verifiable data. Every trade you see is real—pulled directly from my live Google Sheets that I update almost daily."},{question:"How do I know your trade log is real and not faked?",answer:"The data comes directly from my live Google Sheets, which I manually update from my robotic trader's transaction log—and everything traces back to my actual Coinbase transaction history. Plus, I show the flat weeks and quiet periods too, not just the wins. If I were faking it, why would I show the boring weeks?"},{question:"What do all the numbers in the trade log mean?",answer:"Each row shows a completed trade: the cryptocurrency, when I bought it, when I sold it, the quantity, the profit (or if it was a break-even trade), and the strategy used. The 'Trading Results' section summarizes everything—total profits, win rate, average profit per trade, etc."},{question:"Why are some weeks busier with trades than others?",answer:"The system only trades when market conditions are favorable. During high volatility, you'll see lots of trading activity. During flat periods, the system waits patiently. Some weeks have 20+ trades, other weeks might have 2-3. That's normal and expected."},{question:"What happens during down markets? Shouldn't the system stop trading?",answer:e.jsxs(e.Fragment,{children:["Actually, down markets are where the system shines! When prices drop, the trader accumulates inventory at lower prices—building up positions strategically. When prices turn around, you'll have a portfolio of positions ready to sell for profit. ",e.jsx(Q,{to:"/blog/why-start-automated-trading-in-down-markets",children:"Why down markets are the best time to start →"})]})},{question:"Your average profit per trade seems small. Why only a few dollars per trade?",answer:e.jsxs(e.Fragment,{children:["Here's what matters more than average profit per trade: I've been profitable every single month since I started. Every. Single. Month. The system isn't trying to hit home runs—it's focused on consistency and never selling at a loss. Small, consistent profits compound over time. ",e.jsx(Q,{to:"/blog/percent-gain-vs-roi",children:'Understanding % gain vs "how much should I invest" →'})]})},{question:"Do you ever hide losing trades?",answer:e.jsxs(e.Fragment,{children:["No. Every single trade is shown. However, the system is designed to only sell positions when they're profitable. If a position goes underwater, the system holds it until it can sell for a profit. That's the whole point—patience over panic. ",e.jsx(Q,{to:"/blog/never-sell-at-loss-crypto-trading",children:"Why the system never sells at a loss →"})]})},{question:"Can I see trades from specific cryptocurrencies?",answer:"Yes! The trade log shows which coins are being traded—BONK, DOGE, SHIB, and others. You can see which coins generate the most trades, which ones are most profitable, and how the system handles different market conditions for each coin."},{question:"Why is this level of transparency important?",answer:"Because 99% of crypto affiliate sites are full of hype and promises with no proof. I wanted to build something different—a site where you can see the actual performance, not marketing spin. This trade log is my proof and my accountability."},{question:"Why have results dropped from the July highs?",answer:"August and September 2025 saw a market-wide correction after July's peak. During these down markets, the trader accumulates more inventory at better prices—when markets recover, those accumulated positions generate significantly larger profits. Every month remains profitable despite lower activity."},{question:"Can I download the trading data?",answer:"Yes! You can download the complete trade log as a CSV file for your own analysis. Click the download button to export all transactions with timestamps, cryptocurrencies, buy/sell prices, and profit amounts."}]},{category:"Getting Started",icon:Ve,color:"from-blue-500 to-purple-500",questions:[{question:"What is robotic crypto trading?",answer:e.jsxs(e.Fragment,{children:["A robotic trader is an automated trading platform that executes buy and sell decisions based on market conditions and your settings. The system monitors markets 24/7 and executes trades in milliseconds without human intervention. ",e.jsx(Q,{to:"/blog/bucket-and-well-automated-trading-analogy",children:"Read the simple analogy that explains how it works →"})]})},{question:"Do I need trading experience?",answer:"No experience required! The AI handles all analysis and decisions. You set your preferences and investment amount - the platform does the rest. GoBabyTrade provides support and resources to help you understand the process."},{question:"How much money do I need to start?",answer:"Start with as little as $100. It's recommended to start small to get familiar with the platform before scaling up your investment."},{question:"Can I use this outside the USA?",answer:"Yes! Available worldwide as long as you can trade on Coinbase or Kraken. Simply verify you can create and fund an account with either exchange in your region."},{question:"Should I get Coinbase One?",answer:e.jsxs(e.Fragment,{children:["Absolutely! Coinbase One saves me hundreds monthly with $0 trading fees. When you're making multiple trades daily, those fees add up fast."," ",e.jsx("a",{href:"https://dailyprofits.link/cba",target:"_blank",rel:"noopener noreferrer",className:"text-purple-300 hover:text-purple-200 underline transition-colors duration-200",children:"Get Coinbase One here"})]})}]},{category:"Safety & Security",icon:oe,color:"from-green-500 to-blue-500",questions:[{question:"Is my money safe?",answer:"Yes! Your funds stay in your own Kraken/Coinbase accounts. The system only connects via API with trading permissions - it can never withdraw or transfer your funds."},{question:"What if the system makes losing trades?",answer:e.jsxs(e.Fragment,{children:["The GoBabyTrade protection system never executes losing trades. It waits for profitable opportunities or doesn't trade at all, safeguarding your capital. ",e.jsx(Q,{to:"/blog/never-sell-at-loss-crypto-trading",children:"Learn how the never-sell-at-loss strategy works →"})]})},{question:"Can I pause or stop the automated trading anytime?",answer:"Yes! You have complete control over the automation. You can pause or stop the robotic trader anytime directly in the trader interface. When paused, the system stops making new trades but your existing positions remain untouched."}]},{category:"Performance & Profits",icon:V,color:"from-purple-500 to-pink-500",questions:[{question:"What returns can I expect?",answer:"While past performance doesn't guarantee future results, the GoBabyTrade platform achieves consistent profits by only trading when conditions are favorable. Results vary based on market conditions and your settings."},{question:"How often does it trade?",answer:"The system operates 24/7 and only trades when profitable opportunities arise. May trade multiple times daily during favorable conditions, or wait patiently when conditions aren't optimal."},{question:"What about ROI?",answer:e.jsxs(e.Fragment,{children:["ROI calculations can be misleading since most successful traders grow capital over time. Focus on overall portfolio growth and consistent profitable trades rather than ROI percentages. ",e.jsx(Q,{to:"/blog/percent-gain-vs-roi",children:'Why I show % gain instead of "how much should I invest" →'})]})},{question:"Does it ever sell at a loss?",answer:e.jsxs(e.Fragment,{children:["Positions are only sold when profitable, unless you manually choose otherwise. The system waits patiently for opportunities to sell for gains, avoiding locked-in losses. ",e.jsx(Q,{to:"/blog/never-sell-at-loss-crypto-trading",children:"Deep dive: Why never selling at a loss is actually possible →"})]})},{question:"Do you guarantee profits?",answer:"No legitimate system can guarantee profits. However, the GoBabyTrade approach of never trading at a loss significantly improves your probability of success."}]},{category:"Money Management",icon:de,color:"from-emerald-500 to-teal-500",questions:[{question:"Why doesn't the trader use all my available capital?",answer:"The system is designed to be conservative and patient. It waits for optimal opportunities rather than rushing to deploy all capital at once. This approach protects you from market volatility."},{question:"How does profit management work?",answer:"The system automatically manages profits, and you control whether to reinvest them or keep them separate. You can choose to compound your gains for faster growth or withdraw profits."},{question:"Does the system support dollar cost averaging?",answer:"Yes! There are advanced options where the trader will only buy positions and never sell, effectively creating a dollar cost averaging strategy. Perfect for long-term accumulation."},{question:"Why does the trader buy many positions but not sell during market dips?",answer:e.jsxs(e.Fragment,{children:["Down markets are actually good - this is where you build inventory! The trader takes advantage of lower prices to accumulate positions. When markets recover, you'll have multiple profitable positions ready to sell. ",e.jsx(Q,{to:"/blog/why-start-automated-trading-in-down-markets",children:"Why down markets are the best time to start (with real numbers) →"})]})},{question:"Which cryptocurrencies work best for different strategies?",answer:"For active trading, faster-moving currencies often provide more opportunities. However, established coins like BTC and ETH may be better suited for long-term dollar cost averaging strategies. These are examples only - GoBabyTrade provides technical support, not investment advice."},{question:"How do I handle taxes on my trading profits?",answer:e.jsxs(e.Fragment,{children:["Crypto taxes can be complex with hundreds of trades. I personally use CoinTracker to automatically track all my trades and generate tax reports."," ",e.jsx("a",{href:"https://dailyprofits.link/cointracker",target:"_blank",rel:"noopener noreferrer",className:"text-purple-300 hover:text-purple-200 underline transition-colors duration-200",children:"Get CoinTracker here"})]})}]},{category:"Technical & Support",icon:Ie,color:"from-orange-500 to-red-500",questions:[{question:"Why Coinbase and Kraken instead of other exchanges?",answer:"The robotic trading platform was developed specifically for Coinbase and Kraken. These are the only exchanges with approved API integrations from the developer. They also happen to be two of the most reliable and secure exchanges available."},{question:"What exchanges does GoBabyTrade support?",answer:"Coinbase and Kraken exclusively. Seamless integration through secure API connections while keeping your funds safe in your own accounts."},{question:"Do I need to keep my computer running?",answer:"No! The system runs on cloud servers 24/7 even when your computer is off. Monitor trades and adjust settings from any device through the web platform."},{question:"What support is available?",answer:"GoBabyTrade provides comprehensive technical support for setup, configuration, and platform questions. Support is for technical and educational purposes only - no financial advice."}]}],nn=({question:a,answer:n})=>{const[s,t]=w.useState(!1);return e.jsxs("div",{className:"bg-gray-900/50 rounded-xl border border-white/10 overflow-hidden hover:border-purple-400/40 transition-all duration-300 shadow-lg shadow-purple-500/10",children:[e.jsxs("button",{onClick:()=>t(!s),className:"w-full px-6 py-4 text-left flex items-center justify-between hover:bg-white/10 transition-colors duration-200",children:[e.jsx("span",{className:"text-lg font-semibold text-white pr-4",children:a}),e.jsx("div",{className:"flex-shrink-0",children:s?e.jsx(_e,{className:"w-5 h-5 text-purple-300"}):e.jsx(Ke,{className:"w-5 h-5 text-purple-300"})})]}),e.jsx("div",{className:`overflow-hidden transition-all duration-300 ease-in-out ${s?"max-h-[500px] opacity-100":"max-h-0 opacity-0"}`,children:e.jsx("div",{className:"px-6 pb-4 border-t border-white/20",children:e.jsx("div",{className:"text-gray-200 leading-relaxed pt-4",children:n})})})]})},an=({category:a,icon:n,color:s,questions:t})=>e.jsxs("div",{className:"mb-8",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("div",{className:`p-2 rounded-lg bg-gradient-to-br ${s} shadow-lg`,children:e.jsx(n,{className:"w-5 h-5 text-white"})}),e.jsx("h3",{className:"text-2xl font-bold text-white",children:a})]}),e.jsx("div",{className:"space-y-3",children:t.map((i,h)=>e.jsx(nn,{question:i.question,answer:i.answer},h))})]}),sn=()=>e.jsxs("div",{className:"min-h-screen bg-slate-900",children:[e.jsx(ue,{}),e.jsxs("section",{className:"py-20 px-4 relative overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-slate-900 via-purple-900/30 to-slate-900 -z-10"}),e.jsx("div",{className:"absolute top-0 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl -z-10"}),e.jsx("div",{className:"absolute bottom-0 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl -z-10"}),e.jsxs("div",{className:"max-w-4xl mx-auto relative z-10",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsx("h1",{className:"text-4xl md:text-5xl font-bold text-white mb-4",children:"Frequently Asked Questions"}),e.jsx("p",{className:"text-xl text-gray-300",children:"Real answers from real experience - no fluff, just transparency"})]}),e.jsx("div",{className:"max-w-2xl mx-auto mb-12",children:e.jsx("img",{src:"/graphics/homepage-faq-01.webp",alt:"3 Steps to Passive Income - Connect, Configure, Collect",className:"w-full rounded-2xl shadow-xl shadow-purple-500/10 border border-white/10"})}),e.jsx("div",{className:"space-y-8 mb-20",children:tn.map((a,n)=>e.jsx(an,{category:a.category,icon:a.icon,color:a.color,questions:a.questions},n))}),e.jsxs("div",{className:"mt-16 text-center bg-gradient-to-r from-gray-900/30 to-purple-900/20 rounded-2xl p-8 border border-white/10 shadow-lg shadow-purple-500/10",children:[e.jsx("h3",{className:"text-2xl font-bold text-white mb-4",children:"Ready to Start Trading?"}),e.jsx("p",{className:"text-gray-200 mb-6",children:"Get started with GoBabyTrade – the same AI-enhanced autonomous trading system I use. Try paper trading first, risk-free."}),e.jsx("a",{href:"https://gobabytrade.com/432706BE",target:"_blank",rel:"noopener noreferrer",className:"inline-block bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-4 px-8 rounded-xl hover:from-purple-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-200 shadow-lg shadow-purple-500/50",children:"Start Trading – Save $1,000 →"})]})]})]})]}),on=function(){return e.jsx("footer",{className:"relative py-16 px-4 border-t border-white/10",children:e.jsxs("div",{className:"max-w-6xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-8",children:[e.jsxs("a",{href:"/",className:"inline-flex items-center justify-center gap-3 mb-6 group",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg overflow-hidden shadow-lg shadow-purple-500/40 bg-gradient-to-br from-purple-500 to-pink-500 p-0.5 group-hover:scale-105 transition-transform",children:e.jsx("div",{className:"w-full h-full rounded overflow-hidden bg-white/10 backdrop-blur-sm",children:e.jsx("img",{src:"/robot-logo.png",alt:"MyRoboticTrader Robot",className:"w-full h-full object-cover"})})}),e.jsxs("div",{className:"text-xl font-bold group-hover:scale-105 transition-transform",children:[e.jsx("span",{className:"text-gray-300",children:"My"}),e.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text",children:"Robotic"}),e.jsx("span",{className:"text-gray-300",children:"Trader"}),e.jsx("span",{className:"text-purple-400 text-sm ml-1",children:".com"})]})]}),e.jsx("p",{className:"text-gray-400 mb-8 max-w-2xl mx-auto",children:"Set it and forget it crypto trading that never trades at a loss. Your funds stay secure while AI-Enhanced technology maximizes profits 24/7."}),e.jsxs("div",{className:"flex flex-col sm:flex-row justify-center items-center gap-6 mb-8",children:[e.jsxs("a",{href:"https://gobabytrade.com/432706BE",target:"_blank",rel:"noopener noreferrer",className:"text-gray-400 hover:text-purple-400 transition-colors flex items-center gap-2 group",children:["Start Trading – Save $1,000",e.jsx(me,{className:"w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity"})]}),e.jsxs("a",{href:"/resources",className:"text-gray-400 hover:text-purple-400 transition-colors flex items-center gap-2 group",children:["Recommended Tools",e.jsx(Z,{className:"w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity"})]}),e.jsxs("a",{href:"/privacy",className:"text-gray-400 hover:text-purple-400 transition-colors flex items-center gap-2 group",children:[e.jsx(oe,{className:"w-4 h-4"}),"Privacy Policy",e.jsx(Z,{className:"w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity"})]}),e.jsxs("a",{href:"https://x.com/myrobotictrader",target:"_blank",rel:"noopener noreferrer",className:"text-gray-400 hover:text-purple-400 transition-colors flex items-center gap-2 group",children:[e.jsx(Ft,{className:"w-4 h-4"}),"Follow Us on X",e.jsx(me,{className:"w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity"})]})]})]}),e.jsx("div",{className:"border-t border-white/10 pt-8 mb-8",children:e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8 text-xs text-gray-500 max-w-5xl mx-auto",children:[e.jsxs("div",{className:"bg-white/5 rounded-lg p-4 border border-white/10",children:[e.jsx("h4",{className:"text-gray-300 font-semibold mb-2",children:"Affiliate Disclosure"}),e.jsx("p",{className:"leading-relaxed mb-3",children:"We earn commissions from recommended products and services. This doesn't affect our recommendations or your costs. We only promote solutions we believe provide real value to traders."}),e.jsxs("p",{className:"leading-relaxed text-purple-300",children:[e.jsx("strong",{children:"Specific Disclosure:"})," We are an affiliate of GoBabyTrade and earn commissions when you sign up through our referral link. Use our link to save $1,000 on your subscription."]})]}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-4 border border-white/10",children:[e.jsx("h4",{className:"text-gray-300 font-semibold mb-2",children:"Risk Warning"}),e.jsx("p",{className:"leading-relaxed",children:"Crypto trading involves risk. Past performance doesn't guarantee future results. Only trade with funds you can afford to lose. Consider your risk tolerance carefully. Always do your own research (DYOR)."})]}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-4 border border-white/10",children:[e.jsx("h4",{className:"text-gray-300 font-semibold mb-2",children:"Platform Disclaimer"}),e.jsx("p",{className:"leading-relaxed",children:"Not affiliated with Facebook, Meta, Coinbase, Kraken, or any trading platform unless explicitly stated. All trademarks belong to their respective owners and are used for identification only."})]}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-4 border border-white/10",children:[e.jsx("h4",{className:"text-gray-300 font-semibold mb-2",children:"Educational Purpose"}),e.jsx("p",{className:"leading-relaxed",children:"Information provided is educational only, not financial advice. Individual results vary. Consult qualified financial professionals before making investment decisions."})]})]})}),e.jsxs("div",{className:"border-t border-white/10 pt-8 text-center",children:[e.jsxs("a",{href:"/",className:"inline-flex items-center justify-center gap-2 mb-3 group",children:[e.jsx("div",{className:"w-5 h-5 rounded overflow-hidden bg-gradient-to-br from-purple-500 to-pink-500 p-0.5 group-hover:scale-105 transition-transform",children:e.jsx("div",{className:"w-full h-full rounded overflow-hidden bg-white/10 backdrop-blur-sm",children:e.jsx("img",{src:"/robot-logo.png",alt:"",className:"w-full h-full object-cover"})})}),e.jsxs("span",{className:"text-gray-400 text-sm group-hover:text-purple-400 transition-colors",children:["© 2025"," ",e.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-semibold",children:"MyRoboticTrader"}),".com"]})]}),e.jsx("div",{className:"text-xs text-gray-500",children:"Independent affiliate marketing website. Not affiliated with any trading platform or exchange unless explicitly disclosed above."}),e.jsxs("button",{onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),className:"mt-6 inline-flex items-center gap-2 text-purple-300 hover:text-purple-200 transition-colors group","aria-label":"Back to top",children:[e.jsx(jt,{className:"w-4 h-4 group-hover:-translate-y-1 transition-transform"}),e.jsx("span",{className:"text-sm font-medium",children:"Back to Top"})]})]})]})})},rn=function(){const{tradingStats:a}=be(),n=Se(),s=a!=null&&a.totalProfit?`$${Math.round(a.totalProfit).toLocaleString()}+`:"$5,000+";return e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900",children:[e.jsx(ue,{}),e.jsxs("section",{className:"py-12 px-4 relative overflow-hidden",children:[e.jsx("div",{className:"absolute top-10 right-10 opacity-10 pointer-events-none hidden lg:block",children:e.jsx("img",{src:"/robot-trading.png",alt:"",className:"w-24 h-24 animate-pulse"})}),e.jsx("div",{className:"relative max-w-6xl mx-auto text-center z-10 mt-8",children:e.jsxs("div",{className:"mb-8",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-400/40 mb-6 shadow-lg shadow-purple-500/20",children:[e.jsx(It,{className:"w-4 h-4 text-purple-300"}),e.jsx("span",{className:"text-purple-200 font-medium",children:"Recommended Tools"})]}),e.jsxs("h1",{className:"text-4xl md:text-6xl font-bold text-white mb-6 leading-tight",children:["Tools I Use &",e.jsx("span",{className:"block text-transparent bg-gradient-to-r from-green-300 via-blue-400 to-purple-400 bg-clip-text",children:"Personally Recommend"})]}),e.jsxs("p",{className:"text-xl text-gray-200 mb-8 max-w-3xl mx-auto",children:["After ",n," of successful automated trading, these are the essential tools and services that have made my crypto journey profitable and stress-free."]}),e.jsx("div",{className:"bg-gradient-to-r from-gray-900/30 to-purple-900/20 rounded-2xl border border-white/10 p-6 max-w-2xl mx-auto",children:e.jsxs("p",{className:"text-blue-200 font-medium",children:["💡 ",e.jsx("strong",{children:"My Promise:"})," I only recommend tools I personally use and believe provide real value. Your success is my success."]})})]})})]}),e.jsx("section",{className:"py-16 px-4 pb-8",children:e.jsxs("div",{className:"max-w-6xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-green-500/30 to-emerald-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-green-400/40 mb-6 shadow-lg shadow-green-500/20",children:[e.jsx(V,{className:"w-4 h-4 text-green-300"}),e.jsx("span",{className:"text-green-200 font-medium",children:"Trading Platforms"})]}),e.jsx("h2",{className:"text-3xl md:text-4xl font-bold text-white mb-4",children:"Where I Trade & Why"}),e.jsx("p",{className:"text-gray-300 max-w-2xl mx-auto",children:"You need at least one of these exchanges to work with the AI-Enhanced Autonomous Trader. Both are reliable, secure, and perfect for automated trading."})]}),e.jsx("div",{className:"max-w-2xl mx-auto mb-10",children:e.jsx("img",{src:"/graphics/resources-coinbase-01.webp",alt:"Why Coinbase One - Zero fees comparison showing $3,300+ annual savings",className:"w-full rounded-2xl shadow-xl shadow-blue-500/10 border border-white/10"})}),e.jsxs("div",{className:"bg-gradient-to-r from-gray-900/30 to-purple-900/20 rounded-2xl border border-white/10 p-8 mb-8 shadow-lg shadow-purple-500/10 relative",children:[e.jsx("div",{className:"absolute top-4 right-4 md:top-6 md:right-6",children:e.jsx("div",{className:"bg-gradient-to-r from-green-400 to-emerald-400 text-black px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-bold",children:"ESSENTIAL"})}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-8 items-center",children:[e.jsxs("div",{className:"mt-8 md:mt-0",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("div",{className:"w-12 h-12 bg-blue-500 rounded-xl p-3",children:e.jsx(Le,{className:"w-full h-full text-white"})}),e.jsx("h3",{className:"text-2xl font-bold text-white",children:"Coinbase One"})]}),e.jsx("p",{className:"text-gray-200 mb-6 leading-relaxed",children:"My primary exchange for automated trading. Coinbase One gives you zero trading fees, which is crucial when you're making multiple trades daily. The API integration is rock-solid for robotic trading."}),e.jsxs("div",{className:"space-y-3 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"$0 trading fees (saves me hundreds monthly)"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Perfect API for automated trading"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Trusted by millions of traders"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Advanced trading tools included"})]})]}),e.jsxs("a",{href:"https://dailyprofits.link/cba",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/30",children:["Get Coinbase One",e.jsx(me,{className:"w-4 h-4"})]})]}),e.jsxs("div",{className:"bg-gray-900/50 rounded-xl p-6 border border-white/10",children:[e.jsx("h4",{className:"text-lg font-semibold text-white mb-4",children:"Why I Choose Coinbase One:"}),e.jsxs("div",{className:"space-y-3 text-sm text-gray-300",children:[e.jsxs("p",{children:["💰 ",e.jsx("strong",{children:"Zero fees"})," mean more profits stay in my pocket"]}),e.jsxs("p",{children:["🤖 ",e.jsx("strong",{children:"API reliability"})," is crucial for automated trading"]}),e.jsxs("p",{children:["🛡️ ",e.jsx("strong",{children:"Security"})," - my funds have always been safe"]}),e.jsxs("p",{children:["📱 ",e.jsx("strong",{children:"Mobile app"})," lets me monitor trades anywhere"]})]})]})]})]}),e.jsxs("div",{className:"bg-gradient-to-r from-gray-900/30 to-purple-900/20 rounded-2xl border border-white/10 p-8 shadow-lg shadow-purple-500/10 relative",children:[e.jsx("div",{className:"absolute top-4 right-4 md:top-6 md:right-6",children:e.jsx("div",{className:"bg-gradient-to-r from-blue-400 to-indigo-400 text-white px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-bold",children:"GREAT ALTERNATIVE"})}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-8 items-center",children:[e.jsxs("div",{className:"mt-8 md:mt-0",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("div",{className:"w-12 h-12 bg-indigo-500 rounded-xl p-3",children:e.jsx(Le,{className:"w-full h-full text-white"})}),e.jsx("h3",{className:"text-2xl font-bold text-white",children:"Kraken"})]}),e.jsx("p",{className:"text-gray-200 mb-6 leading-relaxed",children:"My alternative exchange for automated trading. Kraken offers excellent API reliability and competitive fees. Great option if you prefer a different platform or want to diversify across exchanges."}),e.jsxs("div",{className:"space-y-3 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Low trading fees and excellent API"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Strong security and reputation"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Works perfectly with robotic trader"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Advanced trading features"})]})]}),e.jsxs("a",{href:"https://dailyprofits.link/krak",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-indigo-500/30",children:["Get Kraken Account",e.jsx(me,{className:"w-4 h-4"})]})]}),e.jsxs("div",{className:"bg-gray-900/50 rounded-xl p-6 border border-white/10",children:[e.jsx("h4",{className:"text-lg font-semibold text-white mb-4",children:"Why Kraken Works Great:"}),e.jsxs("div",{className:"space-y-3 text-sm text-gray-300",children:[e.jsxs("p",{children:["🔒 ",e.jsx("strong",{children:"Security first"})," - excellent track record"]}),e.jsxs("p",{children:["⚡ ",e.jsx("strong",{children:"Fast API"})," - reliable for automated trading"]}),e.jsxs("p",{children:["💰 ",e.jsx("strong",{children:"Competitive fees"})," - keep more of your profits"]}),e.jsxs("p",{children:["🌍 ",e.jsx("strong",{children:"Global reach"})," - available in most countries"]})]})]})]})]})]})}),e.jsx("section",{className:"py-8 px-4",children:e.jsxs("div",{className:"max-w-6xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-orange-500/30 to-red-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-orange-400/40 mb-6 shadow-lg shadow-orange-500/20",children:[e.jsx(De,{className:"w-4 h-4 text-orange-300"}),e.jsx("span",{className:"text-orange-200 font-medium",children:"Tax & Accounting"})]}),e.jsx("h2",{className:"text-3xl md:text-4xl font-bold text-white mb-4",children:"Stay Compliant & Organized"}),e.jsx("p",{className:"text-gray-300 max-w-2xl mx-auto",children:"Crypto taxes can be complex. These tools make it simple and ensure you're always compliant with tax regulations."})]}),e.jsx("div",{className:"max-w-2xl mx-auto mb-10",children:e.jsx("img",{src:"/graphics/resources-taxes-01.webp",alt:"500 Trades Tax Nightmare - DIY vs CoinTracker comparison",className:"w-full rounded-2xl shadow-xl shadow-orange-500/10 border border-white/10"})}),e.jsxs("div",{className:"bg-gradient-to-r from-gray-900/30 to-purple-900/20 rounded-2xl border border-white/10 p-8 shadow-lg shadow-purple-500/10 relative",children:[e.jsx("div",{className:"absolute top-4 right-4 md:top-6 md:right-6",children:e.jsx("div",{className:"bg-gradient-to-r from-green-400 to-emerald-400 text-black px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-bold",children:"ESSENTIAL"})}),e.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-8 items-center",children:[e.jsxs("div",{className:"mt-8 md:mt-0",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("div",{className:"w-12 h-12 bg-orange-500 rounded-xl p-3",children:e.jsx(De,{className:"w-full h-full text-white"})}),e.jsx("h3",{className:"text-2xl font-bold text-white",children:"CoinTracker"})]}),e.jsx("p",{className:"text-gray-200 mb-6 leading-relaxed",children:"After making hundreds of profitable trades, tax reporting became crucial. CoinTracker automatically tracks everything and generates the reports I need for my accountant. It's saved me countless hours."}),e.jsxs("div",{className:"space-y-3 mb-6",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Automatic trade tracking across exchanges"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Tax forms ready for filing (8949, Schedule D)"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Real-time profit/loss tracking"})]}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(J,{className:"w-5 h-5 text-green-300 flex-shrink-0"}),e.jsx("span",{className:"text-gray-200",children:"Connects to Coinbase & Kraken"})]})]}),e.jsxs("a",{href:"https://dailyprofits.link/cointracker",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-orange-500/30",children:["Get CoinTracker",e.jsx(me,{className:"w-4 h-4"})]})]}),e.jsxs("div",{className:"bg-gray-900/50 rounded-xl p-6 border border-white/10",children:[e.jsx("h4",{className:"text-lg font-semibold text-white mb-4",children:"Why Tax Tracking Matters:"}),e.jsxs("div",{className:"space-y-3 text-sm text-gray-300",children:[e.jsxs("p",{children:["📊 ",e.jsx("strong",{children:"Automated reporting"})," saves hours of manual work"]}),e.jsxs("p",{children:["💼 ",e.jsx("strong",{children:"Professional tax forms"})," ready for your accountant"]}),e.jsxs("p",{children:["🎯 ",e.jsx("strong",{children:"Accurate calculations"})," ensure proper tax compliance"]}),e.jsxs("p",{children:["💰 ",e.jsx("strong",{children:"Maximize deductions"})," and minimize tax liability"]})]})]})]})]})]})}),e.jsx("section",{className:"py-16 px-4",children:e.jsx("div",{className:"max-w-4xl mx-auto text-center",children:e.jsxs("div",{className:"bg-gray-900/50 rounded-2xl border border-white/10 p-8 shadow-lg shadow-purple-500/10",children:[e.jsx("h3",{className:"text-2xl md:text-3xl font-bold text-white mb-4",children:"Ready to Start Your Trading Journey?"}),e.jsxs("p",{className:"text-gray-200 mb-6 max-w-2xl mx-auto",children:["These tools have been essential to my ",s," profit success. GoBabyTrade is the AI-enhanced autonomous trading system I use. Use my link to save $1,000!"]}),e.jsx("div",{className:"flex flex-col sm:flex-row gap-4 justify-center",children:e.jsxs("a",{href:"https://gobabytrade.com/432706BE",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-purple-500/30",children:["Start Trading – Save $1,000",e.jsx(Z,{className:"w-4 h-4"})]})})]})})}),e.jsx("section",{className:"py-8 px-4 border-t border-white/10",children:e.jsx("div",{className:"max-w-4xl mx-auto",children:e.jsxs("div",{className:"bg-white/5 rounded-lg p-6 border border-white/10",children:[e.jsx("h4",{className:"text-white font-semibold mb-3",children:"📋 Affiliate Disclosure"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed mb-3",children:"I earn commissions from recommended products and services on this page. This doesn't affect your costs or my recommendations. I only promote tools I personally use and believe provide real value to traders."}),e.jsxs("p",{className:"text-gray-400 text-sm leading-relaxed",children:[e.jsx("strong",{children:"Transparency Promise:"})," Every tool listed here is something I actively use in my own trading setup. Your success with these tools directly impacts my reputation, so I'm incentivized to recommend only the best."]})]})})})]})},ln=function(){return e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900",children:[e.jsx(ue,{}),e.jsx("section",{className:"py-12 px-4 border-b border-white/10 relative overflow-hidden",children:e.jsx("div",{className:"relative max-w-4xl mx-auto text-center mt-8",children:e.jsxs("div",{className:"mb-8",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-400/40 mb-6 shadow-lg shadow-purple-500/20",children:[e.jsx(oe,{className:"w-4 h-4 text-purple-300"}),e.jsx("span",{className:"text-purple-200 font-medium",children:"Privacy Policy"})]}),e.jsx("h1",{className:"text-3xl md:text-4xl font-bold text-white mb-4",children:"Privacy Policy"}),e.jsx("p",{className:"text-gray-300 max-w-2xl mx-auto",children:"Your privacy is important to us. This policy explains how we collect, use, and protect your information."}),e.jsx("p",{className:"text-sm text-gray-400 mt-2",children:"Last updated: December 6, 2025"})]})})}),e.jsx("div",{className:"max-w-xl mx-auto mb-12 px-4",children:e.jsx("img",{src:"/graphics/privacy-data-01.webp",alt:"What We Collect vs What We Don't - Privacy protection overview",className:"w-full rounded-2xl shadow-xl shadow-blue-500/10 border border-white/10"})}),e.jsx("section",{className:"py-16 px-4",children:e.jsx("div",{className:"max-w-4xl mx-auto",children:e.jsxs("div",{className:"bg-gradient-to-r from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl border border-white/10 p-8 space-y-8",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx(Je,{className:"w-6 h-6 text-blue-300"}),e.jsx("h2",{className:"text-2xl font-bold text-white",children:"Information We Collect"})]}),e.jsxs("div",{className:"space-y-4 text-gray-300",children:[e.jsxs("p",{children:[e.jsx("strong",{className:"text-white",children:"Analytics Data:"})," We use Google Analytics to understand how visitors interact with our website. This includes:"]}),e.jsxs("ul",{className:"list-disc list-inside ml-4 space-y-2",children:[e.jsx("li",{children:"Pages visited and time spent on site"}),e.jsx("li",{children:"Device type, browser, and operating system"}),e.jsx("li",{children:"General geographic location (country/city level)"}),e.jsx("li",{children:"Referral sources (how you found our site)"})]}),e.jsxs("p",{children:[e.jsx("strong",{className:"text-white",children:"Cookies:"})," We use cookies to improve your browsing experience and analyze site traffic. You can disable cookies in your browser settings."]})]})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx(oe,{className:"w-6 h-6 text-green-300"}),e.jsx("h2",{className:"text-2xl font-bold text-white",children:"How We Use Your Information"})]}),e.jsxs("div",{className:"space-y-4 text-gray-300",children:[e.jsx("p",{children:"We use the information we collect to:"}),e.jsxs("ul",{className:"list-disc list-inside ml-4 space-y-2",children:[e.jsx("li",{children:"Improve our website content and user experience"}),e.jsx("li",{children:"Understand which pages and features are most valuable"}),e.jsx("li",{children:"Analyze traffic patterns and optimize site performance"}),e.jsx("li",{children:"Ensure our content is relevant and helpful"})]}),e.jsxs("p",{children:[e.jsx("strong",{className:"text-white",children:"We do not:"})," Sell, rent, or share your personal information with third parties for marketing purposes."]})]})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx(Pt,{className:"w-6 h-6 text-purple-300"}),e.jsx("h2",{className:"text-2xl font-bold text-white",children:"Affiliate Links & Disclosures"})]}),e.jsx("div",{className:"max-w-lg mx-auto mb-6",children:e.jsx("img",{src:"/graphics/privacy-affiliate-01.webp",alt:"How Affiliate Links Work - Transparency explanation",className:"w-full rounded-xl shadow-lg shadow-purple-500/10 border border-white/10"})}),e.jsxs("div",{className:"space-y-4 text-gray-300",children:[e.jsxs("p",{children:[e.jsx("strong",{className:"text-white",children:"Affiliate Relationships:"})," ","This website contains affiliate links to products and services we recommend. This means:"]}),e.jsxs("ul",{className:"list-disc list-inside ml-4 space-y-2",children:[e.jsx("li",{children:"We may earn a commission if you make a purchase through our links"}),e.jsx("li",{children:"This does not affect the price you pay"}),e.jsx("li",{children:"We only recommend tools and services we personally use and believe in"}),e.jsx("li",{children:"Our recommendations are based on genuine experience and results"})]}),e.jsx("div",{className:"bg-blue-500/10 border border-blue-400/20 rounded-lg p-4 mt-4",children:e.jsxs("p",{className:"text-blue-200",children:[e.jsx("strong",{children:"Transparency Promise:"})," All trading results shown are real and from Patrick's personal trading account. We believe in complete transparency about both our results and our affiliate relationships."]})})]})]}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-2xl font-bold text-white mb-4",children:"Third-Party Services"}),e.jsxs("div",{className:"space-y-4 text-gray-300",children:[e.jsx("p",{children:"Our website uses the following third-party services:"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4 mt-4",children:[e.jsxs("div",{className:"bg-white/5 rounded-lg p-4",children:[e.jsx("h3",{className:"text-white font-semibold mb-2",children:"Google Analytics"}),e.jsx("p",{className:"text-sm",children:"Website traffic analysis and user behavior tracking."}),e.jsx("a",{href:"https://policies.google.com/privacy",target:"_blank",rel:"noopener noreferrer",className:"text-blue-300 hover:text-blue-200 text-sm",children:"Google Privacy Policy â†’"})]}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-4",children:[e.jsx("h3",{className:"text-white font-semibold mb-2",children:"Cloudflare Pages"}),e.jsx("p",{className:"text-sm",children:"Website hosting and content delivery network."}),e.jsx("a",{href:"https://www.cloudflare.com/privacy/",target:"_blank",rel:"noopener noreferrer",className:"text-blue-300 hover:text-blue-200 text-sm",children:"Cloudflare Privacy Policy â†’"})]})]})]})]}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-2xl font-bold text-white mb-4",children:"Your Rights & Choices"}),e.jsxs("div",{className:"space-y-4 text-gray-300",children:[e.jsx("p",{children:"You have the right to:"}),e.jsxs("ul",{className:"list-disc list-inside ml-4 space-y-2",children:[e.jsx("li",{children:"Opt out of Google Analytics tracking by using browser settings or extensions"}),e.jsx("li",{children:"Disable cookies in your browser (may affect site functionality)"}),e.jsx("li",{children:"Request information about data we may have collected"}),e.jsx("li",{children:"Contact us with any privacy-related questions or concerns"})]})]})]}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx(Wt,{className:"w-6 h-6 text-yellow-300"}),e.jsx("h2",{className:"text-2xl font-bold text-white",children:"Contact Us"})]}),e.jsxs("div",{className:"space-y-4 text-gray-300",children:[e.jsx("p",{children:"If you have any questions about this Privacy Policy or our data practices, please contact us:"}),e.jsxs("div",{className:"bg-white/5 rounded-lg p-4",children:[e.jsxs("p",{children:[e.jsx("strong",{className:"text-white",children:"Website:"})," ","MyRoboticTrader.com"]}),e.jsxs("p",{children:[e.jsx("strong",{className:"text-white",children:"Twitter:"})," ","@myrobotictrader"]}),e.jsxs("p",{children:[e.jsx("strong",{className:"text-white",children:"Email:"})," Available through our social media channels"]})]})]})]}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-2xl font-bold text-white mb-4",children:"Policy Updates"}),e.jsx("div",{className:"text-gray-300",children:e.jsx("p",{children:'We may update this Privacy Policy from time to time. Any changes will be posted on this page with an updated "Last modified" date. We encourage you to review this policy periodically.'})})]})]})})}),e.jsx("section",{className:"py-8 px-4 border-t border-white/10",children:e.jsx("div",{className:"max-w-4xl mx-auto text-center",children:e.jsxs("a",{href:"/",className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-purple-500/30",children:[e.jsx(Nt,{className:"w-4 h-4"}),"Back to MyRoboticTrader"]})})})]})},dn=()=>{const{tradingStats:a,isLoading:n}=be(),s=Se(),t="https://gobabytrade.com/432706BE?utm_source=business_card&utm_medium=nfc_qr&utm_campaign=live_results_2025";if(n||!a)return e.jsxs("section",{className:"relative min-h-screen flex items-center justify-center px-4",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"}),e.jsx("div",{className:"relative text-white text-xl",children:"Loading live data..."})]});const i=a.dailyAvg.toFixed(2);return e.jsxs("section",{className:"relative min-h-screen flex items-center justify-center px-4 overflow-hidden pb-10 pt-10",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"}),e.jsx("div",{className:"absolute top-0 left-0 w-full h-full bg-gradient-to-br from-transparent via-purple-500/15 to-transparent"}),e.jsx("div",{className:"absolute top-8 left-1/2 transform -translate-x-1/2 z-20",children:e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"w-10 h-10 rounded-xl overflow-hidden shadow-lg shadow-purple-500/40 bg-gradient-to-br from-purple-500 to-pink-500 p-0.5",children:e.jsx("div",{className:"w-full h-full rounded-lg overflow-hidden bg-white/10 backdrop-blur-sm",children:e.jsx("img",{src:"/robot-logo.png",alt:"MyRoboticTrader Robot",className:"w-full h-full object-cover"})})}),e.jsxs("div",{className:"text-2xl font-bold",children:[e.jsx("span",{className:"text-white",children:"My"}),e.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text",children:"Robotic"}),e.jsx("span",{className:"text-white",children:"Trader"}),e.jsx("span",{className:"text-purple-300 text-sm ml-1",children:".com"})]})]})}),e.jsxs("div",{className:"relative max-w-6xl mx-auto text-center z-10 mt-16",children:[e.jsxs("div",{className:"mb-8",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-green-500/30 to-emerald-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-green-400/40 mb-6 shadow-lg shadow-green-500/20",children:[e.jsx("div",{className:"w-3 h-3 bg-green-400 rounded-full animate-pulse"}),e.jsx("span",{className:"text-green-200 font-medium",children:a.isLiveData?"LIVE DATA":"REAL RESULTS"})]}),e.jsxs("div",{className:"mb-6",children:[e.jsx("h1",{className:"text-4xl md:text-5xl font-bold text-white mb-4 leading-tight",children:"Thanks for scanning my card! 👋"}),e.jsx("p",{className:"text-xl md:text-2xl text-gray-200 mb-2",children:"Here are my LIVE trading results:"}),e.jsx("p",{className:"text-lg text-purple-200",children:"Real profits. Real transparency. Zero BS."})]})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10",children:[e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-green-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-green-500 to-emerald-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-emerald-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-green-500/40",children:e.jsx(de,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-4xl font-bold text-green-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-green-300 group-hover:to-emerald-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:["$",a.totalProfit.toLocaleString()]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Total Profits"}),e.jsxs("div",{className:"text-green-300 text-sm mt-1",children:[s," • Always Growing!"]})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500 to-emerald-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-orange-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-orange-500 to-amber-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-orange-500/40",children:e.jsx(ge,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsx("div",{className:"text-4xl font-bold text-orange-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-orange-300 group-hover:to-amber-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:a.totalTrades.toLocaleString()}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Closed Trades"}),e.jsx("div",{className:"text-orange-300 text-sm mt-1",children:"Consistent & Automated"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]}),e.jsxs("div",{className:"group relative bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-purple-500/15",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-purple-500 to-pink-500 opacity-0 group-hover:opacity-15 rounded-2xl transition-opacity duration-300"}),e.jsx("div",{className:"relative w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 p-3 mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-purple-500/40",children:e.jsx(V,{className:"w-full h-full text-white"})}),e.jsxs("div",{className:"relative text-center",children:[e.jsxs("div",{className:"text-4xl font-bold text-purple-300 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-300 group-hover:to-pink-300 group-hover:bg-clip-text transition-all duration-300 font-mono",children:["$",i]}),e.jsx("div",{className:"text-gray-200 font-medium group-hover:text-white transition-colors duration-300",children:"Daily Average"}),e.jsx("div",{className:"text-purple-300 text-sm mt-1",children:"Steady Growth"})]}),e.jsx("div",{className:"absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 opacity-0 group-hover:opacity-25 transition-opacity duration-300 -z-10 blur-xl"})]})]}),e.jsx("div",{className:"max-w-2xl mx-auto mb-10",children:e.jsxs("div",{className:"bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm rounded-2xl border border-green-400/30 p-6 shadow-lg shadow-green-500/20",children:[e.jsxs("div",{className:"flex items-center justify-center gap-3 mb-2",children:[e.jsx("div",{className:"w-3 h-3 bg-green-400 rounded-full animate-pulse"}),e.jsx("span",{className:"text-green-300 font-bold text-lg",children:"10 Months. 10 Winning Months."}),e.jsx("div",{className:"w-3 h-3 bg-green-400 rounded-full animate-pulse"})]}),e.jsx("p",{className:"text-gray-200 text-sm text-center",children:"100% profitable months since January 2025 • Every. Single. Month."})]})}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4 justify-center mb-12",children:[e.jsxs("a",{href:t,target:"_blank",rel:"noopener noreferrer",className:"group bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-purple-500/30 flex items-center justify-center gap-2",children:["Start Trading – Save $1,000",e.jsx(me,{className:"w-5 h-5 group-hover:translate-x-1 transition-transform"})]}),e.jsxs("a",{href:"/",className:"group border-2 border-white/40 hover:border-white/60 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 backdrop-blur-sm hover:bg-white/15 flex items-center justify-center gap-2 shadow-lg shadow-white/10",children:[e.jsx(Lt,{className:"w-5 h-5"}),"Explore Full Site",e.jsx(Z,{className:"w-5 h-5 group-hover:translate-x-1 transition-transform"})]})]}),e.jsxs("div",{className:"text-center",children:[e.jsx("p",{className:"text-sm text-yellow-300 font-medium mb-4",children:"🎯 GoBabyTrade is the AI-enhanced system I use – save $1,000 with my link!"}),e.jsx("p",{className:"text-xs text-gray-500 max-w-sm mx-auto leading-relaxed",children:"* Actual trading results from my personal account. Started January 8, 2025. Past performance does not guarantee future results."})]})]})]})},$e=[{title:"The 130x Gambling Explosion Nobody's Talking About",slug:"prediction-markets-gambling-explosion",date:"2025-12-20T12:00:00Z",heroImage:"/blog-images/prediction-markets-gambling-explosion-hero.webp",imageAlt:"Prediction markets grew 130x in 2 years - from $100M to $13B monthly volume",excerpt:`Prediction markets grew from $100M to $13B monthly in under 2 years. Here's why "financial innovation" is gambling's biggest rebrand.`,content:`# The 130x Gambling Explosion Nobody's Talking About
...
- [Crypto Is Dead? The SEC Chairman Disagrees.](/blog/crypto-is-dead-sec-depin-web3) - Why 'crypto is dead' means opportunity`,category:"Education",metaDescription:"Discover why starting automated crypto trading during market crashes is actually the optimal entry point, backed by real numbers and 25 years of data.",heroImage:"/blog-images/why-start-automated-trading-in-down-markets-hero.webp",imageAlt:"Cryptocurrency market downturn chart showing strategic entry opportunity"}],cn=()=>{const a=$e,[n,s]=Fe.useState(null),t=[...new Set(a.map(m=>m.category))],h=[...n?a.filter(m=>m.category===n):a].sort((m,d)=>new Date(d.date).getTime()-new Date(m.date).getTime()),b=m=>new Date(m).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),I=(m,d=200)=>{const M=m.replace(/^#+\s/gm,"").replace(/\*\*/g,"").replace(/\*/g,"").replace(/\[([^\]]+)\]\([^\)]+\)/g,"$1").replace(/\n/g," ");return M.length<=d?M:M.substring(0,d).trim()+"..."};return e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white",children:[e.jsx(ue,{}),e.jsx("section",{className:"py-12 px-4 relative overflow-hidden",children:e.jsx("div",{className:"relative max-w-6xl mx-auto text-center mt-8",children:e.jsxs("div",{className:"mb-8",children:[e.jsx("div",{className:"inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-400/40 mb-6 shadow-lg shadow-purple-500/20",children:e.jsx("span",{className:"text-purple-200 font-medium",children:"Trading Education"})}),e.jsxs("h1",{className:"text-5xl md:text-6xl font-bold mb-6",children:[e.jsx("span",{className:"text-white",children:"Blog & "}),e.jsx("span",{className:"text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text",children:"Insights"})]}),e.jsx("p",{className:"text-xl text-gray-200 max-w-3xl mx-auto",children:"Real insights from building transparent, systematic crypto trading systems. No hype, just facts and lessons learned."})]})})}),e.jsx("div",{className:"relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:e.jsxs("div",{className:"flex flex-wrap gap-4 justify-center",children:[e.jsx("button",{onClick:()=>s(null),className:`px-6 py-3 rounded-full transition-all duration-300 backdrop-blur-sm shadow-lg font-semibold text-sm ${n===null?"bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-2 border-purple-400/60 text-white shadow-purple-500/20":"bg-white/8 hover:bg-white/12 border border-white/20 hover:border-purple-400/30 text-gray-300 hover:text-white"}`,children:"All Posts"}),t.map(m=>e.jsx("button",{onClick:()=>s(m),className:`px-6 py-3 rounded-full transition-all duration-300 backdrop-blur-sm shadow-lg font-semibold text-sm ${n===m?"bg-gradient-to-r from-purple-500/20 to-pink-500/20 border-2 border-purple-400/60 text-white shadow-purple-500/20":"bg-white/8 hover:bg-white/12 border border-white/20 hover:border-purple-400/30 text-gray-300 hover:text-white"}`,children:m},m))]})}),e.jsxs("div",{className:"relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mb-16",children:[e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:h.map(m=>e.jsx(ne,{to:`/blog/${m.slug}`,className:"group",children:e.jsxs("article",{className:"h-full rounded-2xl overflow-hidden border border-white/10 hover:border-purple-400/40 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl shadow-lg shadow-purple-500/10 cursor-pointer relative bg-gray-900/50",children:[e.jsx("div",{className:"h-40 overflow-hidden",children:e.jsx("img",{src:m.heroImage,alt:m.imageAlt,className:"w-full h-full object-cover group-hover:scale-110 transition-all duration-300",style:{filter:"brightness(0.85)"}})}),e.jsxs("div",{className:"p-6 relative",children:[e.jsx("h2",{className:"text-2xl font-bold mb-3 text-white group-hover:text-purple-200 transition-colors duration-300",children:m.title}),e.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[e.jsx("span",{className:"inline-flex items-center px-2.5 py-1 text-xs font-semibold rounded-full bg-purple-500/20 text-purple-300 border border-purple-400/30",children:m.category}),e.jsx("span",{className:"text-gray-500",children:"•"}),e.jsx("span",{className:"text-gray-400 text-sm",children:b(m.date)})]}),e.jsx("p",{className:"text-gray-300 leading-relaxed mb-6 group-hover:text-gray-200 transition-colors duration-300",children:m.excerpt||I(m.content,150)}),e.jsxs("div",{className:"flex items-center text-purple-400 font-semibold group-hover:text-purple-300 transition-colors",children:["Read Full Article",e.jsx("svg",{className:"w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})]})]})},m.slug))}),e.jsx("div",{className:"relative mt-8 text-center bg-gray-900/50 rounded-2xl px-8 py-16 md:px-16 md:py-24 border border-white/10 shadow-2xl shadow-purple-500/10",children:e.jsxs("div",{className:"relative",children:[e.jsxs("h2",{className:"text-3xl md:text-4xl font-bold mb-10 leading-tight",children:[e.jsx("span",{className:"text-white",children:"Want to See These "}),e.jsx("span",{className:"text-transparent bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text",children:"Strategies in Action?"})]}),e.jsx("p",{className:"text-gray-200 text-lg md:text-xl mb-16 max-w-2xl mx-auto leading-relaxed",children:"Check out our live trading dashboard with complete transparency - every trade, every profit, updated automatically."}),e.jsxs(ne,{to:"/",className:"group inline-flex items-center gap-3 px-6 py-3 md:px-8 md:py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full font-semibold text-white text-base transition-all duration-300 transform hover:scale-105 shadow-lg shadow-purple-500/30 hover:shadow-2xl whitespace-nowrap",children:[e.jsx("span",{children:"View Live Results"}),e.jsx("svg",{className:"w-5 h-5 group-hover:translate-x-1 transition-transform flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})]})})]})]})},hn=({currentSlug:a})=>{const s=$e.filter(t=>t.slug!==a).sort((t,i)=>new Date(i.date).getTime()-new Date(t.date).getTime()).slice(0,5);return e.jsx("div",{children:e.jsxs("div",{className:"bg-slate-900/95 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-purple-400/30 shadow-lg shadow-purple-500/10",children:[e.jsx("h3",{className:"text-2xl md:text-3xl font-bold mb-6 text-white pb-3 border-b border-purple-400/30",children:"Recent Posts"}),e.jsx("div",{className:"space-y-4",children:s.map(t=>e.jsxs(ne,{to:`/blog/${t.slug}`,className:"group flex gap-4 transition-all duration-300 hover:translate-x-1",children:[e.jsx("div",{className:"flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden",children:e.jsx("img",{src:t.heroImage,alt:t.imageAlt,className:"w-full h-full object-cover group-hover:scale-110 transition-transform duration-300",style:{filter:"brightness(0.85)"}})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("h4",{className:"text-white font-semibold text-sm leading-tight mb-1 group-hover:text-purple-300 transition-colors line-clamp-2",children:t.title}),e.jsx("span",{className:"text-xs text-purple-400",children:t.category})]})]},t.slug))})]})})},o={slideContainer:"rounded-2xl overflow-hidden bg-gradient-to-r from-gray-900/80 to-purple-900/40 p-4 md:p-8 lg:p-10 border border-white/10 backdrop-blur-sm",card:"bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20",cardHover:"bg-white/8 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/30 transition-all duration-300",cardSm:"bg-white/8 backdrop-blur-sm rounded-xl p-4 border border-white/20",cardInner:"bg-gray-900/50 rounded-xl p-4 border border-white/10",callout:"bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-xl p-4 border border-purple-400/30",calloutWarning:"bg-gradient-to-r from-red-500/20 to-orange-500/20 backdrop-blur-sm rounded-xl p-4 border border-red-400/30",calloutSuccess:"bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm rounded-xl p-4 border border-green-400/30",table:"w-full text-left border-collapse",tableHeader:"border-b border-purple-400/30",tableHeaderCell:"py-3 px-4 text-purple-300 font-semibold text-sm",tableRow:"border-b border-slate-700/50 hover:bg-slate-800/30",tableCell:"py-3 px-4 text-slate-300 text-sm",slideTitle:"text-xl md:text-2xl lg:text-3xl font-bold text-white mb-1 md:mb-2",slideSubtitle:"text-gray-300 text-sm md:text-base",source:"text-center text-gray-500 text-xs italic mt-6",sectionTitle:"text-xl font-bold text-white mb-4",positive:"text-green-400",positiveBold:"text-green-300 font-bold",negative:"text-red-400",negativeBold:"text-red-400 font-bold",gold:"text-yellow-400",goldBold:"text-yellow-400 font-bold",blue:"text-blue-400",blueBold:"text-blue-400 font-bold",orange:"text-orange-400",orangeBold:"text-orange-300 font-bold",purple:"text-purple-400",purpleBold:"text-purple-300 font-bold",muted:"text-gray-400",mutedLight:"text-gray-300",barBlue:"linear-gradient(to top, #2563eb, #60a5fa)",barGreen:"linear-gradient(to top, #16a34a, #4ade80)",barGold:"linear-gradient(to top, #ca8a04, #facc15)",barRed:"linear-gradient(to top, #b91c1c, #ef4444)",avatarGold:"w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-2 border-yellow-400",imageRounded:"rounded-xl object-cover",divider:"border-b border-slate-700/50 pb-2 mb-2",dividerLight:"border-b border-white/10 pb-2 mb-2",slideWrapper:"my-10",textAfterSlide:"mt-8",textBeforeSlide:"mb-6"},ae=({children:a,source:n})=>e.jsxs("div",{className:o.slideContainer,children:[a,n&&e.jsxs("p",{className:o.source,children:["Source: ",n]})]}),se=({title:a,subtitle:n})=>e.jsxs("div",{className:"text-center mb-4 md:mb-8",children:[e.jsx("h3",{className:o.slideTitle,children:a}),n&&e.jsx("p",{className:o.slideSubtitle,children:n})]}),mn=()=>e.jsxs(ae,{children:[e.jsx(se,{title:"Annualized Returns Since 1928",subtitle:"Nearly a century of data tells the story"}),e.jsxs("div",{className:"flex justify-center items-end gap-10 md:gap-20 mt-6 md:mt-8",children:[e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-2xl md:text-3xl font-bold text-green-400 mb-2",children:"9.9%"}),e.jsx("div",{className:"w-12 md:w-20 rounded-t-lg",style:{height:"140px",backgroundColor:"#4ade80"}}),e.jsx("span",{className:"text-green-400 font-medium mt-2 md:mt-3 text-sm md:text-base",children:"S&P 500"})]}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:"text-2xl md:text-3xl font-bold text-yellow-500 mb-2",children:"5.0%"}),e.jsx("div",{className:"w-12 md:w-20 rounded-t-lg",style:{height:"70px",backgroundColor:"#eab308"}}),e.jsx("span",{className:"text-yellow-500 font-medium mt-2 md:mt-3 text-sm md:text-base",children:"Gold"})]})]})]}),un=()=>e.jsxs(ae,{source:"Kiplinger",children:[e.jsx(se,{title:"40-Year Reality Check",subtitle:"1984-2024 Returns: Nominal vs After Inflation"}),e.jsxs("div",{className:"flex justify-center items-end gap-4 md:gap-12 mt-4 md:mt-8",children:[e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-end gap-1 md:gap-2 justify-center",children:[e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:`text-sm md:text-lg font-bold ${o.gold} mb-1 md:mb-2`,children:"4.3%"}),e.jsx("div",{className:"w-10 md:w-20 rounded-t-lg",style:{height:"65px",background:o.barGold}})]}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:`text-sm md:text-lg font-bold ${o.negative} mb-1 md:mb-2`,children:"1.5%"}),e.jsx("div",{className:"w-10 md:w-20 rounded-t-lg",style:{height:"23px",background:o.barRed}})]})]}),e.jsx("span",{className:`${o.goldBold} mt-2 md:mt-4 block text-sm md:text-base`,children:"GOLD"})]}),e.jsxs("div",{className:"text-center",children:[e.jsxs("div",{className:"flex items-end gap-1 md:gap-2 justify-center",children:[e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:`text-sm md:text-lg font-bold ${o.positive} mb-1 md:mb-2`,children:"11.6%"}),e.jsx("div",{className:"w-10 md:w-20 rounded-t-lg",style:{height:"125px",background:o.barBlue}})]}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("span",{className:`text-sm md:text-lg font-bold ${o.positive} mb-1 md:mb-2`,children:"8.6%"}),e.jsx("div",{className:"w-10 md:w-20 rounded-t-lg",style:{height:"92px",background:o.barGreen}})]})]}),e.jsx("span",{className:`${o.blueBold} mt-2 md:mt-4 block text-sm md:text-base`,children:"S&P 500"})]})]}),e.jsx("p",{className:`${o.muted} text-xs md:text-sm text-center mt-4 md:mt-6`,children:"Darker = Nominal   |   Lighter = After Inflation"})]}),pn=()=>e.jsxs(ae,{source:"QuantifiedStrategies.com",children:[e.jsx(se,{title:"The Lost Decades",subtitle:"Gold's 20-Year Nightmare: 1980-2000"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6 mt-8",children:[e.jsxs("div",{className:`${o.card} text-center`,children:[e.jsx("h4",{className:`${o.goldBold} text-xl mb-4`,children:"GOLD"}),e.jsx("div",{className:"flex items-center justify-center mb-4",children:e.jsx("svg",{className:`w-16 h-16 ${o.negative}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 17h8m0 0V9m0 8l-8-8-4 4-6-6"})})}),e.jsx("p",{className:`${o.negativeBold} text-3xl md:text-4xl mb-2`,children:"-4.0%"}),e.jsx("p",{className:`${o.muted} text-sm`,children:"Total return over 20 years"}),e.jsx("p",{className:`${o.negative} text-xs mt-2`,children:"Lost money for TWO decades straight"})]}),e.jsxs("div",{className:`${o.card} text-center`,children:[e.jsx("h4",{className:`${o.blueBold} text-xl mb-4`,children:"S&P 500"}),e.jsx("div",{className:"flex items-center justify-center mb-4",children:e.jsx("svg",{className:`w-16 h-16 ${o.positive}`,fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"})})}),e.jsx("p",{className:`${o.positiveBold} text-3xl md:text-4xl mb-2`,children:"+1,200%"}),e.jsx("p",{className:`${o.muted} text-sm`,children:"Total return over 20 years"}),e.jsx("p",{className:`${o.positive} text-xs mt-2`,children:"Including the 1990s bull market"})]})]}),e.jsx("div",{className:`${o.callout} mt-6 text-center max-w-2xl mx-auto`,children:e.jsxs("p",{className:"text-white font-bold text-base md:text-lg",children:["Gold was the ",e.jsx("span",{className:o.negative,children:"ONLY major asset class"})," with negative returns across two consecutive decades"]})})]}),gn=()=>e.jsxs(ae,{source:"IRS Topic 409",children:[e.jsx(se,{title:"IRS Tax Treatment",subtitle:'Gold is taxed as a "Collectible" — same as art, rugs, and wine'}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6 mt-8",children:[e.jsxs("div",{className:o.card,children:[e.jsx("h4",{className:`${o.goldBold} text-xl text-center mb-2`,children:"GOLD"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-4`,children:"Collectible Tax Rate"}),e.jsx("p",{className:`${o.negativeBold} text-5xl md:text-6xl text-center mb-2`,children:"28%"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-6`,children:"Maximum Rate"}),e.jsxs("ul",{className:"text-white text-sm space-y-2",children:[e.jsx("li",{className:"text-center",children:"Art & Antiques"}),e.jsx("li",{className:"text-center",children:"Rugs & Stamps"}),e.jsx("li",{className:"text-center",children:"Wine & Coins"})]})]}),e.jsxs("div",{className:o.card,children:[e.jsx("h4",{className:`${o.positiveBold} text-xl text-center mb-2`,children:"STOCKS"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-4`,children:"Long-Term Capital Gains"}),e.jsx("p",{className:`${o.positiveBold} text-5xl md:text-6xl text-center mb-2`,children:"0-20%"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-6`,children:"Based on Income"}),e.jsxs("ul",{className:"text-white text-sm space-y-2",children:[e.jsx("li",{className:"text-center",children:"0% (up to $44K)"}),e.jsx("li",{className:"text-center",children:"15% ($44K-$492K)"}),e.jsx("li",{className:"text-center",children:"20% (above $492K)"})]})]})]})]}),yn=()=>e.jsxs(ae,{children:[e.jsx(se,{title:"Real Tax Impact",subtitle:"$100,000 Profit Scenario"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6 mt-8",children:[e.jsxs("div",{className:`${o.card} p-8 text-center`,children:[e.jsx("h4",{className:`${o.positiveBold} text-xl mb-4`,children:"STOCKS"}),e.jsx("p",{className:"text-white font-bold text-4xl md:text-5xl mb-2",children:"$20,000"}),e.jsx("p",{className:o.muted,children:"Tax Owed (20%)"})]}),e.jsxs("div",{className:`${o.card} p-8 text-center`,children:[e.jsx("h4",{className:`${o.goldBold} text-xl mb-4`,children:"GOLD"}),e.jsx("p",{className:`${o.negativeBold} text-4xl md:text-5xl mb-2`,children:"$28,000"}),e.jsx("p",{className:o.muted,children:"Tax Owed (28%)"})]})]}),e.jsxs("div",{className:`${o.calloutWarning} mt-6 text-center max-w-lg mx-auto`,children:[e.jsx("p",{className:`${o.negativeBold} text-lg md:text-xl`,children:"That's $8,000 MORE to the IRS"}),e.jsx("p",{className:"text-white text-sm",children:"on the exact same gain!"})]})]}),bn=()=>e.jsxs(ae,{children:[e.jsx(se,{title:"Storage Fees Eat Your Gains"}),e.jsxs("div",{className:"space-y-4 md:space-y-6 mt-6 md:mt-8",children:[e.jsxs("div",{className:"flex flex-wrap items-baseline gap-2 md:gap-4",children:[e.jsx("span",{className:`${o.goldBold} text-4xl md:text-6xl`,children:"0.5%"}),e.jsx("span",{className:"text-white text-lg md:text-xl",children:"annual storage fee"})]}),e.jsxs("div",{className:"flex flex-wrap items-baseline gap-2 md:gap-4",children:[e.jsx("span",{className:"text-gray-500 text-2xl md:text-3xl",children:"="}),e.jsx("span",{className:`${o.negativeBold} text-2xl md:text-3xl`,children:"$500/year"}),e.jsx("span",{className:`${o.muted} text-sm md:text-base`,children:"on $100,000"})]})]}),e.jsxs("div",{className:`${o.calloutWarning} mt-6 md:mt-8 text-center`,children:[e.jsx("p",{className:`${o.negativeBold} text-lg md:text-2xl mb-2`,children:"Over 20 years = $10,000+ in storage fees alone"}),e.jsx("p",{className:`${o.muted} text-sm md:text-base mb-2`,children:"With gold returning only ~5% annually..."}),e.jsx("p",{className:"text-white font-bold text-sm md:text-base",children:"Storage eats 10-20% of your total gains!"})]})]}),fn=()=>e.jsxs(ae,{source:"CFTC warns of 20-400% dealer markups",children:[e.jsx(se,{title:'The "Free Gold" Trap',subtitle:"How 'free' gifts actually cost you thousands"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-8 mt-8",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:o.divider+" flex justify-between",children:[e.jsx("span",{className:o.muted,children:"You invest:"}),e.jsx("span",{className:"text-white font-bold",children:"$100,000"})]}),e.jsxs("div",{className:o.divider+" flex justify-between",children:[e.jsx("span",{className:o.muted,children:'+ "Free" gold:'}),e.jsx("span",{className:o.goldBold,children:"$10,000"})]}),e.jsxs("div",{className:o.divider+" flex justify-between",children:[e.jsx("span",{className:o.muted,children:"Account shows:"}),e.jsx("span",{className:"text-white font-bold",children:"$110,000"})]}),e.jsxs("div",{className:o.divider+" flex justify-between",children:[e.jsx("span",{className:o.muted,children:"Try to sell:"}),e.jsx("span",{className:o.negativeBold,children:"-25% markup"})]}),e.jsxs("div",{className:"flex justify-between",children:[e.jsx("span",{className:o.muted,children:"You get back:"}),e.jsx("span",{className:o.negativeBold,children:"$82,500"})]})]}),e.jsxs("div",{className:`${o.card} flex flex-col justify-center`,children:[e.jsx("p",{className:`${o.muted} text-sm text-center mb-2`,children:'YOUR "FREE" GIFT'}),e.jsx("p",{className:"text-white text-center mb-2",children:"Actually cost you"}),e.jsx("p",{className:`${o.negativeBold} text-5xl text-center mb-2`,children:"$17,500"}),e.jsx("p",{className:`${o.muted} text-sm text-center`,children:"in hidden markups"})]})]})]}),wn=()=>e.jsxs(ae,{source:"CFTC Consumer Advisory",children:[e.jsx(se,{title:"Coins vs Bars: The Markup Game",subtitle:"Why dealers push coins over bars"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6 mt-8",children:[e.jsxs("div",{className:o.card,children:[e.jsx("h4",{className:`${o.goldBold} text-xl text-center mb-4`,children:"COINS"}),e.jsx("p",{className:`${o.negativeBold} text-4xl md:text-5xl text-center mb-2`,children:"40-200%"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-6`,children:"Premium Over Spot"}),e.jsxs("ul",{className:"text-white text-sm space-y-2",children:[e.jsx("li",{className:"text-center",children:'"Rare" & "Collectible"'}),e.jsx("li",{className:"text-center",children:'"Limited Edition"'}),e.jsx("li",{className:"text-center",children:'"Certified" graded'})]}),e.jsx("p",{className:`${o.negativeBold} text-sm text-center mt-4`,children:"= Higher dealer margins"})]}),e.jsxs("div",{className:o.card,children:[e.jsx("h4",{className:"text-white font-bold text-xl text-center mb-4",children:"BARS"}),e.jsx("p",{className:`${o.positiveBold} text-4xl md:text-5xl text-center mb-2`,children:"2-5%"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-6`,children:"Premium Over Spot"}),e.jsxs("ul",{className:"text-white text-sm space-y-2",children:[e.jsx("li",{className:"text-center",children:'Simple, no "story"'}),e.jsx("li",{className:"text-center",children:"Harder to markup"}),e.jsx("li",{className:"text-center",children:"Lower commissions"})]}),e.jsx("p",{className:`${o.positiveBold} text-sm text-center mt-4`,children:"= Dealers don't push these"})]})]})]}),xn=()=>e.jsxs(ae,{children:[e.jsx(se,{title:"The Celebrity Trust Machine",subtitle:"Same playbook, different face"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6 mt-8",children:[e.jsxs("div",{className:`${o.card} p-4 md:p-6`,children:[e.jsx("div",{className:"flex justify-center mb-4",children:e.jsx("img",{src:"/blog-images/william-devane-gold.jpg",alt:"William Devane in Rosland Capital commercial",className:o.avatarGold})}),e.jsx("h4",{className:"text-white font-bold text-xl text-center mb-1",children:"William Devane"}),e.jsx("p",{className:`${o.gold} text-center mb-1`,children:"Rosland Capital"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-3`,children:"Since 2012"}),e.jsxs("ul",{className:"text-white text-xs md:text-sm space-y-1",children:[e.jsx("li",{className:"text-center",children:'Known for: "24", "Knots Landing"'}),e.jsx("li",{className:"text-center",children:"Heavy cable news presence"}),e.jsx("li",{className:"text-center",children:"Target: Conservative retirees"})]})]}),e.jsxs("div",{className:`${o.card} p-4 md:p-6`,children:[e.jsx("div",{className:"flex justify-center mb-4",children:e.jsx("img",{src:"/blog-images/tom-selleck-gold.jpg",alt:"Tom Selleck in Goldco commercial",className:o.avatarGold})}),e.jsx("h4",{className:"text-white font-bold text-xl text-center mb-1",children:"Tom Selleck"}),e.jsx("p",{className:`${o.gold} text-center mb-1`,children:"Goldco"}),e.jsx("p",{className:`${o.muted} text-sm text-center mb-3`,children:"Since 2023"}),e.jsxs("ul",{className:"text-white text-xs md:text-sm space-y-1",children:[e.jsx("li",{className:"text-center",children:'Known for: "Magnum P.I.", "Blue Bloods"'}),e.jsx("li",{className:"text-center",children:"Same cable news demographic"}),e.jsx("li",{className:"text-center",children:"Target: Same retiree audience"})]})]})]}),e.jsx("p",{className:`${o.negativeBold} text-center mt-6`,children:"Trusted TV actors → Target retirees → Costs passed to customers"})]}),vn=()=>e.jsxs(ae,{children:[e.jsx(se,{title:"Gold vs Autonomous Trading",subtitle:"Which would you choose?"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-6 mt-8",children:[e.jsxs("div",{className:o.card,children:[e.jsx("h4",{className:`${o.goldBold} text-xl text-center mb-6`,children:"GOLD"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Returns:"}),e.jsx("p",{className:o.negativeBold,children:"~5% annually"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Tax Rate:"}),e.jsx("p",{className:o.negativeBold,children:"28% (Collectible)"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Storage:"}),e.jsx("p",{className:o.negativeBold,children:"Fees eat gains"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Complexity:"}),e.jsx("p",{className:o.negativeBold,children:"Dealers, markups"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Sales:"}),e.jsx("p",{className:o.negativeBold,children:"Celebrity spokesmen"})]})]})]}),e.jsxs("div",{className:o.card,children:[e.jsx("h4",{className:`${o.positiveBold} text-xl text-center mb-6`,children:"MY SYSTEM"}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Profits:"}),e.jsx("p",{className:o.positiveBold,children:"$4,736.15"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Trades:"}),e.jsx("p",{className:o.positiveBold,children:"957 closed"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Success:"}),e.jsx("p",{className:o.positiveBold,children:"100% win rate"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Storage:"}),e.jsx("p",{className:o.positiveBold,children:"$0 (digital)"})]}),e.jsxs("div",{children:[e.jsx("p",{className:`${o.muted} text-sm`,children:"Transparency:"}),e.jsx("p",{className:o.positiveBold,children:"Live dashboard"})]})]})]})]})]}),kn=({variant:a})=>{switch(a){case"returns-1928":return e.jsx(mn,{});case"reality-check":return e.jsx(un,{});case"lost-decades":return e.jsx(pn,{});case"irs-tax":return e.jsx(gn,{});case"tax-impact":return e.jsx(yn,{});case"storage-fees":return e.jsx(bn,{});case"free-gold-trap":return e.jsx(fn,{});case"coins-vs-bars":return e.jsx(wn,{});case"celebrity-machine":return e.jsx(xn,{});case"gold-vs-trading":return e.jsx(vn,{});default:return null}},Tn=()=>{const{slug:a}=at(),n=st(),[s,t]=w.useState(null);if(w.useEffect(()=>{const I=$e.find(m=>m.slug===a);I?(t(I),window.scrollTo(0,0)):n("/blog")},[a,n]),!s)return e.jsx("div",{className:"min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center",children:e.jsx("div",{className:"text-white text-xl",children:"Loading..."})});const i=I=>new Date(I).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),h=I=>{const m=I.split(`
`),d=[];let M=[],x=!1,g=!1,F=[],$=!1,Y=[];const H=()=>{M.length>0&&(d.push(e.jsx("p",{className:"mb-8 text-slate-300 leading-relaxed text-lg",children:b(M.join(" "))},`p-${d.length}`)),M=[])},O=()=>{if(F.length>0){const v=g?"ol":"ul";d.push(e.jsx(v,{className:`mb-6 space-y-2 text-slate-300 text-lg ${g?"list-decimal":"list-disc"} list-inside ml-4`,children:F.map((P,l)=>e.jsx("li",{children:b(P)},l))},`${g?"ol":"ul"}-${d.length}`)),F=[],x=!1,g=!1}},K=()=>{if(Y.length>0){const v=Y[0],P=Y.slice(2),l=j=>j.split("|").slice(1,-1).map(A=>A.trim()),S=l(v),k=P.map(l);d.push(e.jsx("div",{className:"mb-6 overflow-x-auto",children:e.jsxs("table",{className:"w-full text-left border-collapse",children:[e.jsx("thead",{children:e.jsx("tr",{className:"border-b border-purple-400/30",children:S.map((j,A)=>e.jsx("th",{className:"py-3 px-4 text-purple-300 font-semibold text-sm",children:b(j)},A))})}),e.jsx("tbody",{children:k.map((j,A)=>e.jsx("tr",{className:"border-b border-slate-700/50 hover:bg-slate-800/30",children:j.map((E,W)=>e.jsx("td",{className:"py-3 px-4 text-slate-300 text-sm",children:b(E)},W))},A))})]})},`table-${d.length}`)),Y=[],$=!1}};return m.forEach((v,P)=>{if(v.startsWith("# "))H(),O(),d.push(e.jsx("h1",{className:"text-4xl md:text-5xl font-bold mb-6 mt-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400",children:v.substring(2)},`h1-${P}`));else if(v.startsWith("## "))H(),O(),d.push(e.jsx("h2",{className:"text-3xl font-bold mb-4 mt-8 text-purple-300",children:v.substring(3)},`h2-${P}`));else if(v.startsWith("### "))H(),O(),d.push(e.jsx("h3",{className:"text-2xl font-bold mb-3 mt-6 text-purple-300",children:v.substring(4)},`h3-${P}`));else if(v.trim()==="---")H(),O();else if(v.trim().match(/^!\[([^\]]*)\]\(([^)]+)\)$/)||v.trim().match(/^!\[Slide:\s*([^\]]+)\]$/)){H(),O();const l=v.trim().match(/^!\[Slide:\s*([^\]]+)\]$/);if(l){const S=l[1].trim();d.push(e.jsx("div",{style:{marginTop:"80px",marginBottom:"80px"},children:e.jsx(kn,{variant:S},`slide-${P}`)},`slide-wrapper-${P}`))}else{const S=v.trim().match(/^!\[([^\]]*)\]\(([^)]+)\)$/);if(S){const k=m[P+1];if(k&&k.trim().match(/^\*(.+)\*$/)){const A=k.trim().match(/^\*(.+)\*$/);d.push(e.jsxs("figure",{className:"my-8",children:[e.jsx("img",{src:S[2],alt:S[1],className:"w-full rounded-xl border border-purple-400/30"}),e.jsx("figcaption",{className:"text-center text-slate-400 text-sm italic mt-3",children:A?A[1]:""})]},`fig-${P}`)),m[P+1]=""}else d.push(e.jsx("img",{src:S[2],alt:S[1],className:"w-full rounded-xl my-6 border border-purple-400/30"},`img-${P}`))}}}else v.trim().startsWith("- ")?(H(),K(),x&&g&&O(),x=!0,g=!1,F.push(v.trim().substring(2))):/^\d+\.\s/.test(v.trim())?(H(),K(),x&&!g&&O(),x=!0,g=!0,F.push(v.trim().replace(/^\d+\.\s/,""))):v.trim().startsWith("|")&&v.trim().endsWith("|")?(H(),O(),$=!0,Y.push(v.trim())):v.trim()===""?(H(),x||O(),$&&K()):(x&&O(),$&&K(),M.push(v))}),H(),O(),K(),d},b=I=>{const m=[];let d=I,M=0;for(;d.length>0;){const x=d.match(/\*\*([^*]+)\*\*/);if(x){const $=d.substring(0,x.index);$&&m.push(e.jsx("span",{children:$},M++)),m.push(e.jsx("strong",{className:"font-bold text-white",children:x[1]},M++)),d=d.substring(x.index+x[0].length);continue}const g=d.match(/\*([^*]+)\*/);if(g){const $=d.substring(0,g.index);$&&m.push(e.jsx("span",{children:$},M++)),m.push(e.jsx("em",{className:"italic",children:g[1]},M++)),d=d.substring(g.index+g[0].length);continue}const F=d.match(/\[([^\]]+)\]\(([^)]+)\)/);if(F){const $=d.substring(0,F.index);$&&m.push(e.jsx("span",{children:$},M++)),m.push(e.jsx("a",{href:F[2],className:"text-purple-400 hover:text-purple-300 underline",target:"_blank",rel:"noopener noreferrer",children:F[1]},M++)),d=d.substring(F.index+F[0].length);continue}m.push(e.jsx("span",{children:d},M++));break}return m};return e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900",children:[e.jsx(ue,{}),e.jsx("section",{className:"relative py-16",children:e.jsxs("article",{className:"max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8",children:[e.jsx("div",{className:"mb-6",children:e.jsxs(ne,{to:"/blog",className:"inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 border border-purple-400/30 hover:border-purple-400/50 text-purple-300 hover:text-purple-200 transition-all duration-300 group",children:[e.jsx("svg",{className:"w-4 h-4 transition-transform group-hover:-translate-x-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),e.jsx("span",{className:"text-sm font-medium",children:"Back to Blog"})]})}),e.jsxs("header",{className:"mb-12",children:[e.jsx("div",{className:"mb-4",children:e.jsx("span",{className:"inline-block px-4 py-2 text-sm font-semibold rounded-full bg-purple-600/30 text-purple-300 border border-purple-400/30",children:s.category})}),e.jsx("h1",{className:"text-4xl md:text-5xl font-bold mb-6 text-white leading-tight",children:s.title}),e.jsxs("div",{className:"flex items-center text-slate-400",children:[e.jsx("time",{dateTime:s.date,children:i(s.date)}),e.jsx("span",{className:"mx-3",children:"•"}),e.jsx("span",{children:"Patrick Jenkins"})]})]}),e.jsx("div",{className:"mb-8 rounded-2xl overflow-hidden h-48 md:h-56",children:e.jsx("img",{src:s.heroImage,alt:s.imageAlt,className:"w-full h-full object-cover",style:{filter:"brightness(0.85)"}})}),e.jsx("div",{className:"prose prose-invert prose-lg max-w-none",children:e.jsx("div",{className:"bg-slate-900/95 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-8 border border-purple-400/30",children:h(s.content)})}),e.jsxs("div",{className:"bg-slate-900/95 backdrop-blur-sm rounded-2xl p-8 border border-purple-400/30",children:[e.jsx("h3",{className:"text-2xl font-bold mb-4 text-white",children:"Ready to See Real Trading Results?"}),e.jsx("p",{className:"text-slate-300 mb-6",children:"Everything you just read is based on real trading data. Check out my live dashboard with complete transparency - every trade, every profit, updated multiple times daily."}),e.jsxs(ne,{to:"/",onClick:()=>window.scrollTo(0,0),className:"inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full font-semibold text-white transition-all duration-300 hover:scale-105 shadow-lg shadow-purple-500/30",children:[e.jsx("span",{children:"View Live Results"}),e.jsx("svg",{className:"w-5 h-5 transition-transform group-hover:translate-x-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})]}),e.jsx("div",{className:"mt-8 pt-8 border-t border-purple-400/30",children:e.jsxs("div",{className:"flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-slate-300 font-medium mb-1",children:"Found this helpful? Let's connect!"}),e.jsx("p",{className:"text-slate-400 text-sm",children:"I share daily insights about systematic trading and building transparent systems."})]}),e.jsxs("a",{href:"https://twitter.com/myrobotictrader",className:"inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-purple-600/20 hover:bg-purple-600/30 border border-purple-400/40 hover:border-purple-400/60 text-purple-300 hover:text-purple-200 transition-all duration-300 group whitespace-nowrap",target:"_blank",rel:"noopener noreferrer",children:[e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"})}),e.jsx("span",{className:"font-medium",children:"Follow on X"}),e.jsx("svg",{className:"w-4 h-4 group-hover:translate-x-1 transition-transform",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})]})}),e.jsx("div",{className:"mt-12",children:e.jsx(hn,{currentSlug:s.slug})})]})})]})},ie={home:{title:"MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams",description:"Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system. Start your automated trading journey today.",keywords:"robotic trading, crypto trading, automated trading, passive income, cryptocurrency, trading bot, AI trading, revenue streams, financial freedom",ogTitle:"MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams",ogDescription:"Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system.",ogImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/og-image.png",twitterTitle:"MyRoboticTrader - Set It and Forget It Crypto Trading | Build New Revenue Streams",twitterDescription:"Discover how I built multiple revenue streams with AI-Enhanced autonomous robotic crypto trading. Real results, proven system.",twitterImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/twitter-image.png",canonicalUrl:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/",pageType:"home"},resources:{title:"Trading Resources & AI-Enhanced Crypto Guides | Build Your Revenue Stream",description:"Free AI-enhanced crypto trading resources and guides. Learn the automated trading strategies to build sustainable revenue streams with GoBabyTrade.",keywords:"trading guides, crypto resources, trading education, automated trading strategies, financial education",ogTitle:"Free Trading Resources & Guides | MyRoboticTrader",ogDescription:"Access free crypto trading resources, guides, and educational content to build your revenue stream.",ogImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/og-image.png",twitterTitle:"Trading Resources & Guides",twitterDescription:"Free crypto trading resources and educational content for building sustainable revenue streams.",twitterImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/twitter-image.png",canonicalUrl:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/resources",pageType:"resources"},privacy:{title:"Privacy Policy | MyRoboticTrader",description:"Privacy policy and data handling practices for MyRoboticTrader.com",keywords:"privacy policy, data protection, terms of service",ogTitle:"Privacy Policy | MyRoboticTrader",ogDescription:"Privacy policy and data handling practices.",ogImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/og-image.png",twitterTitle:"Privacy Policy",twitterDescription:"Privacy policy and data handling practices.",twitterImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/twitter-image.png",canonicalUrl:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/privacy",pageType:"privacy"},card:{title:"Live Trading Results - Building Revenue Streams | MyRoboticTrader",description:"See live AI-enhanced robotic trading results. Real revenue streams being built automatically from Patrick's trading system!",keywords:"live trading results, crypto performance, trading dashboard, automated trading results",ogTitle:"Live Trading Results - Building Revenue Streams",ogDescription:"See live AI-enhanced robotic trading results. Real revenue streams being built automatically from Patrick's trading system!",ogImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/og-image.png",twitterTitle:"Live Trading Results - Building Revenue Streams",twitterDescription:"See live AI-enhanced robotic trading results building sustainable revenue streams automatically!",twitterImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/twitter-image.png",canonicalUrl:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/card",pageType:"card"},blog:{title:"Trading Education Blog | Real Insights from Autonomous Crypto Trading",description:"Learn systematic crypto trading strategies from real results. No hype, just transparent insights from building an AI-enhanced autonomous trading system.",keywords:"crypto trading blog, automated trading education, systematic trading, AI trading insights, crypto trading strategies, trading transparency",ogTitle:"Trading Education Blog - Real Insights, Real Results",ogDescription:"Learn from real trading results and transparent insights about autonomous crypto trading systems.",ogImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/og-image.png",twitterTitle:"Trading Education Blog - MyRoboticTrader",twitterDescription:"Real insights from building transparent, systematic crypto trading systems.",twitterImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/twitter-image.png",canonicalUrl:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/blog",pageType:"blog"},faq:{title:"FAQ - Frequently Asked Questions | MyRoboticTrader",description:"Get answers to common questions about automated crypto trading, AI-enhanced systems, safety, profits, and how to get started with GoBabyTrade.",keywords:"crypto trading FAQ, automated trading questions, trading bot FAQ, GoBabyTrade FAQ, robotic trading help",ogTitle:"Frequently Asked Questions | MyRoboticTrader",ogDescription:"Answers to 30+ questions about automated crypto trading, safety, profits, and getting started.",ogImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/og-image.png",twitterTitle:"FAQ - MyRoboticTrader",twitterDescription:"Get answers to common questions about automated crypto trading and AI-enhanced systems.",twitterImage:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/twitter-image.png",canonicalUrl:"https://rd6xolh11t0gmjdo-default.preview.taskade.app/faq",pageType:"faq"}},Nn=({children:a})=>{const n=Oe(),s=()=>{if(n.pathname.startsWith("/blog/"))return ie.blog;switch(n.pathname){case"/blog":return ie.blog;case"/faq":return ie.faq;case"/resources":return ie.resources;case"/privacy":return ie.privacy;case"/card":return ie.card;default:return ie.home}};return e.jsxs(e.Fragment,{children:[e.jsx(yt,{...s()}),a]})},jn=()=>{const{tradingStats:a,isLoading:n,error:s,refreshStats:t,cacheInfo:i}=be(),h=Fe.useCallback(()=>{try{t&&typeof t=="function"&&t()}catch(b){console.error("Error in refresh function:",b)}},[t]);return e.jsxs(e.Fragment,{children:[e.jsx(ue,{}),e.jsx(qt,{}),e.jsx(Ut,{tradingStats:a}),e.jsx(_t,{tradingStats:a,isLoading:n,error:s,refreshStats:t||h,cacheInfo:i||{isFresh:!1,isRateLimited:!1,timeUntilNextRefresh:0}}),e.jsx(Jt,{}),e.jsx(Vt,{}),e.jsx(Xt,{})]})};function In(){return w.useEffect(()=>{ut()},[]),e.jsxs("div",{className:"App min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900",children:[e.jsx(bt,{}),e.jsx(ft,{}),e.jsx(ot,{children:e.jsxs(Nn,{children:[e.jsxs(rt,{children:[e.jsx(re,{path:"/",element:e.jsx(jn,{})}),e.jsx(re,{path:"/faq",element:e.jsx(sn,{})}),e.jsx(re,{path:"/resources",element:e.jsx(rn,{})}),e.jsx(re,{path:"/privacy",element:e.jsx(ln,{})}),e.jsx(re,{path:"/card",element:e.jsx(dn,{})}),e.jsx(re,{path:"/blog",element:e.jsx(cn,{})}),e.jsx(re,{path:"/blog/:slug",element:e.jsx(Tn,{})})]}),e.jsx(on,{})]})})]})}ze(document.getElementById("root")).render(e.jsx(w.StrictMode,{children:e.jsx(In,{})}));
