  ...
  return (
    <section className="py-16 px-4 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        {/* Why I'm Sharing Section - Updated Real Results card */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                I believe in complete transparency. I'm sharing my actual
                trading results and journey so you can see exactly what this
                system has produced - the real numbers, not just promises.
              </p>
            </div>
