    ...
    <nav className="sticky top-0 left-0 right-0 z-50 bg-white/8 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 h-16">
          ...
          <div className="max-md:hidden flex items-center gap-4 flex-1 justify-center max-w-4xl">
            {/* Total Profit */}
        ...
        {/* Mobile Trading Stats - Below main nav */}
        <div className="md:hidden py-2 border-t border-white/10">
          <div className="grid grid-cols-3 gap-2">
            {/* Total Profit */}
            <div className="flex flex-col items-center gap-1 bg-white/5 rounded-lg px-2 py-2 border border-white/10">
              <div className="w-6 h-6 rounded bg-gradient-to-br from-green-500 to-emerald-500 p-1.5">
                <DollarSign className="w-full h-full text-white" />
              </div>
              {isLoading ? (
                <div className="text-xs font-bold text-green-300 animate-pulse">Loading...</div>
              ) : (
                <>
            ...
            {/* Monthly Average */}
            <div className="flex flex-col items-center gap-1 bg-white/5 rounded-lg px-2 py-2 border border-white/10">
              <div className="w-6 h-6 rounded bg-gradient-to-br from-blue-500 to-cyan-500 p-1.5">
                <Calendar className="w-full h-full text-white" />
              </div>
              {isLoading ? (
                <div className="text-xs font-bold text-blue-300 animate-pulse">Loading...</div>
              ) : (
                <>
            ...
            {/* Daily Average */}
            <div className="flex flex-col items-center gap-1 bg-white/5 rounded-lg px-2 py-2 border border-white/10">
              <div className="w-6 h-6 rounded bg-gradient-to-br from-purple-500 to-pink-500 p-1.5">
                <TrendingUp className="w-full h-full text-white" />
              </div>
              {isLoading ? (
                <div className="text-xs font-bold text-purple-300 animate-pulse">Loading...</div>
              ) : (
                <>
